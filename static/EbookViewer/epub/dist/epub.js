(function webpackUniversalModuleDefinition(root, factory) {
  ...
  window,
  function (__WEBPACK_EXTERNAL_MODULE__16__, __WEBPACK_EXTERNAL_MODULE__28__) {
    return /******/ (function (modules) {
      ...
      /******/ [
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var xmldom__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(16);
          /* harmony import */ var xmldom__WEBPACK_IMPORTED_MODULE_0___default =
            /*#__PURE__*/ __webpack_require__.n(
              xmldom__WEBPACK_IMPORTED_MODULE_0__,
            );
          /**
  ...
  */
                ...
                if (step.type === "element") {
                  ...
                  if (step.id) {
                    ...
                    children =
                      container.children ||
                      Object(
                        _utils_core__WEBPACK_IMPORTED_MODULE_0__[
                          "findChildren"
                        ],
                      )(container);
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          function replaceBase(doc, section) {
            ...
            head = Object(_core__WEBPACK_IMPORTED_MODULE_0__["qs"])(
              doc,
              "head",
            );
            base = Object(_core__WEBPACK_IMPORTED_MODULE_0__["qs"])(
              head,
              "base",
            );
            if (!base) {
      ...
      */
            ...
            prepend(section, forceRight) {
              ...
              view.on(constants["c" /* EVENTS */].VIEWS.RESIZED, (bounds) => {
                ...
                if (
                  document
                    .getElementsByClassName("epub-container")[0]
                    .classList.contains("ios-container")
                )
                  return;
                this.counter(bounds);
              });
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          class annotations_Annotation {
             ...
             */
            attach(view) {
              let { cfiRange, data, type, mark, cb, className, styles, color } =
                this;
              let result;
              if (type === "highlight") {
          ...
          class rendition_Rendition {
            ...
            start() {
              ...
              this.manager.on(
                constants["c" /* EVENTS */].MANAGERS.RESIZED,
                debounce_default()(this.onResized.bind(this), 300),
              );
  ...
  */
            ...
            afterDisplayed(view) {
              view.on(
                ...
                (cfiRange, data, content, color) =>
                  this.triggerMarkEvent(cfiRange, data, view.contents, color),
              );
              view.on(
                constants["c" /* EVENTS */].VIEWS.MARK_IMAGE_CLICKED,
                (data) => this.triggerMarkImageEvent(data),
              );
                      ...
                      if (
                        ...
                        if (container.classList.contains("ios-container")) {
                          if (container.start) {
                            ...
                            container.scrollTo(
                              0,
                              (document.documentElement.clientHeight * 4) / 10,
                            );
            ...
            determineLayoutProperties(metadata) {
              ...
              //김병현 수정
              var minSpreadWidth =
                this.settings.minSpreadWidth || metadata.minSpreadWidth || 0;
              var direction =
            ...
            passEvents(contents) {
              ...
              contents.on(
                ...
                (
                  ...
                  this.triggerCustomSelectedEvent(
                    range,
                    contents,
                    startTop,
                    startLeft,
              ...
              contents.on("customSelectCancel", () =>
                this.triggerCustomSelectedCancelEvent(),
              );
              contents.on("click", () => {
                this.emit("click");
              });
            ...
            triggerMarkImageEvent(data) {
               ...
               */
              this.emit(
                constants["c" /* EVENTS */].RENDITION.MARK_IMAGE_CLICKED,
                data,
              );
            }
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                if (typeof iosChecker == "undefined" || iosChecker == true) {
                  ...
                  if (e.type == "selectionchange") {
                    ...
                    if (selection) {
                      ...
                      let cfirange = new epubcfi["a" /* default */](
                        selection.getRangeAt(0),
                        this.contents.cfiBase,
                      ).toString();
                      this.range = cfirange;
                      ...
                      setTimeout(() => {
                        ...
                        let { startTop, startLeft, endTop, endLeft } =
                          this.calculateTarget(
                            selectionFocusRect(this.selection),
                          );
                        if (this.range) {
                          this.contents.emit(
                            "customSelect",
          ...
          /* harmony default export */ var selectionObserver =
            selectionObserver_SelectionObserver;
          ...
          class contents_Contents {
            ...
            resizeCheck() {
              ...
              if (width != this._size.width || height != this._size.height) {
                ...
                this.emit(
                  constants["c" /* EVENTS */].CONTENTS.RESIZE,
                  this._size,
                );
              }
            }
            ...
            locationOf(target, ignoreClass) {
              ...
              if (this.epubcfi.isCfiString(target)) {
                let range = new epubcfi["a" /* default */](target).toRange(
                  this.document,
                  ignoreClass,
                );
                if (range) {
            ...
            addClass(className) {
              ...
              if (content) {
                ...
                classes.forEach((t) => {
                  if (t.length > 0) content.classList.add(t);
                });
              }
            }
            ...
            triggerSelectedEvent(selection) {
              ...
              if (selection && selection.rangeCount > 0) {
                ...
                if (!range.collapsed) {
                  ...
                  cfirange = new epubcfi["a" /* default */](
                    range,
                    this.cfiBase,
                  ).toString();
                  this.emit(
                    constants["c" /* EVENTS */].CONTENTS.SELECTED,
                    cfirange,
                  );
                  this.emit(
                    constants["c" /* EVENTS */].CONTENTS.SELECTED_RANGE,
                    range,
                  );
                }
              }
            ...
            columns(width, height, columnWidth, gap, dir) {
              ...
              let COLUMN_WIDTH = Object(core["prefixed"])("column-width");
              let COLUMN_FILL = Object(core["prefixed"])("column-fill");
             ...
             */
            linksHandler() {
              Object(replacements["c" /* replaceLinks */])(
                this.content,
                (href) => {
                  this.emit(
                    constants["c" /* EVENTS */].CONTENTS.LINK_CLICKED,
          ...
          /* harmony default export */ var src_contents = (__webpack_exports__[
            "a"
          ] = contents_Contents);
                      ...
                      function dropInstance(options, callback) {
                        ...
                        if (!options.name) {
                          ...
                          var dbPromise = isCurrentDb
                            ...
                            : _getOriginalConnection(options).then(
                                function (db) {
            ...
            function handler() {
              if (this.readyState === XMLHttpRequest.DONE) {
                ...
                if (this.status === 200 || this.status === 0 || responseXML) {
                  ...
                  if (isAndroid || isIOS) {
                    alert(
                      "파일이 손상되었습니다. 모바일 책장에서 삭제 후 다시 다운로드 하시기 바랍니다.",
                    );
                  } else {
                    alert("파일이 손상되었습니다. 관리자에게 문의하세요.");
                  }
                  window.location.href =
                    "https://dev-dplus-front.azurewebsites.net/";
                }
              }
            }
            return deferred.promise;
