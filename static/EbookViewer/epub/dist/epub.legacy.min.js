!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function x(t, e) {
        for (
          var n, i = t.parentNode.childNodes, r = -1, o = 0;
          o < i.length && ((n = i[o]).nodeType === e && r++, n != t);
          o++
        );
        return r;
      }
      ...
      function D(t, e, n) {
        for (
          var i, r = document.createTreeWalker(t, n, null, !1);
          (i = r.nextNode());
      ...
      function q(t, e, n) {
        ...
        if (
          (void 0 !== t.querySelector &&
            (i = t.querySelector("".concat(e, '[*|type="').concat(n, '"]'))),
          i && 0 !== i.length)
        )
          return i;
        i = A(t, e);
      ...
      function W(t, e, n) {
        for (var i = [], r = t.childNodes, o = 0; o < r.length; o++) {
          var s = r[o];
          if (1 === s.nodeType && s.nodeName.toLowerCase() === e) {
            if (n) return s;
            i.push(s);
          }
        }
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t, e) {
                var n = F(t || this.startContainer),
                  i = F(e || this.endContainer);
                if (n[0] == i[0])
    ...
    function (t, e, n) {
      ...
      var s = (function () {
        function t(e, n, o) {
          ...
          if (
            ("string" == typeof n
              ? (this.base = this.parseComponent(n))
              : "object" === r(n) && n.steps && (this.base = n),
            "string" === (s = this.checkType(e)))
          )
            return (this.str = e), Object(i.extend)(this, this.parse(e));
          if ("range" === s)
            return Object(i.extend)(this, this.fromRange(e, this.base, o));
          if ("node" === s)
            return Object(i.extend)(this, this.fromNode(e, this.base, o));
          if ("EpubCFI" === s && e.path) return e;
          if (e) throw new TypeError("not a valid argument for EpubCFI");
          return this;
        }
        var e, n, s;
        return (
          ...
          (n = [
            {
              key: "checkType",
              value: function (e) {
                return this.isCfiString(e)
                  ? "string"
                  : !e ||
                      "object" !== r(e) ||
                      ("Range" !== Object(i.type)(e) &&
                        void 0 === e.startContainer)
                    ? e && "object" === r(e) && void 0 !== e.nodeType
                      ? "node"
                      : !!(e && "object" === r(e) && e instanceof t) &&
                        "EpubCFI"
                    : "range";
              },
            },
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  i.length > 1 &&
                    ((e = i[1]), (n.terminal = this.parseTerminal(e))),
                  "" === r[0] && r.shift(),
                  (n.steps = r.map(
                    function (t) {
            ...
            },
            {
              ...
              value: function (e, n) {
                ...
                if (
                  ...
                  e.spinePos > n.spinePos)
                )
                  return 1;
                if (e.spinePos < n.spinePos) return -1;
                e.range
                  ? ((i = e.path.steps.concat(e.start.steps)),
                    (o = e.start.terminal))
                  : ((i = e.path.steps), (o = e.path.terminal)),
                  n.range
                    ? ((r = n.path.steps.concat(n.start.steps)),
                      (s = n.start.terminal))
                    : ((r = n.path.steps), (s = n.path.terminal));
                for (var a = 0; a < i.length; a++) {
                  if (!i[a]) return -1;
                  if (!r[a]) return 1;
                  if (i[a].index > r[a].index) return 1;
                  if (i[a].index < r[a].index) return -1;
                }
              ...
              value: function (t, e, n) {
                for (
                  var i,
                    ...
                    o = t;
                  o && o.parentNode && 9 != o.parentNode.nodeType;

                )
                  (i = n ? this.filteredStep(o, n) : this.step(o)) &&
                    r.steps.unshift(i),
                    (o = o.parentNode);
                return (
                  null != e &&
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var i = {
                  ...
                  c = !1;
                if (
                  (n && (c = null != o.ownerDocument.querySelector("." + n)),
                  "string" == typeof e
                  ...
                  c && (a = this.patchOffset(o, a, n)),
                    (i.path = this.pathTo(o, a, n));
                else {
                  (i.range = !0),
                    c && (a = this.patchOffset(o, a, n)),
                    (i.start = this.pathTo(o, a, n)),
                    c && (u = this.patchOffset(s, u, n)),
                    (i.end = this.pathTo(s, u, n)),
                    (i.path = { steps: [], terminal: null });
                  var h,
                    l = i.start.steps.length;
                  for (
                    h = 0;
                    h < l && this.equalStep(i.start.steps[h], i.end.steps[h]);
                    h++
                  )
                    h === l - 1
                      ? i.start.terminal === i.end.terminal &&
                        (i.path.steps.push(i.start.steps[h]), (i.range = !1))
                      : i.path.steps.push(i.start.steps[h]);
            ...
            },
            {
              ...
              value: function (t, e) {
                return Array.prototype.slice
                  ...
                  .filter(function (t) {
                    return (
                      3 === t.nodeType || !(!e || !t.classList.contains(e))
                    );
                  });
              },
            },
            ...
            },
            {
              ...
              value: function (t, e, n) {
                ...
                return (
                  n || void 0 === o.evaluate
                    ? (i = n ? this.walkToNode(t, o, n) : this.walkToNode(t, o))
            ...
            },
            {
              ...
              value: function (t, e, n, i) {
                var r,
                  o,
                  s = this.findNode(t.slice(0, -1), n, i),
                  a = s.childNodes,
                  u = this.normalizedMap(a, 3, i),
                  c = t[t.length - 1].index;
                for (var h in u) {
                  if (!u.hasOwnProperty(h)) return;
                  if (u[h] === c) {
                    if (!(e > (o = (r = a[h]).textContent.length))) {
                      s = 1 === r.nodeType ? r.childNodes[0] : r;
                      break;
                    }
                    e -= o;
                  }
                }
                return { container: s, offset: e };
              },
            },
            {
              key: "toRange",
              value: function (t, e) {
                var n,
                  ...
                  h,
                  l = t || document,
                  f = !!e && null != l.querySelector("." + e);
                if (
                  ((n =
                    void 0 !== l.createRange
                      ? l.createRange()
                      : new i.RangeObject()),
                  this.range
                    ? ((r = this.start),
                      (u = this.path.steps.concat(r.steps)),
                      (s = this.findNode(u, l, f ? e : null)),
                      (o = this.end),
                      (c = this.path.steps.concat(o.steps)),
                      (a = this.findNode(c, l, f ? e : null)))
                    : ((r = this.path),
                      (u = this.path.steps),
                      (s = this.findNode(this.path.steps, l, f ? e : null))),
                  !s)
                )
                  return (
                ...
                try {
                  null != r.terminal.offset
                    ? n.setStart(s, r.terminal.offset)
                    : n.setStart(s, 0);
                } catch (t) {
                  (h = this.fixMiss(u, r.terminal.offset, l, f ? e : null)),
                    n.setStart(h.container, h.offset);
                }
                if (a)
                  try {
                    null != o.terminal.offset
                      ? n.setEnd(a, o.terminal.offset)
                      : n.setEnd(a, 0);
                  } catch (t) {
                    (h = this.fixMiss(
                      c,
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        var n,
          ...
          v = t.global,
          g = t.stat;
        if ((n = v ? i : g ? i[p] || a(p, {}) : (i[p] || {}).prototype))
          for (h in e) {
            if (
              ((f = e[h]),
              (l = t.noTargetGet ? (d = r(n, h)) && d.value : n[h]),
              !c(v ? h : p + (g ? "." : "#") + h, t.forced) && void 0 !== l)
            ) {
              if (typeof f == typeof l) continue;
              u(f, l);
            }
            (t.sham || (l && l.sham)) && o(f, "sham", !0), s(n, h, f, t);
          }
      };
    },
    function (t, e) {
    ...
    function (t, e, n) {
      var i = n(6),
        ...
        c = r("wks"),
        h = i.Symbol,
        l = u ? h : (h && h.withoutSetter) || s;
      t.exports = function (t) {
        return (
          o(c, t) || (a && o(h, t) ? (c[t] = h[t]) : (c[t] = l("Symbol." + t))),
          c[t]
        );
      };
    },
    ...
    function (t, e, n) {
      ...
      (r = function (t, e) {
            ...
            if (y.call(this, "__ee__") && (r = this.__ee__[t]))
              if ("object" == typeof r) {
                for (
                  ...
                  o[e - 1] = arguments[e];
                for (r = r.slice(), e = 0; (i = r[e]); ++e) f.call(i, this, o);
              } else
        ...
        (u = { on: h(i), once: h(r), off: h(o), emit: h(s) }),
        (c = g({}, u)),
        (t.exports = e =
          function (t) {
            return null == t ? p(c) : g(Object(t), u);
          }),
        (e.methods = a);
    },
    function (t, e) {
    ...
    function (t, e, n) {
      ...
      i(
        { target: "Array", proto: !0, forced: u || !c || !h },
        {
          indexOf: function (t) {
            return u
    ...
    function (t, e, n) {
      "use strict";
      n(14), n(15), n(36), n(10), n(16), n(19), n(23), n(48);
      var i = n(26),
        r = n.n(i);
      function o(t, e) {
        for (var n = 0; n < e.length; n++) {
      ...
      var s = (function () {
        function t(e) {
          ...
          !(function (t, e) {
            ...
            e.indexOf("://") > -1 && (e = new URL(e).pathname),
            (n = this.parse(e)),
            (this.path = e),
            this.isDirectory(e)
              ? (this.directory = e)
              : (this.directory = n.dir + "/"),
            (this.filename = n.base),
            (this.extension = n.ext.slice(1));
        }
        var e, n, i;
        return (
          (e = t),
    ...
    function (t, e, n) {
      "use strict";
      n(14), n(15), n(10), n(16), n(19), n(196), n(23), n(48);
      var i = n(17),
        r = n(26),
        o = n.n(r);
      function s(t, e) {
        ...
        function t(e, n) {
          ...
          if (
            ...
            try {
              ...
              (this.Url = void 0),
                this.base && (o = new i.a(this.base).resolve(o));
            }
          (this.Path = new i.a(o)),
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return t.indexOf("://") > -1
                  ? t
                  : ((e = o.a.resolve(this.directory, t)), this.origin + e);
              },
            },
            {
              key: "relative",
              value: function (t) {
                return o.a.relative(t, this.directory);
              },
            },
            {
              key: "toString",
    ...
    function (t, e, n) {
      "use strict";
      n(7), n(15), n(85), n(10), n(29), n(19), n(11), n(23);
      function i(t, e) {
        for (var n = 0; n < e.length; n++) {
          var i = e[n];
          (i.enumerable = i.enumerable || !1),
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: "deregister",
              value: function (t) {
                for (var e = 0; e < this.hooks.length; e++)
                  if (this.hooks[e] === t) {
    ...
    function (t, e, n) {
      ...
      function o(t, e) {
        for (var n, i = "", r = -1, o = 0, s = 0; s <= t.length; ++s) {
          ...
          if (47 === n) {
            if (r === s - 1 || 1 === o);
              ...
              if (
                ...
                if (i.length > 2) {
                  for (
                    var a = i.length - 1, u = a;
                    u >= 0 && 47 !== i.charCodeAt(u);
                    --u
                  );
                  if (u !== a) {
                    (i = -1 === u ? "" : i.slice(0, u)), (r = s), (o = 0);
                    continue;
                  }
      ...
      var s = {
        resolve: function () {
          for (
            var t, e = "", n = !1, s = arguments.length - 1;
            s >= -1 && !n;
            s--
          ) {
            var a;
        ...
        relative: function (t, e) {
          ...
          if ((t = s.resolve(t)) === (e = s.resolve(e))) return "";
          for (var n = 1; n < t.length && 47 === t.charCodeAt(n); ++n);
          for (
            var i = t.length, o = i - n, a = 1;
            a < e.length && 47 === e.charCodeAt(a);
            ++a
          );
          for (
            var u = e.length - a, c = o < u ? o : u, h = -1, l = 0;
            l <= c;
            ++l
          ) {
            if (l === c) {
              if (u > c) {
                if (47 === e.charCodeAt(a + l)) return e.slice(a + l + 1);
                if (0 === l) return e.slice(a + l);
              } else
                o > c &&
                  (47 === t.charCodeAt(n + l) ? (h = l) : 0 === l && (h = 0));
              break;
            }
            var f = t.charCodeAt(n + l);
            if (f !== e.charCodeAt(a + l)) break;
            47 === f && (h = l);
          }
          var d = "";
          for (l = n + h + 1; l <= i; ++l)
            (l !== i && 47 !== t.charCodeAt(l)) ||
              (0 === d.length ? (d += "..") : (d += "/.."));
          return d.length > 0
            ? d + e.slice(a + h)
            : ((a += h), 47 === e.charCodeAt(a) && ++a, e.slice(a));
        },
        ...
        extname: function (t) {
          r(t);
          for (
            var e = -1, n = 0, i = -1, o = !0, s = 0, a = t.length - 1;
            a >= 0;
            --a
          ) {
        ...
        parse: function (t) {
          ...
          o ? ((e.root = "/"), (n = 1)) : (n = 0);
          for (
            var s = -1, a = 0, u = -1, c = !0, h = t.length - 1, l = 0;
            h >= n;
            --h
          )
          ...
          return (
            ...
            (1 === l && s === u - 1 && s === a + 1)
              ? -1 !== u &&
                (e.base = e.name = 0 === a && o ? t.slice(1, u) : t.slice(a, u))
              : (0 === a && o
                  ? ((e.name = t.slice(1, s)), (e.base = t.slice(1, u)))
                  : ((e.name = t.slice(a, s)), (e.base = t.slice(a, u))),
                (e.ext = t.slice(s, u))),
            a > 0 ? (e.dir = t.slice(0, a - 1)) : o && (e.dir = "/"),
            e
          );
        },
        sep: "/",
    ...
    function (t, e, n) {
      ...
      (t.exports = function (t, e, n, a) {
        ...
        "function" == typeof n &&
          ...
          (h(n).source = l.join("string" == typeof e ? e : ""))),
          t !== i
    ...
    function (t, e, n) {
      ...
      var i,
        ...
        Y = I(P, function () {
          ...
          if (A >= 51 && /native code/.test(M)) return !1;
          var t = M.resolve(1),
            e = function (t) {
              t(
                function () {},
      ...
      Y &&
        ...
        a(
          { target: P, stat: !0, forced: u || Y },
          {
            resolve: function (t) {
              return _(u && this === o ? M : this, t);
            },
          },
        ),
        a(
    ...
    function (t, e, n) {
      ...
      n(7), n(14), n(200), n(16), n(31), n(61), n(11);
      var i = n(0),
        r = n(20);
      n(17);
      function o(t, e) {
        ...
        t &&
          ...
          !s && window && window.location && (o = window.location.origin + o),
      ...
      function u(t, e) {
        ...
        if (n.length)
          for (
            var o = Object(i.qs)(t.ownerDocument, "base"),
              s = o ? o.getAttribute("href") : void 0,
              a = function (t) {
      ...
      t.exports = function (t, e) {
        ...
        return (a[t] =
          ...
          !r(function () {
            if (c && !i) return !0;
            var t = { length: -1 };
            c ? s(t, 1, { enumerable: !0, get: u }) : (t[1] = 1),
              n.call(t, h, l);
          }));
      };
    },
        ...
        { target: "Array", proto: !0, forced: !d || !p },
        {
          slice: function (t, e) {
            ...
            if (
              ...
              return g.call(l, d, p);
            for (
              i = new (void 0 === n ? Array : n)(y(p - d, 0)), h = 0;
              d < p;
              d++, h++
            )
              d in l && c(i, h, l[d]);
            ...
            [
              ...
              function (t, r) {
                ...
                for (var w = 0, k = 0, x = []; k < f.length; ) {
                  ...
                  if (
                    null === S ||
                    (E = p(c(m.lastIndex + (v ? 0 : k)), f.length)) === w
                  )
                    k = u(f, k, g);
                  else {
    ...
    function (t, e, n) {
      ...
      var i,
        ...
        z = function (t, e) {
          ...
          if ("[" == e.charAt(0)) {
            ...
            for (n = "", i = d(e), r = 0; r < i.length; r++) n += V(i[r], U);
            t.host = n;
          }
        },
        B = function (t) {
          ...
          for (n = [], i = 0; i < e; i++) {
            ...
            if (
              ...
              r.length > 1 &&
                "0" == r.charAt(0) &&
                ((o = R.test(r) ? 16 : 8), (r = r.slice(8 == o ? 1 : 2))),
              "" === r)
            )
              s = 0;
            else {
              if (!(10 == o ? I : 8 == o ? j : L).test(r)) return t;
              s = parseInt(r, o);
            }
            n.push(s);
          }
        ...
        M = function (t) {
          ...
          for (; f(); ) {
            if (8 == c) return;
            if (":" != f()) {
              for (e = n = 0; n < 4 && L.test(f()); )
                (e = 16 * e + parseInt(f(), 16)), l++, n++;
              if ("." == f()) {
                if (0 == n) return;
                if (((l -= n), c > 6)) return;
                for (i = 0; f(); ) {
          ...
          for (
            ...
            switch (((s = o[f]), h)) {
              ...
              case st:
                ...
                break;
              case at:
                if (((h = ut), "/" != s || "/" != p.charAt(f + 1))) continue;
                f++;
                break;
              case ut:
                if ("/" != s && "\\" != s) {
                ...
                if (!T.test(s)) {
                  if (
                    ...
                    if ("" != p) {
                      ...
                      (t.port = G(t) && k === X[t.scheme] ? null : k), (p = "");
                    }
                    if (n) return;
                    h = gt;
                    continue;
              ...
              case gt:
                if (G(t)) {
                  if (((h = yt), "/" != s && "\\" != s)) continue;
                } else if (n || "?" != s)
                  if (n || "#" != s) {
                    if (s != i && ((h = yt), "/" != s)) continue;
                  } else (t.fragment = ""), (h = wt);
                else (t.query = ""), (h = bt);
                break;
              case yt:
                if (
        ...
        xt = function (t) {
          var e,
            ...
            a = x(i, { type: "URL" });
          if (void 0 !== r)
            if (r instanceof xt) e = E(r);
            else if ((n = kt((e = {}), String(r)))) throw TypeError(n);
          ...
          c.updateSearchParams(a.query),
            ...
            o ||
              ...
              (i.username = Ct.call(i)),
              (i.password = Tt.call(i)),
              (i.host = Rt.call(i)),
              (i.hostname = jt.call(i)),
              (i.port = It.call(i)),
              (i.pathname = Lt.call(i)),
              (i.search = At.call(i)),
              (i.searchParams = Nt.call(i)),
              (i.hash = Pt.call(i)));
        },
        Et = xt.prototype,
        St = function () {
        ...
        (o &&
          u(Et, {
            ...
            username: Dt(Ct, function (t) {
              ...
              if (!K(e)) {
                e.username = "";
                for (var i = 0; i < n.length; i++) e.username += V(n[i], H);
              }
            }),
            password: Dt(Tt, function (t) {
              ...
              if (!K(e)) {
                e.password = "";
                for (var i = 0; i < n.length; i++) e.password += V(n[i], H);
              }
            }),
            ...
            hostname: Dt(jt, function (t) {
              var e = E(this);
              e.cannotBeABaseURL || kt(e, String(t), lt);
            }),
            port: Dt(It, function (t) {
              var e = E(this);
              K(e) || ("" == (t = String(t)) ? (e.port = null) : kt(e, t, ft));
            }),
      ...
      g(xt, "URL"), r({ global: !0, forced: !s, sham: !o }, { URL: xt });
    },
    function (t, e, n) {
      "use strict";
      n(10), n(29);
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  this.running ||
                    ((this.running = !0), (this.defered = new i.defer())),
                  this.tick.call(window, function () {
                    t._q.length
                      ...
                      : (t.defered.resolve(), (t.running = void 0));
                  }),
      ...
      var f = (function () {
        function t(e) {
          !(function (t, e) {
            ...
            (this.settings = e || {}),
            (this.id = "epubjs-container-" + Object(o.uuid)()),
          ...
          (n = [
            {
              ...
              value: function (t) {
                var e = t.height,
                  ...
                  r = t.axis || "vertical",
                  s = t.direction;
                Object(o.extend)(this.settings, t),
                  t.height &&
                    Object(o.isNumber)(t.height) &&
                    (e = t.height + "px"),
                  t.width &&
                    Object(o.isNumber)(t.width) &&
                    (n = t.width + "px");
            ...
            },
            {
              key: "onResize",
              value: function (t) {
                (Object(o.isNumber)(this.settings.width) &&
                  Object(o.isNumber)(this.settings.height)) ||
                  ((this.resizeFunc = h()(t, 50)),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                null === t
                  ...
                  Object(o.isNumber)(t) || (t = this.container.clientWidth),
                  Object(o.isNumber)(e) || (e = this.container.clientHeight),
                ...
                var s = Object(o.windowBounds)(),
                  a = window.getComputedStyle(document.body),
                  u = parseFloat(a["padding-left"]) || 0,
                  c = parseFloat(a["padding-right"]) || 0,
                  h = parseFloat(a["padding-top"]) || 0,
                  l = parseFloat(a["padding-bottom"]) || 0;
                return (
                  i || (t = s.width - u - c),
                  ((this.settings.fullsize && !r) || !r) &&
                    (e = s.height - h - l),
                  {
                    width:
                      t -
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  t && t.width && t.height ? t : Object(o.windowBounds)()
                );
              },
            },
            {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (this.length) {
                    for (var n = 0; n < e; n++)
                      (t = this._views[n]), this.destroy(t);
      ...
      var m = (function () {
        function t(e) {
          !(function (t, e) {
            ...
            (this.name = "default"),
            (this.optsSettings = e.settings),
            (this.View = e.view),
            (this.request = e.request),
            (this.renditionQueue = e.queue),
            (this.q = new u.a(this)),
            (this.settings = Object(o.extend)(this.settings || {}, {
              infinite: !0,
              hidden: !1,
              width: void 0,
              height: void 0,
            ...
            Object(o.extend)(this.settings, e.settings || {}),
            (this.viewSettings = {
          ...
          (n = [
            {
              ...
              value: function (t, e) {
                ...
                void 0 !== this.settings.fullsize ||
                  ...
                  (this.views = new p(this.container)),
                    ...
                    function () {
                      (this.orientationTimeout = void 0),
                        this.optsSettings.resizeOnOrientationChange &&
                          this.resize(),
                        this.emit(v.c.MANAGERS.ORIENTATION_CHANGE, e);
                    }.bind(this),
                    500,
                  ));
              },
            ...
            },
            {
              key: "resize",
              value: function (t, e, n) {
                var i = this.stage.size(t, e);
                (this.winBounds = Object(o.windowBounds)()),
            ...
            },
            {
              ...
              value: function (t, e) {
                return new this.View(
                  t,
                  Object(o.extend)(this.viewSettings, { forceRight: e }),
                );
              },
            },
            {
              ...
              value: function (t, e, n) {
                ...
                if (
                  ...
                  if (
                    (i = e.next()) &&
                    !i.properties.includes("page-spread-left")
                  )
            ...
            },
            {
              ...
              value: function (t, e) {
                var n = new o.defer(),
                  i = n.promise;
                (e === t.href || Object(o.isNumber)(e)) && (e = void 0);
                var r = this.views.find(t);
                if (r && t && "pre-paginated" !== this.layout.name) {
                  var s = r.offset();
                  if ("ltr" === this.settings.direction)
                    this.scrollTo(s.left, s.top, !0);
                  else {
                    var a = r.width();
                    this.scrollTo(s.left + a, s.top, !0);
                  }
                  if (e) {
                    var u = r.locationOf(e),
                      c = r.width();
                    this.moveTo(u, c);
                  }
                  return n.resolve(), i;
            ...
            },
            {
              key: "afterDisplayed",
              value: function (t) {
                this.emit(v.c.MANAGERS.ADDED, t);
              },
            },
            {
              key: "afterResized",
              value: function (t) {
                this.emit(v.c.MANAGERS.RESIZE, t.section);
              },
            },
            {
              key: "moveTo",
              value: function (t, e) {
                ...
                this.isPaginated
                  ? ((n =
                      ...
                      (n = this.container.scrollWidth - this.layout.delta),
                    (i =
                      Math.floor(t.top / this.layout.delta) *
                      this.layout.delta) +
                      this.layout.delta >
                      this.container.scrollHeight &&
                      (i = this.container.scrollHeight - this.layout.delta))
                  : (i = t.top),
                  "rtl" === this.settings.direction &&
                    ((n += this.layout.delta), (n -= e)),
                  this.scrollTo(n, i, !0);
              },
            },
            {
              ...
              value: function (t, e) {
                var n = this,
                  i = this.createView(t, e);
                return (
                  this.views.append(i),
                  (i.onDisplayed = this.afterDisplayed.bind(this)),
                  (i.onResize = this.afterResized.bind(this)),
                  i.on(v.c.VIEWS.AXIS, function (t) {
                    n.updateAxis(t);
                  }),
                  i.on(v.c.VIEWS.WRITING_MODE, function (t) {
                    n.updateWritingMode(t);
                  }),
            ...
            },
            {
              ...
              value: function (t, e) {
                var n = this,
                  i = this.createView(t, e);
                return (
                  i.on(v.c.VIEWS.RESIZED, function (t) {
                    n.counter(t);
                  }),
                      ...
                      ? ((this.scrollLeft = this.container.scrollLeft),
                        "default" === this.settings.rtlScrollType
                          ...
                          : this.container.scrollLeft + -1 * this.layout.delta >
                            ...
                            ? this.scrollBy(this.layout.delta, 0, !0)
                            : (t = this.views.last().section.next()))
                      : this.isPaginated && "vertical" === this.settings.axis
                ...
                var t = this,
                  ...
                  i =
                    n.height < window.innerHeight
                      ? n.height
                      : window.innerHeight,
                  r = n.width < window.innerWidth ? n.width : window.innerWidth,
                  o = "vertical" === this.settings.axis,
                  s = (this.settings.direction, 0);
                return (
                  this.settings.fullsize &&
                    (s = o ? window.scrollY : window.scrollX),
                  e.map(function (e) {
                    var a,
                      u,
                      c,
                      ...
                      g = e.height();
                    o
                      ? ((u = (a = s + n.top - p.top + 0) + i - 0),
                        (h = t.layout.count(g, i).pages),
                        (c = i))
                      : ((u = (a = s + n.left - p.left + 0) + r - 0),
                        (h = t.layout.count(v, r).pages),
                        (c = r));
                    var y = Math.ceil(a / c),
                      m = [],
                      b = Math.ceil(u / c);
                    if ("rtl" === t.settings.direction && !o) {
                      var w = y;
                      (y = h - b), (b = h - w);
                    }
                    m = [];
                ...
                return (
                  ...
                  e.map(function (e) {
                    var o,
                      ...
                      f = e.position(),
                      d = e.width();
                    "rtl" === t.settings.direction
                      ? ((o = n.right - i),
                        (u =
                          Math.min(Math.abs(o - f.left), t.layout.width) - r),
                        (s = (a = f.width - (f.right - o) - r) - u))
                      : ((o = n.left + i),
                        (u = Math.min(f.right - o, t.layout.width) - r),
                        (a = (s = o - f.left + r) + u)),
                      (r += u);
                    var p = t.mapping.page(e.contents, e.section.cfiBase, s, a),
                      v = t.layout.count(d).pages,
                      g = Math.floor(s / t.layout.pageWidth),
                      y = [],
                      m = Math.floor(a / t.layout.pageWidth);
                    if (
                      (g < 0 && ((g = 0), (m += 1)),
                      "rtl" === t.settings.direction)
                    ) {
            ...
            },
            {
              ...
              value: function () {
                for (
                  ...
                  (t = n[o]), !0 === this.isVisible(t, 0, 0, e) && r.push(t);
                return r;
              },
            },
            {
              key: "scrollBy",
              value: function (t, e, n) {
                var i = "rtl" === this.settings.direction ? -1 : 1;
                n && (this.ignore = !0),
                  this.settings.fullsize
            ...
            },
            {
              ...
              value: function () {
                ...
                this.settings.fullsize
                  ...
                  this.ignore
                    ? (this.ignore = !1)
                    : (this.emit(v.c.MANAGERS.SCROLL, { top: t, left: e }),
                      clearTimeout(this.afterScrolled),
                      (this.afterScrolled = setTimeout(
                        function () {
                          this.emit(v.c.MANAGERS.SCROLLED, {
                            top: this.scrollTop,
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t, e, n, r) {
                var o,
                  s = !(!t || !t.document) && t.document.body;
                if (s) {
                  if (
                    ((o = this.rangePairToCfiPair(e, {
                      start: this.findStart(s, n, r),
                      end: this.findEnd(s, n, r),
                    })),
                    !0 === this._dev)
                  ) {
                    var a = t.document,
                      u = new i.a(o.start).toRange(a),
                      c = new i.a(o.end).toRange(a),
                      h = a.defaultView.getSelection(),
                      l = a.createRange();
                    h.removeAllRanges(),
                      l.setStart(u.startContainer, u.startOffset),
                      l.setEnd(c.endContainer, c.endOffset),
                      h.addRange(l);
                  }
                  return o;
                }
              ...
              value: function (t) {
                for (
                  var e,
                    ...
                    o =
                      Math.ceil(r / this.layout.spreadWidth) *
                      this.layout.divisor,
                    s = this.layout.columnWidth,
                    a = this.layout.gap,
                    u = 0;
                  u < o.pages;
                  u++
            ...
            },
            {
              key: "findStart",
              value: function (t, e, n) {
                for (var i, o, s = this, a = [t], u = t; a.length; )
                  if (
                    ((i = a.shift()),
                    (o = this.walk(i, function (t) {
                      var i, o, c, h, l;
                      if (
                        ((l = Object(r.nodeBounds)(t)),
                        s.horizontal && "ltr" === s.direction)
                      ) {
                        if (
                          ((i = s.horizontal ? l.left : l.top),
                          (o = s.horizontal ? l.right : l.bottom),
                          i >= e && i <= n)
                        )
                          return t;
                        if (o > e) return t;
                        (u = t), a.push(t);
                      } else if (s.horizontal && "rtl" === s.direction) {
                        if (((i = l.left), (o = l.right) <= n && o >= e))
                          return t;
                        if (i < n) return t;
                        (u = t), a.push(t);
                      } else {
                        if (((c = l.top), (h = l.bottom), c >= e && c <= n))
                          return t;
                        if (h > e) return t;
                        (u = t), a.push(t);
                      }
                    ...
                    return this.findTextStartRange(o, e, n);
                return this.findTextStartRange(u, e, n);
              },
            },
            {
              key: "findEnd",
                  ...
                  if (
                    ...
                    (o = this.walk(i, function (t) {
                      ...
                      if (
                        ...
                        if (
                          ((i = Math.round(s.horizontal ? l.left : l.top)),
                          (o = Math.round(s.horizontal ? l.right : l.bottom)) <
                            e && u)
                        )
                          return u;
                        if (i < e) return t;
                    ...
                    return this.findTextEndRange(o, e, n);
                return this.findTextEndRange(u, e, n);
              },
            },
            {
              ...
              value: function (t, e, n) {
                for (
                  var i, r, o = this.splitTextNodeIntoRanges(t), s = 0;
                  s < o.length;
                  s++
                )
                  if (
                    ((r = (i = o[s]).getBoundingClientRect()),
              ...
              value: function (t, e, n) {
                for (
                  var i,
                    ...
                    u,
                    c,
                    h = this.splitTextNodeIntoRanges(t),
                    l = 0;
                  l < h.length;
                  l++
                ) {
                  if (
                    ((o = (r = h[l]).getBoundingClientRect()),
                    this.horizontal && "ltr" === this.direction)
                  ) {
                    if (((s = o.left), (a = o.right), s > n && i)) return i;
                    if (a > n) return r;
                  } else if (this.horizontal && "rtl" === this.direction) {
                    if (((s = o.left), (a = o.right) < e && i)) return i;
                    if (s < e) return r;
                  } else {
                    if (((u = o.top), (c = o.bottom), u > n && i)) return i;
                    if (c > n) return r;
                  }
                  i = r;
                }
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                if (-1 === a || t.nodeType != Node.TEXT_NODE)
                  return (n = o.createRange()).selectNodeContents(t), [n];
                for (
                  (n = o.createRange()).setStart(t, 0),
                    n.setEnd(t, a),
                    i.push(n),
                    n = !1;
                  -1 != a;
                  ...
                  (a = r.indexOf(s, a + 1)) > 0 &&
                    ...
                    (n = o.createRange()).setStart(t, a + 1));
            ...
            },
            {
              ...
              value: function (t) {
                return (
                  t && (this.horizontal = "horizontal" === t), this.horizontal
                );
              },
            },
          ]) && s(e.prototype, n),
          ...
          concat: function (t) {
            ...
            for (e = -1, i = arguments.length; e < i; e++)
              if (y((o = -1 === e ? s : arguments[e]))) {
                if (f + (r = u(o.length)) > 9007199254740991)
                  throw TypeError("Maximum allowed index exceeded");
                for (n = 0; n < r; n++, f++) n in o && c(l, f, o[n]);
              } else {
    ...
    function (t, e, n) {
      ...
      i("replace", 2, function (t, e, n, i) {
        ...
        return [
          ...
          function (t, i) {
            if ((!g && y) || ("string" == typeof i && -1 === i.indexOf(m))) {
              var o = n(e, t, this, i);
            ...
            for (var k = []; ; ) {
              ...
              if (null === x) break;
              if ((k.push(x), !v)) break;
              "" === String(x[0]) && (u.lastIndex = c(d, s(u.lastIndex), w));
            }
            for (var E, S = "", O = 0, _ = 0; _ < k.length; _++) {
              x = k[_];
              for (
                var C = String(x[0]),
                  T = l(f(a(x.index), d.length), 0),
                  R = [],
                  j = 1;
                j < x.length;
                j++
              )
                R.push(void 0 === (E = x[j]) ? E : String(E));
              var I = x.groups;
              if (p) {
                var L = [C].concat(R, T, d);
                void 0 !== I && L.push(I);
                var A = String(i.apply(void 0, L));
              } else A = b(C, d, T, R, I, i);
              T >= O && ((S += d.slice(O, T) + A), (O = T + C.length));
            }
            return S + d.slice(O);
          },
        ];
    ...
    function (t, e, n) {
      ...
      var i = n(3),
        ...
        ut = function (t) {
          ...
          return (
            !(this === W && l($, e) && !l(Z, e)) &&
            (!(n || !l(this, e) || !l($, e) || (l(this, M) && this[M][e])) || n)
          );
        },
        ct = function (t, e) {
          var n = g(t),
          ...
          if (n !== W || !l($, i) || l(Z, i)) {
            var r = X(n, i);
            return (
              !r || !l($, i) || (l(n, M) && n[M][i]) || (r.enumerable = !0), r
            );
          }
        },
        ht = function (t) {
      ...
      (u ||
        (T(
          (H = function () {
            ...
            return a && nt && it(W, e, { configurable: !0, set: n }), rt(e, t);
          }).prototype,
          "toString",
          function () {
            return F(this).tag;
        ...
        a &&
          ...
          s || T(W, "propertyIsEnumerable", ut, { unsafe: !0 }))),
      i({ global: !0, wrap: !0, forced: !u, sham: !u }, { Symbol: H }),
      B(w(tt), function (t) {
        P(t);
      }),
      i(
      ...
      i(
        ...
        { getOwnPropertyNames: ht, getOwnPropertySymbols: lt },
      ),
      i(
        {
          target: "Object",
      ...
      H.prototype[q] || C(H.prototype, q, H.prototype.valueOf),
        D(H, "Symbol"),
        (I[M] = !0);
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      var l = "undefined" != typeof navigator,
        f = l && /Chrome/.test(navigator.userAgent),
        d = l && !f && /AppleWebKit/.test(navigator.userAgent),
        p = (function () {
          function t(e, n, i, r) {
            !(function (t, e) {
              if (!(t instanceof e))
              ...
              (this.epubcfi = new s.a()),
              (this.document = e),
              (this.documentElement = this.document.documentElement),
              (this.content = n || this.document.body),
              (this.window = this.document.defaultView),
              (this._size = { width: 0, height: 0 }),
              (this.sectionIndex = r || 0),
              (this.cfiBase = i || ""),
              this.epubReadingSystem("epub.js", c.b),
              (this.called = 0),
              (this.active = !0),
              this.listeners();
          }
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (n && n.hasAttribute("content")) {
                    var s = n.getAttribute("content"),
                      a = s.match(/width\s*=\s*([^,]*)/),
                      u = s.match(/height\s*=\s*([^,]*)/),
                      c = s.match(/initial-scale\s*=\s*([^,]*)/),
                      h = s.match(/minimum-scale\s*=\s*([^,]*)/),
                      l = s.match(/maximum-scale\s*=\s*([^,]*)/),
                      f = s.match(/user-scalable\s*=\s*([^,]*)/);
                    a && a.length && void 0 !== a[1] && (i.width = a[1]),
                      u && u.length && void 0 !== u[1] && (i.height = u[1]),
                      c && c.length && void 0 !== c[1] && (i.scale = c[1]),
                      h && h.length && void 0 !== h[1] && (i.minimum = h[1]),
                      l && l.length && void 0 !== l[1] && (i.maximum = l[1]),
                      f && f.length && void 0 !== f[1] && (i.scalable = f[1]);
                  }
                  return (
                    (e = Object(o.defaults)(t || {}, i)),
                    t &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (t == this._size.width && e == this._size.height) ||
                    ...
                    this.emit(c.c.CONTENTS.RESIZE, this._size));
                },
              },
              {
                key: "resizeListeners",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  document.addEventListener("visibilitychange", function () {
                    "visible" === document.visibilityState && !1 === t.active
                      ? ((t.active = !0), t.resizeListeners())
                      : ((t.active = !1), clearTimeout(t.expanding));
                  });
                },
              },
              {
                ...
                value: function () {
                  for (
                    ...
                    for (var r = 0; r < i.length; r += 1)
                      i[r].media &&
                        this.window
                          .matchMedia(i[r].media.mediaText)
                          .addListener(e);
                  }
                },
              },
              {
                ...
                value: function () {
                  ...
                  (this.observer = new ResizeObserver(function (e) {
                    requestAnimationFrame(t.resizeCheck.bind(t));
                  })),
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  if (this.epubcfi.isCfiString(t)) {
                    var r = new s.a(t).toRange(this.document, e);
                    if (r) {
                      try {
                        if (
                          !r.endContainer ||
                          ...
                          var o = r.startContainer.textContent.indexOf(
                            " ",
                            r.startOffset,
                          );
                          -1 == o && (o = r.startContainer.textContent.length),
                            r.setEnd(r.startContainer, o);
                        }
                      } catch (t) {
                        console.error(
                      ...
                      if (r.startContainer.nodeType === Node.ELEMENT_NODE)
                        ...
                        try {
                          1 === a.nodeType
                            ...
                            : r.startOffset + 2 < a.length
                              ? (u.setStart(a, r.startOffset),
                                u.setEnd(a, r.startOffset + 2),
                                (n = u.getBoundingClientRect()))
                              : r.startOffset - 2 > 0
                                ? (u.setStart(a, r.startOffset - 2),
                                  u.setEnd(a, r.startOffset),
                                  (n = u.getBoundingClientRect()))
                                : (n = a.parentNode.getBoundingClientRect());
                        } catch (t) {
                    ...
                    if (h)
                      if (d) {
                        var l = new Range();
                        l.selectNode(h), (n = l.getBoundingClientRect());
                      } else n = h.getBoundingClientRect();
                  }
                    ...
                    if (
                      ...
                      for (var i = 0, r = t.length; i < r; i++) {
                        var o = 1,
                          ...
                          u = "";
                        "[object Array]" ===
                          Object.prototype.toString.call(s[1][0]) &&
                          ((s = s[1]), (o = 0));
                        for (var c = s.length; o < c; o++) {
                          var h = s[o];
                          u +=
                            h[0] +
                            ":" +
                        ...
                        n.insertRule(a + "{" + u + "}", n.cssRules.length);
                      }
                    else
                ...
                value: function (t) {
                  ...
                  t &&
                    ...
                    ((e = t.getRangeAt(0)).collapsed ||
                      ((n = new s.a(e, this.cfiBase).toString()),
                      this.emit(c.c.CONTENTS.SELECTED, n),
                      this.emit(c.c.CONTENTS.SELECTED_RANGE, e)));
                },
              },
              {
                key: "range",
                value: function (t, e) {
                  return new s.a(t).toRange(this.document, e);
                },
              },
              {
                key: "cfiFromRange",
                value: function (t, e) {
                  return new s.a(t, this.cfiBase, e).toString();
                },
              },
              {
                key: "cfiFromNode",
              ...
              },
              {
                ...
                value: function (t, e, n, i, r) {
                  var s = Object(o.prefixed)("column-axis"),
                    a = Object(o.prefixed)("column-gap"),
                    u = Object(o.prefixed)("column-width"),
                    c = Object(o.prefixed)("column-fill"),
                    h =
                      0 === this.writingMode().indexOf("vertical")
                        ? "vertical"
                        : "horizontal";
                  this.layoutStyle("paginated"),
                    "rtl" === r && "horizontal" === h && this.direction(r),
                    this.width(t),
                    this.height(e),
                    this.viewport({
                      width: t,
              ...
              },
              {
                ...
                value: function (t, e, n) {
                  ...
                  if (
                    ...
                    this.scaler(u, 0, 0),
                    this.css("background-size", r * u + "px " + o * u + "px"),
              ...
              },
              {
                ...
                value: function () {
                  var t = this;
                  Object(u.c)(this.content, function (e) {
                    t.emit(c.c.CONTENTS.LINK_CLICKED, e);
                  });
                },
              },
              {
                key: "writingMode",
                value: function (t) {
                  var e = Object(o.prefixed)("writing-mode");
                  return (
                    t &&
                      this.documentElement &&
    ...
    function (t, e, n) {
      ...
      e.Pane = (function () {
        function t(e) {
          ...
          c(this, t),
            ...
            o.default.proxyMouse(this.target, this.marks),
            (this.container = n),
          ...
          i(t, [
            ...
            },
            {
              ...
              value: function () {
                ...
                try {
                  for (
                    var a, u = this.marks[Symbol.iterator]();
                    !(r = (a = u.next()).done);
                    r = !0
                  ) {
                    a.value.render();
      ...
      var h = (e.Mark = (function () {
          function t() {
            c(this, t), (this.element = null);
          }
          return (
            i(t, [
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (
                    ...
                    var a = e[o],
                      u = r.default.createElement("rect");
                    u.setAttribute("x", a.left - n.left + i.left),
                      u.setAttribute("y", a.top - n.top + i.top),
                      u.setAttribute("height", a.height),
                      u.setAttribute("width", a.width),
                      t.appendChild(u);
                  }
          ...
          i(e, [
            {
              ...
              value: function () {
                ...
                for (
                  ...
                  var c = r.default.createElement("line");
                  c.setAttribute("x1", a.left - n.left + i.left),
                    c.setAttribute("x2", a.left - n.left + i.left + a.width),
                    c.setAttribute("y1", a.top - n.top + i.top + a.height - 1),
                    c.setAttribute("y2", a.top - n.top + i.top + a.height - 1),
          ...
          return (
            ...
            c
              ? i
                ...
                : (s.lastIndex = 0)
              : h && i && (s.lastIndex = s.global ? i.index + i[0].length : e),
            f &&
              i &&
              i.length > 1 &&
          ...
          splice: function (t, e) {
            ...
            if (
              (0 === b
                ...
                : 1 === b
                  ? ((n = 0), (i = y - m))
                  : ((n = b - 2), (i = v(p(o(e), 0), y - m))),
              y + n - i > 9007199254740991)
            )
              throw TypeError("Maximum allowed length exceeded");
            for (h = u(g, i), l = 0; l < i; l++)
              (f = m + l) in g && c(h, l, g[f]);
            if (((h.length = i), n < i)) {
              for (l = m; l < y - i; l++)
                (d = l + n), (f = l + i) in g ? (g[d] = g[f]) : delete g[d];
              for (l = y; l > y - i + n; l--) delete g[l - 1];
            } else if (n > i)
              for (l = y - i; l > m; l--)
                (d = l + n - 1),
                  (f = l + i - 1) in g ? (g[d] = g[f]) : delete g[d];
            for (l = 0; l < n; l++) g[l + m] = arguments[l + 2];
            return (g.length = y - i + n), h;
          },
        },
      );
    },
    function (t, e, n) {
      ...
      var i = n(3),
        r = n(202).trim;
      i(
        { target: "String", proto: !0, forced: n(203)("trim") },
        {
          trim: function () {
            return r(this);
          },
      ...
      var l = (function () {
        function t(e) {
          !(function (t, e) {
            ...
            (this.settings = e),
            (this.name = e.layout || "reflowable"),
            (this._spread = "none" !== e.spread),
            (this._minSpreadWidth = e.minSpreadWidth || 800),
            (this._evenSpreads = e.evenSpreads || !1),
            "scrolled" === e.flow ||
            "scrolled-continuous" === e.flow ||
            "scrolled-doc" === e.flow
              ? (this._flow = "scrolled")
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var i,
                  ...
                  h = e,
                  l = Math.floor(c / 12);
                (a = this._spread && c >= this._minSpreadWidth ? 2 : 1),
                  "reflowable" !== this.name ||
                    "paginated" !== this._flow ||
                    n >= 0 ||
                    (u = l % 2 == 0 ? l : l - 1),
                  "pre-paginated" === this.name && (u = 0),
                  a > 1 ? (o = (i = c / a - u) + u) : ((i = c), (o = c)),
                  "pre-paginated" === this.name && a > 1 && (c = i),
                  (r = i * a + u),
                  (s = c),
                  (this.width = c),
                  (this.height = h),
              ...
              value: function (t, e) {
                ...
                return (
                  "pre-paginated" === this.name
                    ...
                    : "paginated" === this._flow
                      ? ((e = e || this.delta),
                        (i = (n = Math.ceil(t / e)) * this.divisor))
                      : ((e = e || this.height), (i = n = Math.ceil(t / e))),
                  { spreads: n, pages: i }
                );
              },
            },
              ...
              value: function (t) {
                ...
                if (
                  (Object.keys(t).forEach(function (n) {
                    e.props[n] === t[n] && delete t[n];
                  }),
                  Object.keys(t).length > 0)
                ) {
                  var n = Object(o.extend)(this.props, t);
                  this.emit(c.c.LAYOUT.UPDATED, n, t);
                }
              },
            },
          ]) && h(e.prototype, n),
          ...
          (n = [
            {
              ...
              value: function () {
                if (0 !== arguments.length)
                  return 1 === arguments.length && "object" === p(arguments[0])
                    ...
                    : 1 === arguments.length && "string" == typeof arguments[0]
                      ...
                      : 2 === arguments.length &&
                        ...
                        : 2 === arguments.length && "object" === p(arguments[1])
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (this._current = t),
                  this.update(t),
                  this.rendition.getContents().forEach(function (n) {
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var i = this,
                  r = this.rendition.getContents();
                (this._overrides[t] = { value: e, priority: !0 === n }),
                  r.forEach(function (e) {
                    e.css(t, i._overrides[t].value, i._overrides[t].priority);
                  });
              },
            },
            {
            ...
            b(t, [
              {
                ...
                value: function (t, e, n, i, r, o) {
                  ...
                  return (
                    (this._annotations[s] = c),
                    u in this._annotationsBySectionIndex
                      ? this._annotationsBySectionIndex[u].push(s)
                      : (this._annotationsBySectionIndex[u] = [s]),
                    this.rendition.views().forEach(function (t) {
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  if (i in this._annotations) {
                    var r = this._annotations[i];
                    if (e && r.type !== e) return;
                    this.rendition.views().forEach(function (t) {
                      n._removeFromAnnotationBySectionIndex(r.sectionIndex, i),
                        r.sectionIndex === t.index && r.detach(t);
                    }),
              ...
              },
              {
                ...
                value: function (t, e) {
                  this._annotationsBySectionIndex[t] = this._annotationsAt(
                    t,
                  ).filter(function (t) {
                    return t !== e;
                  });
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this,
                    n = t.index;
                  n in this._annotationsBySectionIndex &&
                    this._annotationsBySectionIndex[n].forEach(function (n) {
                      e._annotations[n].attach(t);
                    });
                },
              },
              {
            ...
            b(t, [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    "highlight" === r
                      ? (e = t.highlight(n, i, o, s, a))
                      : "underline" === r
                        ? (e = t.underline(n, i, o, s, a))
                        : "mark" === r && (e = t.mark(n, i, o)),
                    (this.mark = e),
                    this.emit(c.c.ANNOTATION.ATTACH, e),
                    e
                  );
                },
              },
                    ...
                    t &&
                      ("highlight" === i
                        ...
                        : "underline" === i
                          ...
                          : "mark" === i && (e = t.unmark(n))),
                    (this.mark = void 0),
                    this.emit(c.c.ANNOTATION.DETACH, e),
                    e
                  );
                },
              },
      ...
      var T = (function () {
        function t(e, n) {
          !(function (t, e) {
            ...
            Object(o.extend)(this.settings, n),
            "object" === _(this.settings.manager) &&
              (this.manager = this.settings.manager),
            (this.book = e),
            (this.hooks = {}),
            (this.hooks.display = new s.a(this)),
            (this.hooks.serialize = new s.a(this)),
            (this.hooks.content = new s.a(this)),
            (this.hooks.unloaded = new s.a(this)),
            (this.hooks.layout = new s.a(this)),
            (this.hooks.render = new s.a(this)),
            (this.hooks.show = new s.a(this)),
            ...
            (this.themes = new g(this)),
            (this.annotations = new x(this)),
            (this.epubcfi = new a.a()),
            (this.q = new u.a(this)),
            (this.location = void 0),
            this.q.enqueue(this.book.opened),
            (this.starting = new o.defer()),
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: "requireView",
              value: function (t) {
                return "string" == typeof t && "iframe" === t ? E.a : t;
              },
            },
            {
              key: "start",
              value: function () {
                ...
                this.manager ||
                  ...
                  this.manager.on(
                    c.c.MANAGERS.REMOVED,
                    this.afterRemoved.bind(this),
                  ),
                  this.manager.on(
                    c.c.MANAGERS.RESIZED,
                    this.onResized.bind(this),
                  ),
                  this.manager.on(
                    c.c.MANAGERS.ORIENTATION_CHANGE,
                    this.onOrientationChange.bind(this),
                  ),
                  this.manager.on(
                    c.c.MANAGERS.SCROLLED,
                    this.reportLocation.bind(this),
                  ),
                  this.emit(c.c.RENDITION.STARTED),
                ...
                return this.q.enqueue(
                  function () {
                    this.manager.render(t, {
                      ...
                      this.emit(c.c.RENDITION.ATTACHED);
                  }.bind(this),
                );
              },
            },
              ...
              value: function (t) {
                ...
                if (this.book) {
                  ...
                  return (
                    ...
                    (n = this.book.spine.get(t))
                      ? (this.manager.display(n, t).then(
                          function () {
                            i.resolve(n),
                              (e.displaying = void 0),
                              e.emit(c.c.RENDITION.DISPLAYED, n),
                              e.reportLocation();
                          },
                          function (t) {
                            e.emit(c.c.RENDITION.DISPLAY_ERROR, t);
                          },
                        ),
                        r)
                      : (i.reject(new Error("No Section Found")), r)
                  );
                }
              },
            },
            {
              ...
              value: function (t) {
                var e = this;
                t.on(c.c.VIEWS.MARK_CLICKED, function (n, i) {
                  return e.triggerMarkEvent(n, i, t.contents);
                }),
                  this.hooks.render.trigger(t, this).then(function () {
                    t.contents
                      ? e.hooks.content
                          .trigger(t.contents, e)
                          .then(function () {
                            e.emit(c.c.RENDITION.RENDERED, t.section, t);
                          })
                      : e.emit(c.c.RENDITION.RENDERED, t.section, t);
                  });
              },
            },
            {
              ...
              value: function (t) {
                var e = this;
                this.hooks.unloaded.trigger(t, this).then(function () {
                  e.emit(c.c.RENDITION.REMOVED, t.section, t);
                });
              },
            },
            {
            ...
            },
            {
              key: "onOrientationChange",
              value: function (t) {
                this.emit(c.c.RENDITION.ORIENTATION_CHANGE, t);
              },
            },
            {
              key: "moveTo",
            ...
            },
            {
              ...
              value: function (t) {
                var e = this.settings.layout || t.layout || "reflowable",
                  ...
                  o = t.viewport || "",
                  s = this.settings.minSpreadWidth || t.minSpreadWidth || 800,
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  t &&
                    ((this._layout = new f(t)),
                    this._layout.spread(t.spread, this.settings.minSpreadWidth),
                    this._layout.on(c.c.LAYOUT.UPDATED, function (t, n) {
                      e.emit(c.c.RENDITION.LAYOUT, t, n);
                    })),
                  this.manager &&
                    this._layout &&
                    this.manager.applyLayout(this._layout),
                    ...
                    requestAnimationFrame(
                      function () {
                        ...
                        if (t && t.then && "function" == typeof t.then)
                          t.then(
                            function (t) {
                              var e = this.located(t);
                              e &&
                                e.start &&
                                e.end &&
                                ((this.location = e),
                                this.emit(c.c.RENDITION.LOCATION_CHANGED, {
                          ...
                          (this.location = e),
                            ...
                            this.emit(c.c.RENDITION.RELOCATED, this.location);
                        }
                      }.bind(this),
                    );
                  }.bind(this),
              ...
              value: function (t) {
                ...
                null != r &&
                  ...
                  null != o &&
                    ((i.end.location = o),
                    (i.end.percentage =
                      this.book.locations.percentageFromLocation(o)));
                var s = this.book.pageList.pageFromCfi(e.mapping.start),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                c.a.forEach(function (n) {
                  t.on(n, function (n) {
                    return e.triggerViewEvent(n, t);
                  });
                }),
                  t.on(c.c.CONTENTS.SELECTED, function (n) {
                    return e.triggerSelectedEvent(n, t);
                  });
              },
            },
            {
            ...
            },
            {
              key: "triggerSelectedEvent",
              value: function (t, e) {
                this.emit(c.c.RENDITION.SELECTED, t, e);
              },
            },
            {
              key: "triggerMarkEvent",
              value: function (t, e, n) {
                this.emit(c.c.RENDITION.MARK_CLICKED, t, e, n);
              },
            },
            {
              key: "getRange",
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var e = t.window.getComputedStyle(t.content, null),
                  n =
                    0.95 *
            ...
            },
            {
              key: "views",
              value: function () {
                var t = this.manager ? this.manager.views : void 0;
                return t || [];
              },
            },
            {
              ...
              value: function (t) {
                var e = this;
                t &&
                  t.on(c.c.CONTENTS.LINK_CLICKED, function (t) {
                    var n = e.book.path.relative(t);
                    e.display(n);
                  });
              },
            },
            ...
            },
            {
              ...
              value: function (t, e) {
                var n = this.book.packaging.metadata.identifier,
    ...
    function (t, e, n) {
      "use strict";
      n(7), n(14), n(41), n(206), n(67), n(10), n(29), n(11);
      var i = n(12),
        r = n.n(i),
        o = n(0),
        s = n(2),
      ...
      var l = (function () {
        function t(e, n) {
          !(function (t, e) {
            ...
            (this.id = "epubjs-view-" + Object(o.uuid)()),
            (this.section = e),
            (this.index = e.index),
        ...
        return (
          ...
          (n = [
              ...
              value: function () {
                return (
                  this.iframe ||
                    ...
                    (this.added = !0),
                    (this.elementBounds = Object(o.bounds)(this.element)),
                  ...
                  this.sectionRender
                    ...
                    .then(
                      function () {
                        var t,
                          e = this,
                          n = this.contents.writingMode();
                        return (
                          (t =
                            "scrolled" === this.settings.flow
                              ? 0 === n.indexOf("vertical")
                                ? "horizontal"
                                : "vertical"
                              : 0 === n.indexOf("vertical")
                                ? "vertical"
                          ...
                          this.setAxis(t),
                          this.emit(u.c.VIEWS.AXIS, t),
                          this.setWritingMode(n),
                          this.emit(u.c.VIEWS.WRITING_MODE, n),
                          this.layout.format(
                            this.contents,
                            this.section,
                            this.axis,
                          ...
                          new Promise(function (t, n) {
                            e.expand(),
                              e.settings.forceRight &&
                                (e.element.style.marginLeft = e.width() + "px"),
                              t();
                          })
                        );
                      }.bind(this),
                      function (t) {
                        return (
                          this.emit(u.c.VIEWS.LOAD_ERROR, t),
                    ...
                    .then(
                      function () {
                        this.emit(u.c.VIEWS.RENDERED, this.section);
                      }.bind(this),
                    )
                );
              },
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var i,
                  r = Object(o.borders)(this.element);
                (i = this.iframe
                  ? Object(o.borders)(this.iframe)
                  : { width: 0, height: 0 }),
                  "width" == t &&
                    Object(o.isNumber)(e) &&
                    ...
                    : "horizontal" === this.settings.axis
                      ...
                      : "vertical" === this.settings.axis &&
                        ...
                        "paginated" === this.settings.flow &&
                          ...
                          (i =
                            Math.ceil(i / this.layout.height) *
                            this.layout.height)),
                  (this._needsReframe ||
                    n != this._width ||
                    i != this._height) &&
              ...
              value: function (t, e) {
                ...
                Object(o.isNumber)(t) &&
                  ...
                  requestAnimationFrame(function () {
                    var t;
                    for (var e in i.marks)
                      i.marks.hasOwnProperty(e) &&
                        ((t = i.marks[e]), i.placeMark(t.element, t.range));
                  }),
                  this.onResize(this, n),
                  this.emit(u.c.VIEWS.RESIZED, n),
                  (this.prevBounds = n),
                  (this.elementBounds = Object(o.bounds)(this.element));
              },
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  ...
                  (this.blobUrl = Object(o.createBlobUrl)(
                    t,
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                i
                  ...
                  this.contents.on(u.c.CONTENTS.EXPAND, function () {
                    n.displayed &&
                      n.iframe &&
                      (n.expand(), n.contents && n.layout.format(n.contents));
                  }),
                  this.contents.on(u.c.CONTENTS.RESIZE, function (t) {
                    n.displayed &&
                      n.iframe &&
                      (n.expand(), n.contents && n.layout.format(n.contents));
                  }),
            ...
            { key: "removeListeners", value: function (t) {} },
            {
              key: "display",
              value: function (t) {
                var e = new o.defer();
                return (
                  this.displayed
                    ...
                    : this.render(t).then(
                        function () {
                          this.emit(u.c.VIEWS.DISPLAYED, this),
            ...
            },
            {
              ...
              value: function () {
                (this.element.style.visibility = "visible"),
                  ...
                  this.emit(u.c.VIEWS.SHOWN, this);
              },
            },
            {
              key: "hide",
              value: function () {
                (this.element.style.visibility = "hidden"),
                  ...
                  this.emit(u.c.VIEWS.HIDDEN, this);
              },
            },
            {
              key: "offset",
            ...
            { key: "onDisplayed", value: function (t) {} },
              ...
              value: function (t) {
                ...
                if (this.contents) {
                  var s = Object.assign(
                    ...
                    a = this.contents.range(t),
                    h = function () {
                      e.emit(u.c.VIEWS.MARK_CLICKED, t, n);
                    };
                  (n.epubcfi = t),
                    this.pane ||
                      (this.pane = new c.Pane(this.iframe, this.element));
                  var l = new c.Highlight(a, r, n, s),
                    f = this.pane.addMark(l);
                  return (
                    (this.highlights[t] = {
                      mark: f,
                      element: f.element,
                    ...
                    f.element.setAttribute("ref", r),
                    f.element.addEventListener("click", h),
                    f.element.addEventListener("touchstart", h),
                    i &&
                      (f.element.addEventListener("click", i),
                      f.element.addEventListener("touchstart", i)),
                    f
                  );
                }
              },
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (this.contents) {
                  ...
                  var o = this.contents.range(t);
                  if (o) {
                    var s = o.commonAncestorContainer,
                      a = 1 === s.nodeType ? s : s.parentNode,
                      c = function (i) {
                        e.emit(u.c.VIEWS.MARK_CLICKED, t, n);
                      };
                    o.collapsed && 1 === s.nodeType
                      ? (o = new Range()).selectNodeContents(s)
                      : o.collapsed && (o = new Range()).selectNodeContents(a);
                    var h = this.document.createElement("a");
                    return (
                      h.setAttribute("ref", "epubjs-mk"),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                if (
                  ...
                  for (var s, a = e.getClientRects(), u = 0; u != a.length; u++)
                    (s = a[u]),
                      (!r || s.left < r) &&
                        ((r = s.left),
                        (i =
            ...
            },
            {
              key: "destroy",
              value: function () {
                for (var t in this.highlights) this.unhighlight(t);
                for (var e in this.underlines) this.ununderline(e);
                for (var n in this.marks) this.unmark(n);
                this.blobUrl && Object(o.revokeBlobUrl)(this.blobUrl),
                  this.displayed &&
                    ((this.displayed = !1),
                    this.removeListeners(),
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        function m(e) {
          var n = u,
            i = c;
          return (u = c = void 0), (p = e), (l = t.apply(i, n));
        }
        function b(t) {
          return (p = t), (f = setTimeout(k, e)), v ? m(t) : l;
        }
        function w(t) {
          var n = t - d;
        ...
        function k() {
          ...
          f = setTimeout(
            ...
            (function (t) {
              var n = e - (t - d);
              return g ? a(n, h - (t - p)) : n;
            })(t),
          );
        }
        function x(t) {
          return (f = void 0), y && u ? m(t) : ((u = c = void 0), l);
        }
        function E() {
          var t = r(),
            n = w(t);
          if (((u = arguments), (c = this), (d = t), n)) {
            ...
            if (g) return clearTimeout(f), (f = setTimeout(k, e)), m(d);
          }
        ...
        return (
          ...
          i(n) &&
            ((v = !!n.leading),
            (h = (g = "maxWait" in n) ? s(o(n.maxWait) || 0, e) : h),
            (y = "trailing" in n ? !!n.trailing : y)),
          (E.cancel = function () {
            void 0 !== f && clearTimeout(f), (p = 0), (u = d = c = f = void 0);
          }),
          (E.flush = function () {
            return void 0 === f ? l : x(r());
          }),
          E
        );
      };
        ...
        l = (function () {
          function t(e, n) {
            !(function (t, e) {
              ...
              this.supportsTouch && this.setup(e);
          }
          var e, n, r;
          return (
            (e = t),
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  (this._onResize = this.onResize.bind(this)),
                    ...
                    this.manager.on(o.c.MANAGERS.ADDED, this._afterDisplayed);
                },
              },
              {
                key: "removeListeners",
                value: function () {
                  window.removeEventListener("resize", this._onResize),
                    ...
                    this.manager.off(o.c.MANAGERS.ADDED, this._afterDisplayed),
              ...
              },
              {
                key: "wasSwiped",
                value: function () {
                  var t = this.layout.pageWidth * this.layout.divisor,
                ...
                value: function (t) {
                  ...
                  return (
                    ...
                    function i() {
                      var a = this.now(),
                        u = Math.min(1, (a - r) / o);
                      if ((s(u), this.touchCanceler || this.resizeCanceler))
                        return (
                          (this.resizeCanceler = !1),
                          (this.snapping = !1),
                          void e.resolve()
      ...
      var x = (function (t) {
        ...
        function u(t) {
          ...
          return (
            ...
            ((e = a.call(this, t)).name = "continuous"),
            (e.settings = Object(i.extend)(e.settings || {}, {
              infinite: !0,
              overflow: void 0,
              axis: void 0,
              writingMode: void 0,
            ...
            Object(i.extend)(e.settings, t.settings || {}),
            "undefined" != t.settings.gap &&
              0 === t.settings.gap &&
              (e.settings.gap = t.settings.gap),
            (e.viewSettings = {
              ignoreClass: e.settings.ignoreClass,
              axis: e.settings.axis,
              flow: e.settings.flow,
              layout: e.layout,
              width: 0,
              height: 0,
              forceEvenPages: !1,
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: "afterResized",
              value: function (t) {
                this.emit(o.c.MANAGERS.RESIZE, t.section);
              },
            },
            {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  this.views.append(n),
                  n.on(o.c.VIEWS.RESIZED, function (t) {
                    n.expanded = !0;
                  }),
                  n.on(o.c.VIEWS.AXIS, function (t) {
                    e.updateAxis(t);
                  }),
                  n.on(o.c.VIEWS.WRITING_MODE, function (t) {
                    e.updateWritingMode(t);
                  }),
            ...
            },
            {
              ...
              value: function (t) {
                for (
                  ...
                  if (((e = r[h]), !0 === this.isVisible(e, a, a, n))) {
                    if (e.displayed) e.show();
                    else {
                      var l = e.display(this.request).then(
                        function (t) {
                          t.show();
                        },
                        function (t) {
                ...
                return c.length
                  ? Promise.all(c).catch(function (t) {
                      u.reject(t);
                    })
                  : (u.resolve(), u.promise);
              },
            },
            {
              ...
              value: function (t, e) {
                var n = this,
                  ...
                  a = this.settings.offset || 0;
                t && s && (a = t), e && !s && (a = e);
                var u = this._bounds,
                  c = s ? this.scrollLeft : this.scrollTop,
                  h = s ? Math.floor(u.width) : u.height,
                  l = s
                    ? this.container.scrollWidth
                    : this.container.scrollHeight,
                  f =
                ...
                c + h + a >= l &&
                  ((v = n.views.last()),
                  (g = v && v.section.next()) && o.push(n.append(g))),
                  b < 0 &&
                    ((y = n.views.first()),
                    (m = y && y.section.prev()) && o.push(n.prepend(m)));
                var w = o.map(function (t) {
                  return t.display(n.request);
                });
                return o.length
                  ? Promise.all(w)
                      .then(function () {
              ...
              value: function () {
                for (
                  var t = new i.defer(),
                    ...
                    n = e[0],
                    r = e[e.length - 1],
                    o = this.views.indexOf(n),
                    s = this.views.indexOf(r),
                    a = this.views.slice(0, o),
                    u = this.views.slice(s + 1),
                    c = 0;
                  c < a.length - 1;
                  c++
                )
                  this.erase(a[c], a);
                for (var h = 1; h < u.length; h++) this.erase(u[h]);
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.scrollDeltaVert = 0),
                  ...
                  (this._onScroll = this.onScroll.bind(this)),
                  t.addEventListener("scroll", this._onScroll),
                  (this._scrolled = p()(this.scrolled.bind(this), 30)),
                  (this.didScroll = !1);
              },
            },
            {
                  ...
                  (this.afterScrolled = setTimeout(
                    function () {
                      (this.snapper &&
                        ...
                        this.emit(o.c.MANAGERS.SCROLLED, {
                          top: this.scrollTop,
                          left: this.scrollLeft,
                        });
                    }.bind(this),
            ...
            },
            {
              ...
              value: function (t) {
                this.rendered &&
                  ...
                  y(k(u.prototype), "updateFlow", this).call(this, t, "scroll"),
                  this.rendered &&
                    this.isPaginated &&
                    this.settings.snap &&
                    (this.snapper = new f(
            ...
            },
            {
              key: "destroy",
              value: function () {
                y(k(u.prototype), "destroy", this).call(this),
    ...
    function (t, e, n) {
      (function (e) {
        t.exports = (function t(e, n, i) {
          ...
          for (var o = !1, s = 0; s < i.length; s++) r(i[s]);
          return r;
        })(
          {
            1: [
              ...
              function (t, e, n) {
                ...
                (e.exports = c),
                  ...
                  (c.all = function (t) {
                    ...
                    for (
                      var s = new Array(n), a = 0, u = -1, c = new this(r);
                      ++u < n;
                  ...
                  (c.race = function (t) {
                    ...
                    var n = t.length,
                      i = !1;
                    if (!n) return this.resolve([]);
                    for (var s, a = -1, u = new this(r); ++a < n; )
                      (s = t[a]),
                        e.resolve(s).then(
                          function (t) {
                            i || ((i = !0), o.resolve(u, t));
            ...
            4: [
              function (t, e, n) {
                ...
                function g(t) {
                  var e = f[t.name].deferredOperations.pop();
                  if (e) return e.resolve(), e.promise;
                }
                function y(t, e) {
                  var n = f[t.name].deferredOperations.pop();
                      ...
                      return s
                        ...
                        .then(function () {
                          return (function (t) {
                            v(t);
                            for (
                              var e = f[t.name], n = e.forages, i = 0;
                              i < n.length;
                              i++
                            ) {
                              var r = n[i];
                ...
                var _ = {
                    ...
                    _initStorage: function (t) {
                      ...
                      for (var u = 0; u < r.forages.length; u++) {
                        var c = r.forages[u];
                        c !== e && o.push(c._initReady().catch(a));
                      }
                      var h = r.forages.slice(0);
                      return s
                        .all(o)
                        .then(function () {
                        ...
                        .then(function (t) {
                          return (
                            (n.db = t),
                            k(n, e._defaultConfig.version) ? w(n) : t
                          );
                        })
                        .then(function (t) {
                    ...
                    iterate: function (t, e) {
                      var n = this,
                        i = new s(function (e, i) {
                          n.ready()
                            .then(function () {
                              O(n._dbInfo, "readonly", function (r, o) {
                                if (r) return i(r);
                                try {
                                  var s = o
                    ...
                    setItem: function (t, e, n) {
                      var i = this;
                      t = c(t);
                      var r = new s(function (n, r) {
                        var o;
                        i.ready()
                          .then(function () {
                            return (
                              (o = i._dbInfo),
                              "[object Blob]" === d.call(e)
                                ? p(o.db).then(function (t) {
                                    return t
                                      ? e
                                      : ((n = e),
                                        new s(function (t, e) {
                          ...
                          .then(function (e) {
                            O(i._dbInfo, "readwrite", function (o, s) {
                              if (o) return r(o);
                              try {
                                var a = s.objectStore(i._dbInfo.storeName);
                                null === e && (e = void 0);
                                var u = a.put(e, t);
                    ...
                    clear: function (t) {
                      var e = this,
                        n = new s(function (t, n) {
                          e.ready()
                            .then(function () {
                              O(e._dbInfo, "readwrite", function (i, r) {
                                if (i) return n(i);
                                try {
                                  var o = r
                    ...
                    length: function (t) {
                      var e = this,
                        n = new s(function (t, n) {
                          e.ready()
                            .then(function () {
                              O(e._dbInfo, "readonly", function (i, r) {
                                if (i) return n(i);
                                try {
                                  var o = r
                                    .objectStore(e._dbInfo.storeName)
                    ...
                    dropInstance: function (t, e) {
                      ...
                      var i,
                        o = this;
                      if (t.name) {
                        var u = t.name === n.name && o._dbInfo.db,
                          c = u
                                ...
                                return new s(function (e, i) {
                                  ...
                                  .then(function (t) {
                                    ...
                                    for (var e = 0; e < o.length; e++) {
                                      var n = o[e];
                                      (n._dbInfo.db = t), g(n._dbInfo);
                                    }
                                  })
                                  .catch(function (e) {
                                    throw (
                                      ((y(t, e) || s.resolve()).catch(
                                        function () {},
                                      ),
                                      e)
                                    );
                      ...
                      } else i = s.reject("Invalid arguments");
                      return a(i, e), i;
                    },
                  },
                  C =
                    ...
                    t.transaction(
                      function (i) {
                        i.executeSql(
                          ...
                          [],
                          function (n, i) {
                            for (var r = [], o = 0; o < i.rows.length; o++)
                              r.push(i.rows.item(o).name);
                            e({ db: t, storeNames: r });
                          },
                          function (t, e) {
                            n(e);
                                ...
                                function (n, i) {
                                  for (
                                    ...
                                    var u = o.item(a),
                                      c = u.value;
                                    if (
                                      (c && (c = r.serializer.deserialize(c)),
                                      void 0 !== (c = t(c, u.key, a + 1)))
                                    )
                                      return void e(c);
                                  }
                                  e();
                                ...
                                t.db.transaction(
                                  function (i) {
                                    ...
                                    for (
                                      var o = [],
                                        a = 0,
                                        u = t.storeNames.length;
                                      a < u;
                                      a++
                                    )
                                      o.push(r(t.storeNames[a]));
                                    s.all(o)
                                      .then(function () {
                                        e();
                                      })
                ...
                var F = {
                    ...
                    setItem: function (t, e, n) {
                      ...
                      var r = i.ready().then(function () {
                        ...
                        return new s(function (r, o) {
                          var s = i._dbInfo;
                          s.serializer.serialize(e, function (e, i) {
                            if (i) o(i);
                            else
                              try {
                                localStorage.setItem(s.keyPrefix + t, e), r(n);
                              } catch (t) {
                        ...
                        n = e.ready().then(function () {
                          for (
                            ...
                            0 === o.indexOf(t.keyPrefix) &&
                              i.push(o.substring(t.keyPrefix.length));
                          }
                          return i;
                        });
                      return a(n, t), n;
                  ...
                  W = function (t, e) {
                    for (var n, i, r = t.length, o = 0; o < r; ) {
                      if (
                        (n = t[o]) === (i = e) ||
                        ("number" == typeof n &&
                          "number" == typeof i &&
                  ...
                  V = {},
                  X = {},
                  G = { INDEXEDDB: _, WEBSQL: M, LOCALSTORAGE: F },
                  Y = [
                    G.INDEXEDDB._driver,
                    G.WEBSQL._driver,
                ...
                var tt = new ((function () {
                  ...
                  return (
                      ...
                      var i = new s(function (e, n) {
                        try {
                          ...
                          for (
                            ...
                            var h = o[u];
                            if ((!W(K, h) || t[h]) && "function" != typeof t[h])
                              return void n(r);
                          }
                          !(function () {
                            for (
                      ...
                      return (
                        (this._driverSet = c
                          ...
                          .catch(function () {
                            ...
                            return (i._driverSet = s.reject(t)), i._driverSet;
                          })),
                    ...
                    (t.prototype._wrapLibraryMethodsWithReady = function () {
                      for (var t = 0, e = $.length; t < e; t++) J(this, $[t]);
                    }),
    ...
    function (t, e, n) {
      ...
      var i = n(12),
        ...
        s = n(20),
        a = n(17),
        u = (n(7), n(85), n(39), n(11), n(2)),
        c = n(24),
        h = (n(149), n(198), n(36), n(30));
      n(48);
      var l = function (t, e, n, i) {
          var r,
            s = "undefined" != typeof window && window.URL,
            u = s ? "blob" : "arraybuffer",
            c = new o.defer(),
            h = new XMLHttpRequest(),
            l = XMLHttpRequest.prototype;
          for (r in ("overrideMimeType" in l ||
            ...
            if (this.readyState === XMLHttpRequest.DONE) {
              ...
              if (
                ...
                (n = t
                  ? this.responseXML
                  : Object(o.isXml)(e)
                    ? Object(o.parse)(this.response, "text/xml")
                    : "xhtml" == e
                      ? Object(o.parse)(this.response, "application/xhtml+xml")
                      : "html" == e || "htm" == e
                        ? Object(o.parse)(this.response, "text/html")
                        : "json" == e
          ...
          h.open("GET", t, !0),
          i))
            h.setRequestHeader(r, i[r]);
          return (
            "json" == e && h.setRequestHeader("Accept", "application/json"),
            e || (e = new a.a(t).extension),
            "blob" == e && (h.responseType = u),
            Object(o.isXml)(e) && h.overrideMimeType("text/xml"),
      ...
      var p = (function () {
        function t(e, n) {
          !(function (t, e) {
            ...
            (this.next = e.next),
            (this.prev = e.prev),
            (this.cfiBase = e.cfiBase),
            n
              ? (this.hooks = n)
              : ((this.hooks = {}),
                (this.hooks.serialize = new c.a(this)),
                (this.hooks.content = new c.a(this))),
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: "base",
              value: function () {
                return Object(h.a)(this.document, this);
              },
            },
            {
              key: "render",
                  ...
                  this.load(t)
                    .then(
                      function (t) {
                        ...
                        return (
                          (this.output = n.serializeToString(t)), this.output
                        );
                      }.bind(this),
                    )
                    .then(
                  ...
                  r = function (t) {
                    for (
                      var r,
                        ...
                        u = e.document.createRange(),
                        c = -1;
                      -1 != o;

                    )
                      -1 != (o = a.indexOf(i, c + 1)) &&
                        ((u = e.document.createRange()).setStart(t, o),
                        u.setEnd(t, o + i.length),
                        (r = e.cfiFromRange(u)),
                        (s =
                          t.textContent.length < 150
                            ? t.textContent
                            : "..." +
                              (s = t.textContent.substring(o - 75, o + 75)) +
                              "..."),
                        n.push({ cfi: r, excerpt: s })),
                        (c = o);
                  };
                return (
                  Object(o.sprint)(e.document, function (t) {
                    r(t);
                  }),
                  n
                );
            ...
            },
            {
              ...
              value: function (t) {
                ...
                for (
                    ...
                    a = function (t) {
                      ...
                      if (-1 != e) {
                        ...
                        if (e < t[0].length) {
                          for (
                            var c;
                            a < t.length - 1 && !(n <= (u += t[a].length));

                          )
                            a += 1;
                          var h = t[0],
                            l = t[a],
                            f = o.document.createRange();
                          f.setStart(h, e);
                          var d = t.slice(0, a).reduce(function (t, e) {
                            return t + e.textContent.length;
                          }, 0);
                          f.setEnd(l, d > n ? n : n - d),
                            (c = o.cfiFromRange(f));
                          var p = t.slice(0, a + 1).reduce(function (t, e) {
                            return t + e.textContent;
                          }, "");
                          p.length > r &&
                            (p =
                              "..." +
                              (p = p.substring(e - r / 2, e + r / 2)) +
                              "..."),
                            i.push({ cfi: c, excerpt: p });
                        }
                      }
                    },
                  ...
                  c.push(n),
                    c.length == e && (a(c.slice(0, e)), (c = c.slice(1, e)));
                return c.length > 0 && a(c), i;
              },
            },
            {
                ...
                return (
                  this.properties.forEach(function (t) {
                    var n,
                      ...
                      o = r.indexOf("-");
                    -1 != o &&
                      ((n = r.slice(0, o)), (i = r.slice(o + 1)), (e[n] = i));
                  }),
                  e
                );
              },
            },
            {
              key: "cfiFromRange",
              value: function (t) {
                return new u.a(t, this.cfiBase).toString();
              },
            },
            {
              key: "cfiFromElement",
      ...
      var g = (function () {
          function t() {
            !(function (t, e) {
              ...
              (this.spineById = {}),
              (this.hooks = {}),
              (this.hooks.serialize = new c.a()),
              (this.hooks.content = new c.a()),
              this.hooks.content.register(h.a),
              this.hooks.content.register(h.b),
              this.hooks.content.register(h.d),
              (this.epubcfi = new u.a()),
              (this.loaded = !1),
              (this.items = void 0),
          ...
          return (
            ...
            (n = [
                ...
                value: function (t, e, n) {
                  ...
                  (this.items = t.spine),
                    ...
                    this.items.forEach(function (t, r) {
                      var o,
                        s = i.manifest[t.idref];
                      (t.index = r),
                        (t.cfiBase = i.epubcfi.generateChapterComponent(
                          i.spineNodeIndex,
                          t.index,
                          t.idref,
                        )),
                        t.href &&
                          ((t.url = e(t.href, !0)), (t.canonical = n(t.href))),
                        s &&
                          ((t.href = s.href),
                          (t.url = e(t.href, !0)),
                        ...
                        "yes" === t.linear
                          ? ((t.prev = function () {
                              for (var e = t.index; e > 0; ) {
                                var n = this.get(e - 1);
                                if (n && n.linear) return n;
                                e -= 1;
                              }
                            }.bind(i)),
                            (t.next = function () {
                ...
                value: function (t) {
                  ...
                  if (void 0 === t)
                    for (; e < this.spineItems.length; ) {
                      var n = this.spineItems[e];
                      if (n && n.linear) break;
                      e += 1;
                    }
                  else
                    this.epubcfi.isCfiString(t)
                      ? (e = new u.a(t).spinePos)
              ...
              },
              {
                key: "last",
                value: function () {
                  var t = this.spineItems.length - 1;
                  do {
                    var e = this.get(t);
                    if (e && e.linear) return e;
                    t -= 1;
          ...
          (n = [
                  ...
                  : t.load(this.request).then(
                      function (r) {
                        var s = new o.defer(),
                          ...
                          u = i - this._locationsWords.length;
                        return (
                          (this._locationsWords = this._locationsWords.concat(
                            a.length >= i ? a.slice(0, u) : a,
                          )),
                          t.unload(),
                          (this.processingTimeout = setTimeout(function () {
                            return s.resolve(a);
            ...
            },
            {
              ...
              value: function (t, e, n, i) {
                var r,
                  ...
                  a = [],
                  c = t.ownerDocument,
                  h = Object(o.qs)(c, "body"),
                  l = n,
                  f = !i || i.spinePos !== e.index;
                return (
                  i &&
                    e.index === i.spinePos &&
                    (r = i.findNode(
                      i.range
                        ? i.path.steps.concat(i.start.steps)
                        : i.path.steps,
                      t.ownerDocument,
                    )),
                  Object(o.sprint)(
                    ...
                    function (t) {
                      ...
                      if (0 === n) return !1;
                      for (
                        (e = l - this._wordCounter) > n &&
                        ((this._wordCounter += n), (i = n));
                        i < n;

                      )
                        if (i + (e = l - this._wordCounter) >= n)
            ...
            },
            {
              ...
              value: function (t) {
                var e;
                return (
                  u.a.prototype.isCfiString(t) && (t = new u.a(t)),
                  0 === this._locations.length
                    ? -1
                    : (e = Object(o.locationOf)(
                          t,
                          this._locations,
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  ...
                  var n = new u.a(this._locations[this.total]);
          ...
          (n = [
            {
              ...
              value: function (t) {
                ...
                if (!(e = Object(o.qs)(t, "rootfile")))
                  throw new Error("No RootFile Found");
                (this.packagePath = e.getAttribute("full-path")),
                  (this.directory = E.a.dirname(this.packagePath)),
          ...
          (n = [
            {
              ...
              value: function (t) {
                ...
                if (!(e = Object(o.qs)(t, "metadata")))
                  throw new Error("No Metadata Found");
                if (!(n = Object(o.qs)(t, "manifest")))
                  throw new Error("No Manifest Found");
                if (!(i = Object(o.qs)(t, "spine")))
                ...
                return (
                  ...
                  (this.spineNodeIndex = Object(o.indexOfElementNode)(i)),
            ...
            },
            {
              key: "findNavPath",
              value: function (t) {
                var e = Object(o.qsp)(t, "item", { properties: "nav" });
            ...
            },
            {
              ...
              value: function (t, e) {
                var n,
                  i = Object(o.qsp)(t, "item", {
                    "media-type": "application/x-dtbncx+xml",
                  });
                return (
                  i ||
                    ((n = e.getAttribute("toc")) &&
                      (i = t.querySelector("#".concat(n)))),
            ...
            },
            {
              key: "findCoverPath",
              value: function (t) {
                Object(o.qs)(t, "package").getAttribute("version");
                var e = Object(o.qsp)(t, "item", { properties: "cover-image" });
                if (e) return e.getAttribute("href");
                var n = Object(o.qsp)(t, "meta", { name: "cover" });
                if (n) {
            ...
            },
            {
              key: "getPropertyText",
              value: function (t, e) {
                var n = Object(o.qsp)(t, "meta", { property: e });
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var n = t.readingOrder || t.spine;
                return (
                  (this.spine = n.map(function (t, e) {
                    return (t.index = e), (t.linear = t.linear || "yes"), t;
                  })),
                  t.resources.forEach(function (t, n) {
                    (e.manifest[n] = t),
                      t.rel && "cover" === t.rel[0] && (e.coverPath = t.href);
                  }),
                  (this.spineNodeIndex = 0),
                  (this.toc = t.toc.map(function (t, e) {
          ...
          return (
            ...
            (n = [
                  ...
                  if (0 !== n.length) {
                    ...
                    if (!i || (t !== i.id && t !== i.href)) {
                      for (
                        var r, o = 0;
                        o < n.length &&
                        !(r = this.getByIndex(t, e, n[o].subitems));
                        ++o
                      );
                      return r;
                    }
              ...
              },
              {
                key: "parseNav",
                value: function (t) {
                  var e = Object(o.querySelectorByType)(t, "nav", "toc"),
                    n = [];
                  if (!e) return n;
                  var i = Object(o.filterChildren)(e, "ol", !0);
                  return i ? (n = this.parseNavList(i)) : n;
                },
              },
              {
                key: "parseNavList",
                value: function (t, e) {
                  var n = [];
                  if (!t) return n;
                  if (!t.children) return n;
                  for (var i = 0; i < t.children.length; i++) {
                    var r = this.navItem(t.children[i], e);
                    r && n.push(r);
                  }
                  return n;
                },
              },
              {
                key: "navItem",
                value: function (t, e) {
                  var n = t.getAttribute("id") || void 0,
                    i = Object(o.filterChildren)(t, "a", !0);
                  if (i) {
                    var r = i.getAttribute("href") || "";
                    n || (n = r);
                    var s = i.textContent || "",
                      a = [],
                      u = Object(o.filterChildren)(t, "ol", !0);
                    return (
                      u && (a = this.parseNavList(u, n)),
                      { id: n, href: r, label: s, subitems: a, parent: e }
                    );
                  }
                },
              },
              {
                ...
                value: function (t) {
                  var e,
                    n,
                    i = Object(o.querySelectorByType)(t, "nav", "landmarks"),
                    r = i ? Object(o.qsa)(i, "li") : [],
                    s = r.length,
                    a = [];
                  if (!r || 0 === s) return a;
                  for (e = 0; e < s; ++e)
              ...
              },
              {
                key: "landmarkItem",
                value: function (t) {
                  var e = Object(o.filterChildren)(t, "a", !0);
                  if (e) {
                    var n =
                      e.getAttributeNS(
              ...
              },
              {
                ...
                value: function (t) {
                  var e,
                    n,
                    i = Object(o.qsa)(t, "navPoint"),
                    r = i.length,
                    s = {},
                    a = [];
                  if (!i || 0 === r) return a;
                  for (e = 0; e < r; ++e)
                    (s[(n = this.ncxItem(i[e])).id] = n),
                      n.parent ? s[n.parent].subitems.push(n) : a.push(n);
                  return a;
                },
              },
              {
                ...
                value: function (t) {
                  var e,
                    ...
                    i = Object(o.qs)(t, "content").getAttribute("src"),
                    r = Object(o.qs)(t, "navLabel"),
                    s = r.textContent ? r.textContent : "",
                    a = t.parentNode;
                  return (
                    !a ||
                      ("navPoint" !== a.nodeName &&
                      ...
                      (e = a.getAttribute("id")),
                    { id: n, href: i, label: s, subitems: [], parent: e }
                  );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  return t.map(function (t) {
                    return (
                      (t.label = t.title),
                      (t.subitems = t.children ? e.load(t.children) : []),
                      t
                    );
                  });
                },
        ...
        I = (function () {
          ...
          for (t in j)
            if (j.hasOwnProperty(t))
              for (e in j[t])
                if (j[t].hasOwnProperty(e))
                  if ("string" == typeof (n = j[t][e])) r[n] = t + "/" + e;
                  else for (i = 0; i < n.length; i++) r[n[i]] = t + "/" + e;
          return r;
        })();
      var L = {
        lookup: function (t) {
          return (t && I[t.split(".").pop().toLowerCase()]) || "text/plain";
        },
      };
      function A(t, e) {
        for (var n = 0; n < e.length; n++) {
          ...
          (n = [
                ...
                return this.settings.archive
                  ...
                  : "base64" === this.settings.replacements
                    ? this.settings
                        .request(t, "blob")
                        .then(function (t) {
                          return Object(o.blob2base64)(t);
                        })
                        .then(function (t) {
                          return Object(o.createBase64Url)(t, n);
                        })
                    : this.settings.request(t, "blob").then(function (t) {
                        return Object(o.createBlobUrl)(t, n);
                      });
              },
            },
            {
              ...
              value: function () {
                ...
                var e = this.urls.map(function (e) {
                  var n = t.settings.resolver(e);
                  return t.createUrl(n).catch(function (t) {
                    return console.error(t), null;
                  });
                });
                return Promise.all(e).then(function (e) {
                  return (
                    (t.replacementUrls = e.filter(function (t) {
                      return "string" == typeof t;
                    })),
                    e
                  );
            ...
            },
            {
              ...
              value: function (t) {
                ...
                n = this.settings.archive
                  ? this.settings.archive.getText(i)
                  : this.settings.request(i, "text");
                var r = this.urls.map(function (t) {
                  var n = e.settings.resolver(t);
                  return new a.a(i).relative(n);
                });
                return n
                  ? n.then(
                      function (t) {
                        return (
                          (t = Object(h.e)(t, r, e.replacementUrls)),
                          "base64" === e.settings.replacements
                            ? Object(o.createBase64Url)(t, "text/css")
                            : Object(o.createBlobUrl)(t, "text/css")
                        );
                      },
                      function (t) {
                        return new Promise(function (t) {
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  ...
                  Object(h.e)(t, n, this.replacementUrls)
                );
              },
            },
            {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t) {
                  var e,
                    n,
                    i = Object(o.querySelectorByType)(t, "nav", "page-list"),
                    r = i ? Object(o.qsa)(i, "li") : [],
                    s = r.length,
                    a = [];
                  if (!r || 0 === s) return a;
                  for (e = 0; e < s; ++e) (n = this.item(r[e])), a.push(n);
                  return a;
                },
              },
              {
                ...
                value: function (t) {
                  var e,
                    ...
                    s = [],
                    a = 0;
                  if (!(n = Object(o.qs)(t, "pageList"))) return s;
                  if (
                    ((r = (i = Object(o.qsa)(n, "pageTarget")).length),
                    !i || 0 === i.length)
                  )
                    return s;
                  for (a = 0; a < r; ++a) (e = this.ncxItem(i[a])), s.push(e);
                  return s;
                },
              },
              {
                key: "ncxItem",
                value: function (t) {
                  var e = Object(o.qs)(t, "navLabel"),
                    n = Object(o.qs)(e, "text").textContent;
                  return {
                    href: Object(o.qs)(t, "content").getAttribute("src"),
                    page: parseInt(n, 10),
                  };
                },
              },
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t, e) {
                  return "json" == e
                    ? JSON.parse(t)
                    : Object(o.isXml)(e)
                      ? Object(o.parse)(t, "text/xml")
                      : "xhtml" == e
                        ? Object(o.parse)(t, "application/xhtml+xml")
                        : "html" == e || "htm" == e
                          ? Object(o.parse)(t, "text/html")
                          : t;
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t, e) {
                  var n,
                    i,
                    r = new o.defer(),
                    s = window.URL || window.webkitURL || window.mozURL,
                    a = e && e.base64;
              ...
              },
              {
                ...
                value: function () {
                  ...
                  for (var e in this.urlCache) t.revokeObjectURL(e);
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (t, e) {
                var n = this,
                  i = t.resources.map(function (t) {
                    var i = t.href,
                      r = n.resolver(i),
                      o = window.encodeURIComponent(r);
                    return n.storage.getItem(o).then(function (t) {
                      return !t || e
                        ? n.requester(r, "binary").then(function (t) {
                            return n.storage.setItem(o, t);
                          })
                        : t;
                    });
                  });
            ...
            },
            {
              ...
              value: function (t, e, n) {
                var i = this,
                  r = window.encodeURIComponent(t);
                return this.storage.getItem(r).then(function (o) {
                  return (
                    o ||
                    i.requester(t, "binary", e, n).then(function (t) {
                      return i.storage.setItem(r, t);
                    })
                  );
                });
              },
            },
            {
              ...
              value: function (t, e, n, i) {
                var r = this;
                return this.online
                  ? this.requester(t, e, n, i).then(function (e) {
                      return r.put(t), e;
                    })
                  : this.retrieve(t, e);
              },
                ...
                return (
                  ...
                  ("blob" == e ? this.getBlob(t) : this.getText(t)).then(
                    function (i) {
                      ...
                      return (
                        i
                          ? ((r = n.handleResponse(i, e)), s.resolve(r))
                          : s.reject({
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return this.storage.getItem(n).then(function (n) {
                  if (n)
                    return (e = e || L.lookup(t)), new Blob([n], { type: e });
                });
              },
            },
            {
          ...
          (n = [
            {
              ...
              value: function (t) {
                var e = this;
                if (!t) return this;
                var n = Object(o.qs)(t, "display_options");
                return n
                  ? (Object(o.qsa)(n, "option").forEach(function (t) {
                      var n = "";
                      switch (
                        (t.childNodes.length && (n = t.childNodes[0].nodeValue),
        ...
        nt = (function () {
          function t(e, n) {
            ...
            !(function (t, e) {
              ...
              Object(o.extend)(this.settings, n),
              (this.opening = new o.defer()),
              (this.opened = this.opening.promise),
              (this.isOpen = !1),
              (this.loading = {
                manifest: new o.defer(),
                spine: new o.defer(),
                metadata: new o.defer(),
                cover: new o.defer(),
                navigation: new o.defer(),
                pageList: new o.defer(),
                resources: new o.defer(),
                displayOptions: new o.defer(),
              }),
              (this.loaded = {
              ...
              (this.isRendered = !1),
              (this.request = this.settings.requestMethod || l),
              (this.spine = new g()),
              (this.locations = new k(this.spine, this.load.bind(this))),
              ...
              e &&
                this.open(e, this.settings.openAs).catch(function (t) {
                  var n = new Error("Cannot load book at " + e);
                  i.emit(m.c.BOOK.OPEN_FAILED, n);
                });
          }
          var e, n, i;
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return this.unarchive(t, e || this.settings.encoding)
                    .then(function () {
                      return n.openContainer("META-INF/container.xml");
                    })
                    .then(function (t) {
                      return n.openPackaging(t);
                    });
                },
              },
              {
                ...
                value: function (t) {
                  var e = this;
                  return this.load(t).then(function (t) {
                    return (
                      (e.container = new O(t)),
                      e.resolve(e.container.packagePath)
                    );
                  });
                },
              },
                ...
                value: function (t) {
                  ...
                  return (
                    ...
                    this.load(t).then(function (t) {
                      return (e.packaging = new C(t)), e.unpack(e.packaging);
                    })
                  );
                },
              },
                  ...
                  (this.package = t),
                    "" === this.packaging.metadata.layout
                      ? this.load(
                          ...
                          .then(function (t) {
                            (e.displayOptions = new Y(t)),
                              e.loading.displayOptions.resolve(
                                e.displayOptions,
                              );
                          })
                          .catch(function (t) {
                            (e.displayOptions = new Y()),
                              e.loading.displayOptions.resolve(
                                e.displayOptions,
                              );
                          })
                      : ((this.displayOptions = new Y()),
                    ...
                    (this.resources = new N(this.packaging.manifest, {
                    ...
                    this.loadNavigation(this.packaging).then(function () {
                      e.loading.navigation.resolve(e.navigation);
                    }),
                    ...
                    (this.settings.replacements &&
                      ...
                      ? this.replacements()
                          .then(function () {
                            e.loaded.displayOptions.then(function () {
                              e.opening.resolve(e);
                            });
                          })
                          .catch(function (t) {
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this,
                    n = t.navPath || t.ncxPath,
                    i = t.toc;
                  return i
                    ? new Promise(function (n, r) {
                        (e.navigation = new R(i)),
                          t.pageList && (e.pageList = new D(t.pageList)),
                          n(e.navigation);
                      })
                    : n
                      ? this.load(n, "xml").then(function (t) {
                          return (
                            (e.navigation = new R(t)),
                            (e.pageList = new D(t)),
                            e.navigation
                          );
                        })
              ...
              },
              {
                key: "unarchive",
                value: function (t, e) {
                  return (this.archive = new U()), this.archive.open(t, e);
                },
              },
              {
                key: "store",
                value: function (t) {
                  var e = this,
                    n =
                      ...
                      "none" !== this.settings.replacements,
                    i = this.url,
                    r = this.settings.requestMethod || l.bind(this);
                  return (
                    (this.storage = new X(t, r, this.resolve.bind(this))),
                    (this.request = this.storage.request.bind(this.storage)),
                    this.opened.then(function () {
                      e.archived &&
                        (e.storage.requester = e.archive.request.bind(
                          e.archive,
                        ));
                      var t = function (t, n) {
                        n.output = e.resources.substitute(t, n.url);
                      };
                      (e.resources.settings.replacements = n || "blobUrl"),
                        e.resources.replacements().then(function () {
                          return e.resources.replaceCss();
                        }),
                        e.storage.on("offline", function () {
                          (e.url = new s.a("/", "")),
                            e.spine.hooks.serialize.register(t);
                        }),
                        e.storage.on("online", function () {
                          (e.url = i), e.spine.hooks.serialize.deregister(t);
                        });
                    }),
                    this.storage
                  );
              ...
              },
              {
                ...
                value: function () {
                  var t = this;
                  return (
                    this.spine.hooks.serialize.register(function (e, n) {
              ...
              },
              {
                ...
                value: function (t) {
                  var e =
                    ...
                    this.url.filename;
                  return "epubjs:".concat(m.b, ":").concat(e);
                },
              },
              {
                key: "destroy",
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, h, d, m, b) {
        r(n, e, h);
        var w,
          k,
          x,
          ...
          O = !1,
          _ = t.prototype,
          C = _[g] || _["@@iterator"] || (d && _[d]),
          T = (!v && C) || E(d),
          R = ("Array" == e && _.entries) || C;
        if (
          (R &&
            ((w = o(R.call(new t()))),
            p !== Object.prototype &&
              ...
              (l ||
                o(w) === p ||
                (s ? s(w, p) : "function" != typeof w[g] && u(w, g, y)),
              a(w, S, !0, !0),
              l && (f[S] = y))),
          "values" == d &&
            C &&
          ...
          if (
            ...
            for (x in k) (v || O || !(x in _)) && c(_, x, k[x]);
          else i({ target: e, proto: !0, forced: v || O }, k);
        return k;
      };
    },
    function (t, e, n) {
              ...
              : !s.addEventListener ||
                ...
                ? (i =
                    "onreadystatechange" in l("script")
                      ? function (t) {
                          h.appendChild(l("script")).onreadystatechange =
                            function () {
                ...
                : ((i = S), s.addEventListener("message", E, !1))),
    ...
    function (t, e, n) {
      ...
      t.exports =
        ...
        r(function () {
          ...
          ? function (t, e) {
              for (
                var n = u(t), r = arguments.length, h = 1, l = s.f, f = a.f;
                r > h;
        ...
        return [
          ...
          function (t) {
            ...
            for (var l, f = [], d = 0; null !== (l = u(s, c)); ) {
              var p = String(l[0]);
              (f[d] = p),
                "" === p && (s.lastIndex = a(c, o(s.lastIndex), h)),
                d++;
            }
            return 0 === d ? null : f;
          },
      ...
      i(
        {
          target: "Array",
          proto: !0,
          forced: !n(35)("indexOf", { ACCESSORS: !0, 1: 0 }),
        },
        {
          includes: function (t) {
            return r(this, t, arguments.length > 1 ? arguments[1] : void 0);
    ...
    function (t, e, n) {
      ...
      var i = n(3),
        ...
        o = n(33);
      i(
        { target: "String", proto: !0, forced: !n(205)("includes") },
        {
          includes: function (t) {
    ...
    function (t, e, n) {
      ...
      var i = n(6),
        ...
        B = function (t, e, n, i) {
          var r = f(n),
            o = k(t);
          if (r + e > o.byteLength) throw T("Wrong index");
          var s = k(o.buffer).bytes,
            a = r + o.byteOffset,
            u = s.slice(a, a + e);
          return i ? u : u.reverse();
        },
        M = function (t, e, n, i, r, o) {
          var s = f(n),
            a = k(t);
          if (s + e > a.byteLength) throw T("Wrong index");
          for (
            var u = k(a.buffer).bytes, c = s + a.byteOffset, h = i(+r), l = 0;
            l < e;
            l++
          )
            u[c + l] = h[o ? l : e - l - 1];
      ...
      if (o) {
        ...
        (S = function (t) {
          ...
          a(O.prototype, {
            ...
            getInt32: function (t) {
              return N(
                B(this, 4, t, arguments.length > 1 ? arguments[1] : void 0),
              );
            },
            ...
            getFloat64: function (t) {
              return j(
                B(this, 8, t, arguments.length > 1 ? arguments[1] : void 0),
                52,
              );
            },
            setInt8: function (t, e) {
            ...
            setInt16: function (t, e) {
              M(this, 2, t, L, e, arguments.length > 2 ? arguments[2] : void 0);
            },
            setUint16: function (t, e) {
              M(this, 2, t, L, e, arguments.length > 2 ? arguments[2] : void 0);
            },
            setInt32: function (t, e) {
              M(this, 4, t, A, e, arguments.length > 2 ? arguments[2] : void 0);
            },
            setUint32: function (t, e) {
              M(this, 4, t, A, e, arguments.length > 2 ? arguments[2] : void 0);
            },
            setFloat32: function (t, e) {
              M(this, 4, t, P, e, arguments.length > 2 ? arguments[2] : void 0);
            },
            setFloat64: function (t, e) {
              M(this, 8, t, D, e, arguments.length > 2 ? arguments[2] : void 0);
            },
          });
      b(S, "ArrayBuffer"),
        b(O, "DataView"),
        (t.exports = { ArrayBuffer: S, DataView: O });
    },
    function (t, e) {
      t.exports =
      ...
      t.exports = {
        pack: function (t, e, a) {
          ...
          for (
            (t = n(t)) != t || t === 1 / 0
              ...
              : ((u = r(o(t) / s)),
                t * (h = i(2, -u)) < 1 && (u--, (h *= 2)),
                (t += u + p >= 1 ? v / h : v * i(2, 1 - p)) * h >= 2 &&
                  (u++, (h /= 2)),
                u + p >= d
                  ? ((c = 0), (u = d))
                  : u + p >= 1
                    ? ((c = (t * h - 1) * i(2, e)), (u += p))
                    : ((c = t * i(2, p - 1) * i(2, e)), (u = 0)));
            e >= 8;
            l[y++] = 255 & c, c /= 256, e -= 8
          );
          for (
        ...
        unpack: function (t, e) {
          ...
          if (0 === l) l = 1 - a;
            ...
            if (l === s) return n ? NaN : h ? -1 / 0 : 1 / 0;
            (n += i(2, e)), (l -= a);
          }
          return (h ? -1 : 1) * n * i(2, l - e);
        },
      };
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      (t.exports = function (t, e, n, h, l) {
        ...
        for (y = f.next; !(m = y.call(f)).done; )
          if (
            "object" == typeof (g = u(f, b, m.value, h)) &&
            g &&
            g instanceof c
          )
            return g;
        ...
        b
          ...
          : g && !v
            ? ((a = !0),
              ...
              new g(i).observe(u, { characterData: !0 }),
              (s = function () {
                u.data = a = !a;
              }))
            : m && m.resolve
    ...
    function (t, e, n) {
      ...
      (t.exports = function (t, e) {
        ...
        return (
          ...
          (h = { get: e, set: n, configurable: a, enumerable: u }),
          c ? i(r(c), h) : h
        );
      };
    },
    function (t, e, n) {
      "use strict";
      t.exports = n(176)() ? Object.assign : n(177);
    },
    function (t, e, n) {
      "use strict";
      t.exports = function () {
    ...
    function (t, e, n) {
      "use strict";
      t.exports = n(179)() ? Object.keys : n(180);
    },
    function (t, e, n) {
      "use strict";
      t.exports = function () {
    ...
    function (t, e, n) {
      "use strict";
      t.exports = n(186)() ? String.prototype.contains : n(187);
    },
    function (t, e, n) {
      "use strict";
      var i = "razdwatrzy";
    ...
    function (t, e, n) {
      var i = n(54),
        ...
        f = function (t) {
          s(t, c, { value: { objectID: "O" + ++h, weakData: {} } });
        },
        d = (t.exports = {
          REQUIRED: !1,
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        var e,
          ...
          w = 0;
        if (
          (m && (y = i(y, g > 2 ? arguments[2] : void 0, 2)),
          null == b || (v == Array && s(b)))
        )
          for (n = new v((e = a(p.length))); e > w; w++)
            (d = m ? y(p[w], w) : p[w]), u(n, w, d);
        else
          for (
            f = (l = b.call(p)).next, n = new v();
            !(h = f.call(l)).done;
            w++
          )
            (d = m ? o(l, y, [h.value, w], !0) : h.value), u(n, w, d);
        return (n.length = w), n;
      };
    },
    function (t, e, n) {
      ...
      var i = /[^\0-\u007E]/,
        ...
        h = function (t) {
          ...
          for (d && i.push("-"); p < r; ) {
            var v = 2147483647;
            for (e = 0; e < t.length; e++) (n = t[e]) >= h && n < v && (v = n);
            var g = p + 1;
            if (v - h > s((2147483647 - l) / g)) throw RangeError(o);
            for (l += (v - h) * g, h = v, e = 0; e < t.length; e++) {
              if ((n = t[e]) < h && ++l > 2147483647) throw RangeError(o);
              if (n == h) {
                for (var y = l, m = 36; ; m += 36) {
                  var b = m <= f ? 1 : m >= f + 26 ? 26 : m - f;
                  if (y < b) break;
                  var w = y - b,
                    k = 36 - b;
                  i.push(a(u(b + (w % k)))), (y = s(w / k));
                }
                i.push(a(u(y))), (f = c(l, g, p == d)), (l = 0), ++p;
              }
            }
            ++l, ++h;
          }
      ...
      t.exports = function (t) {
        ...
        for (e = 0; e < s.length; e++)
          (n = s[e]), o.push(i.test(n) ? "xn--" + h(n) : n);
        return o.join(".");
      };
    },
    function (t, e, n) {
      ...
      var i = n(3),
        ...
        S = k("iterator"),
        O = h.set,
        _ = h.getterFor("URLSearchParams"),
        C = h.getterFor("URLSearchParamsIterator"),
        T = /\+/g,
        R = Array(4),
        j = function (t) {
          return (
        ...
        D = function (t) {
          return encodeURIComponent(t).replace(A, P);
        },
        z = function (t, e) {
          if (e)
        ...
        U = function () {
          ...
          if (
            ...
            if (g(c))
              ...
              else for (u in c) f(c, u) && d.push({ key: u, value: c[u] + "" });
            else
              z(
                d,
                "string" == typeof c
      ...
      a(
        ...
        s(
          ...
          function () {
            for (var t, e = _(this).entries, n = [], i = 0; i < e.length; )
              (t = e[i++]), n.push(D(t.key) + "=" + D(t.value));
            return n.join("&");
          },
          { enumerable: !0 },
        ),
        u(U, "URLSearchParams"),
        i({ global: !0, forced: !o }, { URLSearchParams: U }),
        o ||
          "function" != typeof x ||
          "function" != typeof E ||
          i(
                ...
                return (
                  arguments.length > 1 &&
                    (g((e = arguments[1])) &&
                      ((n = e.body),
                      "URLSearchParams" === p(n) &&
                        ((i = e.headers ? new E(e.headers) : new E()).has(
                          "content-type",
                        ) ||
                          i.set(
                            "content-type",
        ...
        (t.exports = { URLSearchParams: U, getState: _ });
    },
    function (t, e, n) {
      var i = n(9),
        r = n(81);
      ...
      var i = n(44),
        ...
        a = function (t) {
          return function (e, n, a, u) {
            ...
            for (; t ? f >= 0 : l > f; f += d) f in h && (u = n(u, h[f], f, c));
            return u;
          };
        };
        ...
        for (
          var E = function (t, e) {
              var n,
                ...
                r = c(t),
                o = void 0 === e;
              if (!i && r && t.constructor === E && o) return t;
              k
                ? r && !o && (t = t.source)
                : t instanceof E && (o && (e = h.call(t)), (t = t.source)),
                x &&
                  (n = !!e && e.indexOf("y") > -1) &&
                  (e = e.replace(/y/g, ""));
              var a = s(k ? new y(t, e) : y(t, e), i ? this : m, E);
              return x && n && p(a, { sticky: n }), a;
            },
            S = function (t) {
              (t in E) ||
                a(E, t, {
          ...
          S(O[_++]);
        (m.constructor = E), (E.prototype = m), f(r, "RegExp", E);
      }
      v("RegExp");
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      function i(t, e) {
        function n(n) {
          for (var i = e.length - 1; i >= 0; i--) {
            ...
            if (
              (n.touches &&
                n.touches.length &&
                ((a = n.touches[0].clientX), (u = n.touches[0].clientY)),
              o(s, t, a, u))
            ) {
              s.dispatchEvent(r(n));
              break;
        ...
        for (
          var i = ["mouseup", "mousedown", "click", "touchstart"], s = 0;
          s < i.length;
          s++
        ) {
          var a = i[s];
      ...
      function o(t, e, n, i) {
        ...
        function o(t, e, n) {
          var i = t.top - r.top,
            ...
            s = i + t.height,
            a = o + t.width;
          return i <= n && o <= e && s > n && a > e;
        }
        if (!o(t.getBoundingClientRect(), n, i)) return !1;
        for (var s = t.getClientRects(), a = 0, u = s.length; a < u; a++)
          if (o(s[a], n, i)) return !0;
        return !1;
      }
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.proxyMouse = i),
