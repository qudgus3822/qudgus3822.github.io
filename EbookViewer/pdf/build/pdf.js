...
exports.StatTimer = exports.RenderingCancelledException = exports.PageViewport = exports.PDFDateString = exports.LinkTarget = exports.DOMStandardFontDataFactory = exports.DOMSVGFactory = exports.DOMCanvasFactory = exports.DOMCMapReaderFactory = exports.DEFAULT_LINK_REL = void 0;
...
var _base_factory = __w_pdfjs_require__(146);
...
var createNonEnumerableProperty = __w_pdfjs_require__(46);
var createPropertyDescriptor = __w_pdfjs_require__(15);
var clearErrorStack = __w_pdfjs_require__(102);
var installErrorCause = __w_pdfjs_require__(103);
var iterate = __w_pdfjs_require__(89);
var normalizeStringArgument = __w_pdfjs_require__(104);
var wellKnownSymbol = __w_pdfjs_require__(36);
var ERROR_STACK_INSTALLABLE = __w_pdfjs_require__(106);
var TO_STRING_TAG = wellKnownSymbol('toStringTag');
var $Error = Error;
var push = [].push;
...
var TO_STRING_TAG_SUPPORT = __w_pdfjs_require__(95);
var defineBuiltIn = __w_pdfjs_require__(50);
var toString = __w_pdfjs_require__(108);
...
var microtask = __w_pdfjs_require__(122);
var hostReportErrors = __w_pdfjs_require__(125);
var perform = __w_pdfjs_require__(126);
var Queue = __w_pdfjs_require__(127);
var InternalStateModule = __w_pdfjs_require__(54);
var NativePromiseConstructor = __w_pdfjs_require__(128);
var PromiseConstructorDetection = __w_pdfjs_require__(129);
...
var IS_IOS = __w_pdfjs_require__(121);
var IS_IOS_PEBBLE = __w_pdfjs_require__(123);
var IS_WEBOS_WEBKIT = __w_pdfjs_require__(124);
var IS_NODE = __w_pdfjs_require__(111);
...
var perform = __w_pdfjs_require__(126);
var iterate = __w_pdfjs_require__(89);
var PROMISE_STATICS_INCORRECT_ITERATION = __w_pdfjs_require__(133);
$({
 target: 'Promise',
 stat: true,
...
var NativePromiseConstructor = __w_pdfjs_require__(128);
var checkCorrectnessOfIteration = __w_pdfjs_require__(134);
var FORCED_PROMISE_CONSTRUCTOR = (__w_pdfjs_require__(129).CONSTRUCTOR);
...
var NativePromiseConstructor = __w_pdfjs_require__(128);
var FORCED_PROMISE_CONSTRUCTOR = (__w_pdfjs_require__(129).CONSTRUCTOR);
var promiseResolve = __w_pdfjs_require__(139);
...
exports.build = exports.PDFWorker = exports.PDFPageProxy = exports.PDFDocumentProxy = exports.PDFDataRangeTransport = exports.LoopbackPort = exports.DefaultStandardFontDataFactory = exports.DefaultCanvasFactory = exports.DefaultCMapReaderFactory = void 0;
...
var PDFPageProxy = /*#__PURE__*/function () {
  ...
  _createClass(PDFPageProxy, [{
    ...
    key: "getXfa",
    value: function () {
      var _getXfa = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
var WorkerTransport = /*#__PURE__*/function () {
  ...
  _createClass(WorkerTransport, [{
      ...
      messageHandler.on("obj", function (data) {
        ...
        switch (type) {
          case "Image":
            ...
            var MAX_IMAGE_SIZE_TO_STORE = 800000000;
    ...
    key: "startCleanup",
    value: function () {
      var _startCleanup = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var keepLoadedFonts,
            i,
            ii,
            page,
...
var _scripting_utils = __w_pdfjs_require__(159);
...
var _network_utils = __w_pdfjs_require__(164);
...
var _content_disposition = __w_pdfjs_require__(165);
...
var _api = __w_pdfjs_require__(147);

var _util = __w_pdfjs_require__(2);

var _annotation_layer = __w_pdfjs_require__(158);

var _worker_options = __w_pdfjs_require__(153);

var _is_node = __w_pdfjs_require__(4);

var _text_layer = __w_pdfjs_require__(160);

var _svg = __w_pdfjs_require__(161);

var _xfa_layer = __w_pdfjs_require__(162);

var pdfjsVersion = '2.10.381';
var pdfjsBuild = '1d7e38c67';
{
  if (_is_node.isNodeJS) {
    var _require = __w_pdfjs_require__(163),
    ...
    var _require2 = __w_pdfjs_require__(166),
        PDFNetworkStream = _require2.PDFNetworkStream;

    var _require3 = __w_pdfjs_require__(167),
