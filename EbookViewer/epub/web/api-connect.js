...
async function httpGet(apiMethod, param) {
  try {
    const response = await fetch(`${apiUrl}${apiMethod}.json`, {
      method: "GET",
      mode: "cors",
      headers: {
...
async function httpDelete(apiMethod, param) {
  // try {
  //     const response = await fetch(`${apiUrl}${apiMethod}.json`, {
  //         method: "POST",
  //         mode: "cors",
...
async function httpPatch(apiMethod, param) {
  // try {
  //     const response = await fetch(`${apiUrl}${apiMethod}.json`, {
  //         method: "POST",
  //         mode: "cors",
...
// async function reportReview(contentFeedbackNo, notifyReasonKindCode, notifyReasonComment, notifyMemberNo) {
//     try {
//         let param = {};
...
//         const response = await fetch(apiUrl + `api/Book/${bookId}/reviews/${UTC}/${MemberNo}`, {
//             method: "POST",
//             mode: "cors",
//             headers: {
//                 // "Ocp-Apim-Subscription-Key": "d2bfbf6c28e14eeea84ee569402cab26",
...
//     try {
//         const response = await fetch(apiUrl + "api/me/common-code" + '?CodeGroupCode=' + CodeGroupCode, {
//             method: "POST",
//             mode: "cors",
//             headers: {
//                 // "Ocp-Apim-Subscription-Key": "d2bfbf6c28e14eeea84ee569402cab26",
