  ...
  triggerSelectedEvent(selection) {
    ...
    if (selection && selection.rangeCount > 0) {
      ...
      if (!range.collapsed) {
        ...
        this.emit(constants["c" /* EVENTS */].CONTENTS.SELECTED, cfirange);
        this.emit(constants["c" /* EVENTS */].CONTENTS.SELECTED_RANGE, range);
      }
    }
  }
  /**
...
class IframeView {
  ...
  highlight(cfiRange, data = {}, cb, className = "epubjs-hl", styles = {}, color = "yellow") {
    ...
    if (this.contents.window.getSelection) {
      ...
      } else if (this.contents.window.getSelection().removeAllRanges) {
        // Firefox
