            ...
            <div className="card-body p-0">
              <ul className="nav nav-tabs" role="tablist">
                <li className="nav-item" >
                  <a className="nav-link active" data-bs-toggle="tab" href="#front" role="tab" aria-selected="false">Web</a>
                </li>
                ...
                <li className="nav-item">
                  <a className="nav-link" data-bs-toggle="tab" href="#info" role="tab" aria-selected="false">내 정보</a>
                </li>
              </ul>
                          ...
                          <div className="accordion" id="accordionFront">
                            <div className="accordion-item">
                              <h5 className="accordion-header m-0" id="headingProjectOne">
                                <button className="accordion-button fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseProjectOne" aria-expanded="false" aria-controls="collapseProjectOne">
                                  전자책 뷰어
                                </button>
                              </h5>
                              <div id="collapseProjectOne" className="accordion-collapse collapse show" aria-labelledby="headingProjectOne" data-bs-parent="#accordionFront">
                            ...
                            <div className="accordion-item">
                              ...
                              <div id="collapseProjectThree" className="accordion-collapse collapse" aria-labelledby="headingProjectThree" data-bs-parent="#accordionFront" >
                                <div className="accordion-body">
                                  <ul>
                                    <li>
                                      du.plus E-Book PC 뷰어 [EPUB, PDF] (100%)
                                    </li>
                                    <li>
                                      App(Web View) 뷰어 개발 [EPUB, PDF] (50%)
                                    </li>
                                    <li>
                                      프론트(next.js) 개발에 참여하였음 (20%)
                                    </li>
                                  </ul>
                                </div>
                              </div>
                          ...
                          <div className="accordion" id="accordionDesktop">
                            <div className="accordion-item">
                              <h5 className="accordion-header m-0" id="headingDesktopProjectOne">
                                <button className="accordion-button fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDesktopProjectOne" aria-expanded="false" aria-controls="collapseDesktopProjectOne">
                                  이니스프리 키오스크
                                </button>
                              </h5>
                              <div id="collapseDesktopProjectOne" className="accordion-collapse collapse show" aria-labelledby="headingDesktopProjectOne" data-bs-parent="#accordionDesktop">
                                <div className="accordion-body">
                                  <ul>
                                    <li>
                            ...
                            <div className="accordion-item">
                              ...
                              <div id="collapseDesktopProjectThree" className="accordion-collapse collapse" aria-labelledby="headingDesktopProjectThree" data-bs-parent="#accordionDesktop">
                                <div className="accordion-body">
                                  <ul>
                                    <li>
                                      BeeCast네트워크 모니터링 시스템 개발(WPF) (100%)
                                    </li>
                                  </ul>
                                </div>
                              </div>
                        ...
                        <div className="col-6">
                          <div className="card">
                            ...
                            <div className="card-body">
                              ...
                              <p className="font-14 text-muted ms-3">독서
                              </p>

                              <p className="font-14 text-muted ms-3">맛집탐방
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="accordion" id="accordionSchool">
                            <div className="accordion-item">
                              <h5 className="accordion-header m-0" id="headingSchoolTwo">
                                <button className="accordion-button fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSchoolTwo" aria-expanded="false" aria-controls="collapseSchoolTwo">
                                  단국대학교(천안)
                                </button>
                              </h5>
                              <div id="collapseSchoolTwo" className="accordion-collapse collapse show" aria-labelledby="headingSchoolTwo" data-bs-parent="#accordionSchool" >
                                <div className="accordion-body">
