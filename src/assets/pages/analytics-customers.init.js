...
var tabledata = [
  {
    id: 1,
    image:
      "<img alt='' style='width: 30px; height: 30px' class='rounded' src='assets/images/users/user-1.jpg'>",
    name: "Oli Bob",
    progress: 12,
    gender: "male",
    rating: 1,
  ...
  },
  {
    id: 2,
    image:
      "<img alt='' style='width: 30px; height: 30px' class='rounded' src='assets/images/users/user-2.jpg'>",
    name: "Mary May",
    progress: 1,
    gender: "female",
    rating: 2,
