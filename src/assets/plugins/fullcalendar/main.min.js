...
var FullCalendar = (function (e) {
  ...
  function b(e) {
    ((!e.__d && (e.__d = !0) && a.push(e) && !R.__r++) ||
      ...
      ((l = i.debounceRendering) || s)(R);
  }
  function R() {
    for (var e; (R.__r = a.length); )
  ...
  function D(e, t, n, r, o, i, a, s, l, u) {
    var c,
      ...
      D = R.length;
    for (
      l == d && (l = null != a ? a[0] : D ? E(r, 0) : null), n.__k = [], c = 0;
      c < t.length;
      c++
    )
      if (
        ...
        if (
          ((v.__ = n),
          (v.__b = n.__b + 1),
          null === (h = R[c]) || (h && v.key == h.key && v.type === h.type))
        )
          R[c] = void 0;
        else
          for (f = 0; f < D; f++) {
  ...
  function P(e, t, n) {
    ...
    for (r = 0; r < e.__k.length; r++)
      (o = e.__k[r]) &&
        ((o.__ = e),
        o.__e &&
          ("function" == typeof o.type && o.__k.length > 1 && P(o, t, n),
      ...
      e: if ("function" == typeof w) {
        if (
          ...
          null != w.getDerivedStateFromProps &&
            ...
            h(d.__s, w.getDerivedStateFromProps(E, d.__s))),
          (f = d.props),
          (g = d.state),
          p)
        )
  ...
  function N(e, t, n, r, o, i, a, s) {
    ...
    if (null === t.type) g === v || (s && e.data === v) || (e.data = v);
      ...
      if (
        ...
        (c = (g = n.props || d).dangerouslySetInnerHTML),
        (f = v.dangerouslySetInnerHTML),
        !s)
      ) {
        if (null != i)
          for (g = {}, h = 0; h < e.attributes.length; h++)
            g[e.attributes[h].name] = e.attributes[h].value;
        (f || c) &&
      ...
      (function (e, t, n, r, o) {
        ...
        s ||
          ("value" in v &&
            ...
            x(e, "value", l, g.value, !1),
          "checked" in v &&
            void 0 !== (l = v.checked) &&
            l !== e.checked &&
            x(e, "checked", l, g.checked, !1));
    }
    return e;
  }
  function H(e, t, n) {
  ...
  function ue(e, t, n) {
    var r, o;
    for (r = 0; r < n.length; r += 1) if ((o = ce(e, t, n[r]))) return o;
    return 0;
  }
  function ce(e, t, n) {
  ...
  function ze(e, t) {
    if (e === t) return !0;
    for (var n in e) if (Oe.call(e, n) && !(n in t)) return !1;
    for (var n in t) if (Oe.call(t, n) && e[n] !== t[n]) return !1;
    return !0;
  }
  function Ve(e, t) {
    var n = [];
  ...
  function Fe(e, t, n) {
    ...
    for (var r in t) if (!(r in e) || !je(e[r], t[r], n[r])) return !1;
  ...
  function qe(e, t, n) {
    ...
    a)) {
      ...
      if (u.recurringDef) {
        ...
        for (
          var d = 0, p = Ye(u, c, t, r, o.recurringTypes);
          d < p.length;
          d++
        ) {
          var f = p[d],
            h = He(l, { start: f, end: r.add(f, c) });
          s[h.instanceId] = h;
        }
      }
    }
  ...
  function lt(e) {
    return (
      pe(e.getUTCHours(), 2) +
      ":" +
      pe(e.getUTCMinutes(), 2) +
      ":" +
      pe(e.getUTCSeconds(), 2)
    );
  }
  function ut(e, t) {
    void 0 === t && (t = !1);
  ...
  var vt = {
    ...
    Rt = (function () {
      function e(e) {
        ...
        for (var o in e)
          o in vt
            ? ((n[o] = e[o]), (r = Math.max(vt[o], r)))
            : ((t[o] = e[o]), o in mt && (r = Math.max(mt[o], r)));
        (this.standardDateProps = t),
          (this.extendedSettings = n),
          (this.severity = r),
          (this.buildFormattingFunc = pt(Dt));
      }
      return (
  ...
  function Bt(e, t, n, r) {
    for (
      var o = { defs: {}, instances: {} }, i = rn(n), a = 0, s = e;
      a < s.length;
      a++
    ) {
  ...
  var $t = { id: String, groupId: String, title: String, url: String },
    Qt = { start: Ut, end: Ut, date: Ut, allDay: Boolean },
    en = r(r(r({}, $t), Qt), { extendedProps: Ut });
  ...
  function sn(e, t) {
    ...
    return (
      e.start && ((n = we(e.start)), r && r <= n && (r = ye(n, 1))),
      { start: n, end: r }
    );
  }
  function ln(e) {
  ...
  function un(e, t, n, r) {
    return "year" === r
      ? Ke(n.diffWholeYears(e, t), "year")
      : "month" === r
        ? Ke(n.diffWholeMonths(e, t), "month")
        : be(e, t);
  }
  function cn(e, t) {
    var n,
      ...
      o = [],
      i = t.start;
    for (e.sort(dn), n = 0; n < e.length; n += 1)
  ...
  var _n = { start: Ut, end: Ut, allDay: Boolean };
  function Nn(e, t, n) {
    var o = (function (e, t) {
        var n = Lt(e, _n),
          o = n.refined,
  ...
  function On(e, t, n) {
    return r(r({}, Wn(e, t, n)), { timeZone: t.timeZone });
  }
  function Wn(e, t, n) {
    return {
  ...
  function Un(e, t) {
    ...
    return (
      r(
        ...
        ((n = e),
        (o = t.dateEnv),
        r(r({}, Wn(n.range, o, n.allDay)), { allDay: n.allDay })),
      ),
      i
    );
  }
  ...
  function Fn(e, t, n, o, i) {
    ...
    return (
      ...
      u.range.end < u.range.start &&
        (u.range.end = Bn(t.allDay, u.range.start, i)),
      u
    );
  }
  var jn = (function () {
      ...
      return (
        ...
        (e.prototype.addEvent = function (e, t) {
          if (e instanceof Kn) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({
                  type: "ADD_EVENTS",
                  eventStore: zt({ def: n, instance: r }),
                }),
          ...
          if (s) {
            ...
            return (
              this.dispatch({ type: "ADD_EVENTS", eventStore: zt(s) }),
  ...
  var or = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeMonths = function (e, t) {
          var n = this.calendarSystem;
          return Ne(e) === Ne(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
        ...
        (e.prototype.timestampToMarker = function (e) {
          return "local" === this.timeZone
            ...
            : "UTC" !== this.timeZone && this.namedTimeZoneImpl
              ? Ie(this.namedTimeZoneImpl.timestampToArray(e))
              : new Date(e);
        }),
        (e.prototype.offsetForMarker = function (e) {
          return "local" === this.timeZone
            ? -ke(Pe(e)).getTimezoneOffset()
            : "UTC" === this.timeZone
              ? 0
              : this.namedTimeZoneImpl
                ? this.namedTimeZoneImpl.offsetForArray(Pe(e))
                : null;
        }),
          ...
          return "local" === this.timeZone
            ...
            : "UTC" === this.timeZone
              ...
              : this.namedTimeZoneImpl
                ? new Date(
                    e.valueOf() -
                      1e3 * this.namedTimeZoneImpl.offsetForArray(Pe(e)) * 60,
                  )
  ...
  function cr(e) {
    ...
    return new or(
      r(r({ timeZone: It.timeZone, calendarSystem: "gregory" }, e), {
        locale: t,
      }),
    );
  }
  ...
  function xr(e, t) {
    return (
      void 0 === t && (t = "day"), JSON.stringify({ date: st(e), type: t })
    );
  }
  var Mr,
    kr = null;
  ...
  if (
    ((Fr.prototype.classes = {}),
    (Fr.prototype.iconClasses = {}),
    (Fr.prototype.baseIconClass = ""),
    (Fr.prototype.iconOverridePrefix = ""),
  ...
  var to = (function (e) {
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          this.debug && console.log(Ve(e, this.props), Ve(t, this.state)),
          !Fe(this.props, e, this.propEquality) ||
            !Fe(this.state, t, this.stateEquality)
        );
      }),
      (t.addPropsEquality = ro),
      (t.addStateEquality = oo),
      (t.contextType = Qr),
      t
    );
  })(jr);
      ...
      !(
        ...
        !(function (e, t, n, o) {
          var i = t.getCurrentData(),
            ...
            l = s.defs,
            u = s.instances,
            c = Cn(l, a.isEvent ? e.eventUiBases : { "": i.selectionConfig });
          o && (c = Le(c, o));
          var d =
              ((g = e.eventStore),
              (v = a.affectedEvents.instances),
              {
                defs: g.defs,
          ...
          for (var m in u) {
            ...
            for (var D in f) {
              ...
              if (hn(S, w.range)) {
                ...
                if (R && !R(new Kn(t, p[w.defId], w), new Kn(t, C, y)))
                  return !1;
              }
            }
            for (var T = i.eventStore, x = 0, M = E.allows; x < M.length; x++) {
              var k = M[x],
                P = r(r({}, n), { range: y.range, allDay: C.allDay }),
                I = T.defs[C.defId],
                _ = T.instances[m],
                N = void 0;
              if (((N = I ? new Kn(t, I, _) : new Kn(t, C)), !k(Un(P, t), N)))
                return !1;
            }
          }
          return !0;
  ...
  var mo = (function (e) {
    ...
    return (
      ...
      (t.prototype.isInteractionValid = function (e) {
        ...
        if (t) for (var r in n) if (!gn(t.validRange, n[r].range)) return !1;
      ...
      (t.prototype.isDateSelectionValid = function (e) {
        ...
        return (
          !(r && !gn(r.validRange, e.range)) &&
          ((t = e), (n = this.context), co({ dateSelection: t }, n))
        );
      }),
  ...
  (Eo.prototype.classes = {
    ...
    (Eo.prototype.baseIconClass = "fc-icon"),
    (Eo.prototype.iconClasses = {
      close: "fc-icon-x",
    ...
    (Eo.prototype.iconOverrideOption = "buttonIcons"),
    (Eo.prototype.iconOverrideCustomButtonOption = "icon"),
    (Eo.prototype.iconOverridePrefix = "fc-icon-");
  var bo = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
      ...
      return (
        ...
        (t.prototype.renderInnerContent = function () {
          var e = this.context.pluginHooks.contentTypeHandlers,
            ...
            i = null;
          if (
            (void 0 === o && (o = ko(t.defaultContent, t.hookProps)),
            void 0 !== o)
          ) {
  ...
  function xo() {
    ...
    return function (r, o) {
      return (
        (t && ze(t, o) && r === e) || ((e = r), (t = o), (n = Mo(r, o))), n
      );
    };
  }
  function Mo(e, t) {
      ...
      n.content &&
        ...
        (o = function (e) {
          return Gr(Qr.Consumer, null, function (n) {
            return Gr(Po, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
    ...
    return (
      ...
      (e.prototype.build = function (e, t, n) {
        ...
        return (
          ...
          d.showNonCurrentDates || (s = pn(s, o.range)),
          (s = pn((s = this.adjustActiveRange(s)), r)),
          (l = hn(o.range, r)),
          {
            validRange: r,
      ...
      (e.prototype.adjustActiveRange = function (e) {
        ...
        return (
          r &&
            (tt(o) < 0 && ((a = we(a)), (a = n.add(a, o))),
            tt(i) > 1 && ((s = ye((s = we(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
      ...
      (e.prototype.buildDateIncrement = function (e) {
        ...
        return (
          n ||
          ((t = this.props.dateAlignment) ? Ke(1, t) : e || Ke({ days: 1 }))
        );
      }),
  ...
  function Xo(e, t, n, r, o) {
    ...
    return {
      headerToolbar: e.headerToolbar
        ? Ko(e.headerToolbar, e, t, n, r, o, i)
        : null,
      footerToolbar: e.footerToolbar
        ? Ko(e.footerToolbar, e, t, n, r, o, i)
        : null,
      viewsWithButtons: i,
    };
  }
  ...
  function Qo(e, t) {
    for (
      var n = Be(t.getCurrentData().eventSources), r = [], o = 0, i = e;
      o < i.length;
      o++
    ) {
      ...
      eventSourceDefs: [
        {
          ...
          fetch: function (e, t, n) {
            ...
            Ar(
              e.eventSource.meta.bind(null, On(e.range, r)),
              function (e) {
                t({ rawEvents: e });
              },
              n,
      ...
      recurringTypes: [
        {
          ...
          expand: function (e, t, n) {
            var r = pn(t, { start: e.startRecur, end: e.endRecur });
            return r
              ? (function (e, t, n, r) {
                  var o = e ? Ue(e) : null,
                    i = we(n.start),
    ...
    yo({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            r(r({}, On(e.activeRange, t.dateEnv)), { view: t.viewApi }),
          );
        },
  ...
  var ai = (function () {
    function e(e) {
      ...
      (this.computeOptionsData = pt(this._computeOptionsData)),
        (this.computeCurrentViewData = pt(this._computeCurrentViewData)),
        (this.organizeRawLocales = pt(sr)),
        (this.buildLocale = pt(lr)),
        (this.buildPluginHooks = So()),
        (this.buildDateEnv = pt(si)),
        (this.buildTheme = pt(li)),
        (this.parseToolbars = pt(Xo)),
        (this.buildViewSpecs = pt(No)),
        (this.buildDateProfileGenerator = ft(ui)),
        (this.buildViewApi = pt(ci)),
        (this.buildViewUiProps = ft(fi)),
        (this.buildEventUiBySource = pt(di, ze)),
        (this.buildEventUiBases = pt(pi)),
        (this.parseContextBusinessHours = ft(gi)),
        (this.buildTitle = pt(ii)),
        (this.emitter = new Lr()),
      ...
      for (
        var g = Wo(o.calendarOptions, d, p),
          v = {
      ...
      hi(v, p) && this.emitter.trigger("loading", !0),
        (this.state = v),
        this.updateData(),
    ...
    return (
        ...
        this.data &&
          ...
          (d = (function (e, t, n, r) {
            ...
            switch (t.type) {
              ...
              case "CHANGE_DATE":
                if (!e.activeRange || !vn(e.currentRange, t.dateMarker))
          ...
          vn(d.currentRange, c) || (c = d.currentRange.start);
        for (
          var p = Ao(n.eventSources, e, d, u),
            f = ao(n.eventStore, e, p, d, u),
            h =
              (Lo(p) &&
      ...
      (e.prototype.processRawCalendarOptions = function (e, t) {
        var n = At([It, e, t]),
          ...
          c = (this.currentCalendarOptionsRefiners = r(
            r(r(r(r({}, Pt), _t), Nt), u.listenerRefiners),
            u.optionRefiners,
          )),
          d = {},
          p = At([It, l, e, t]),
        ...
        for (var m in p)
          "plugins" !== m &&
            (p[m] === h[m] || (Ht[m] && m in h && Ht[m](h[m], p[m]))
              ? (f[m] = g[m])
              : c[m]
                ? ((f[m] = c[m](p[m])), (v = !0))
                : (d[m] = h[m]));
      ...
      (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
        var a = At([It, e.optionDefaults, n, o, e.optionOverrides, i]),
          s = r(
            r(r(r(r(r({}, Pt), _t), Nt), Wt), t.listenerRefiners),
            t.optionRefiners,
          ),
          l = {},
  ...
  var bi = {},
    ...
    Di = {},
    wi = { startTime: Ke, duration: Ke, create: Boolean, sourceId: String };
  function Ti(e) {
    var t = Lt(e, wi),
      n = t.refined,
      r = t.extra;
  ...
  var xi = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            if ("title" === c)
              (a = !1),
                i.push(Gr("h2", { className: "fc-toolbar-title" }, t.title));
            else {
          ...
          if (i.length > 1) {
            ...
            return Gr.apply(void 0, o(["div", { className: m }], i));
          }
          return i[0];
        }),
        t
    ...
    Pi = (function (e) {
      function t(t) {
        ...
        return (
          ...
          (n.destroy = J(t.el, "click", ".fc-event", n.handleSegClick)),
          n
        );
      }
      return n(t, e), t;
    ...
    _i = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.buildViewContext = pt(eo)),
          (t.buildViewPropTransformers = pt(Hi)),
          (t.buildToolbarProps = pt(Ni)),
          (t.handleNavLinkClick = K(
            "a[data-navlink]",
      ...
      return (
        ...
        (t.prototype.computeTiming = function () {
          ...
          return (
            (i = Math.min(864e5, i)),
            {
              currentState: { nowDate: r, todayRange: Vi(r) },
              nextState: { nowDate: o, todayRange: Vi(o) },
              waitMs: i,
            }
          );
        }),
  ...
  var Fi = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Gr(zi, { unit: "day" }, function (e, t) {
          return Gr(
            "tr",
            null,
            i && i("day"),
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            o([{ range: { start: e, end: Se(e, 1) }, allDay: !1 }, {}, t], n),
          );
        }),
        ...
        (e.prototype.sliceEventRange = function (e, t) {
          ...
          this.forceDayIfListItem &&
            ...
            (n = { start: n.start, end: ye(n.start, 1) });
          for (
  ...
  var da = (function (e) {
    function t() {
      ...
      return (
        ...
        (t.renderMicroColGroup = pt(ra)),
        (t.scrollerRefs = new Ji()),
        (t.scrollerElRefs = new Ji(t._handleScrollerEl.bind(t))),
        (t.state = {
          shrinkWidth: null,
          forceYScrollbars: !1,
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Gr(
          ...
          Boolean(!h && d.length) && Gr.apply(void 0, o(["thead", {}], d)),
          Boolean(!h && p.length) && Gr.apply(void 0, o(["tbody", {}], p)),
          Boolean(!h && f.length) && Gr.apply(void 0, o(["tfoot", {}], f)),
          h && Gr.apply(void 0, o(["tbody", {}], d, p, f)),
        );
      }),
      (t.prototype.renderSection = function (e, t) {
        return "outerContent" in e
          ? Gr(Zr, { key: e.key }, e.outerContent)
          : Gr(
              "tr",
              { key: e.key, className: sa(e, this.props.liquid).join(" ") },
  ...
  da.addStateEquality({ scrollerClientWidths: ze, scrollerClientHeights: ze });
  var pa = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.elRef = Yr()), t;
  ...
  function ha(e) {
    return Gr(
      ...
      e.timeText && Gr("div", { className: "fc-event-time" }, e.timeText),
      Gr(
        "div",
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this.props,
          ...
          o = wr(r, t.theme).concat(
            r.isDisabled
              ? []
              : this.normalizeClassNames(n.dayCellClassNames, r),
          ),
          i = r.isDisabled ? {} : { "data-date": st(e.date) };
        return Gr(
          To,
          {
            hookProps: r,
  ...
  function ba(e) {
    return (
      e.event.title && Gr("div", { className: "fc-event-title" }, e.event.title)
    );
  }
  var Ra = function (e) {
    return Gr(Qr.Consumer, null, function (t) {
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    Gr(
                      ...
                      Gr(_i, r({ isHeightAuto: i, forPrint: a }, e)),
                    )
                  );
                },
              ),
    ...
    ka = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (xa += 1) &&
            window.addEventListener("touchmove", Pa, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (xa -= 1) ||
              window.removeEventListener("touchmove", Pa, { passive: !1 });
        }),
  ...
  var Ia = (function () {
    ...
    La = (function () {
      function e(e) {
        (this.origRect = Or(e)),
          (this.scrollCaches = Wr(e).map(function (e) {
            return new Na(e, !0);
          }));
      }
      return (
        ...
        for (var i in n) {
          ...
          if (s && s.isWithinClipping(e, t)) {
            ...
            if (c >= 0 && c < f && d >= 0 && d < h) {
              ...
              g &&
                gn(v.activeRange, g.dateSpan.range) &&
                (!o || g.layer > o.layer) &&
                ((g.rect.left += l),
                (g.rect.right += l),
                (g.rect.top += u),
  ...
  function Ba(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && Hn(e.dateSpan, t.dateSpan))
    );
  }
  function za(e, t) {
    for (
      ...
      function t(t) {
        ...
        (n.dragSelection = null),
          ...
          (n.handlePointerUp = function (e) {
            n.dragSelection &&
              (Ln(n.dragSelection, e, n.component.context),
              (n.dragSelection = null));
          });
    ...
    function t(n) {
      ...
      (o.subjectEl = null),
        ...
        (o.handlePointerDown = function (e) {
          ...
          (o.relevantEvents = Vt(l.getCurrentData().eventStore, c)),
            ...
            if (e) {
              ...
              i === a || (p.editable && p.droppable)
                ? (s = (function (e, t, n) {
                  ...
                  ((l = zn(n, a.getCurrentData().eventUiBases, s, a)),
                  (c.mutatedEvents = l),
      ...
      (n.draggingSegEl = null),
        ...
        (n.handleHitUpdate = function (e, t, o) {
          ...
          e &&
            (u = (function (e, t, n, o, i) {
              for (
                var a = e.component.context.dateEnv,
                  ...
                  u = un(s, l, a, e.component.largeUnit),
                  c = {},
                  d = 0,
                  p = i;
                d < p.length;
            ...
            u &&
              ((c = zn(a, i.getCurrentData().eventUiBases, u, i)),
              (p.mutatedEvents = c),
        ...
        (this.context = e),
          ...
          (this.onDocumentPointerDown = function (e) {
            ...
            (t.matchesCancel = !!V(r, n)),
              (t.matchesEvent = !!V(r, ja.SELECTOR));
          }),
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ((s = (function (e, t, n) {
                  ...
                  var f = t.duration
                      ...
                      : Bn(e.allDay, p, n),
                    h = He(d.defId, { start: p, end: f });
                  return { def: d, instance: h };
                })(e.dateSpan, n.dragMeta, a)),
                (u.mutatedEvents = zt(s)),
                (l = !uo(u, a)) &&
      ...
      return (
        (e.prototype.buildDragMeta = function (e) {
          return "object" == typeof this.suppliedDragMeta
            ? Ti(this.suppliedDragMeta)
            : "function" == typeof this.suppliedDragMeta
              ? Ti(this.suppliedDragMeta(e))
              : Ti(
                  (t = (function (e, t) {
        ...
        (e.prototype.canDropElOnCalendar = function (e, t) {
          ...
          return "function" == typeof n
            ...
            : "string" != typeof n || !n || Boolean(F(e, n));
        }),
        e
      );
    })();
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              i = r.longPressDelay;
            (t.minDistance =
              null != o ? o : e.isTouch ? 0 : It.eventDragMinDistance),
              (t.delay = e.isTouch ? (null != i ? i : It.longPressDelay) : 0);
          }),
          (this.handleDragStart = function (e) {
            e.isTouch &&
              n.dragging.delay &&
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t) {
          ...
          return (
            ...
            Gr(Po, { viewSpec: r.viewSpec }, function (e, t) {
              return Gr(
                "div",
          ...
          return (
            ...
            l &&
              u.push({
                ...
                key: "footer",
                isSticky: !0,
                chunks: [{ key: "main", content: la }],
              }),
            Gr(Po, { viewSpec: a.viewSpec }, function (e, t) {
              return Gr(
                "div",
                { ref: e, className: ["fc-daygrid"].concat(t).join(" ") },
                Gr(o, {
      ...
      (t.prototype.render = function () {
        var e = this.props,
          t = this.context.options.navLinks
            ? { "data-navlink": xr(e.date), tabIndex: 0 }
            : {};
        return Gr(
          ma,
          {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            u = n.navLinks
              ? { "data-navlink": xr(a, "week"), tabIndex: 0 }
              : {};
          return Gr(
            Sa,
            {
            ...
            function (t, o, c, d) {
              return Gr(
                ...
                Gr(
                  ...
                  Gr("div", { className: "fc-daygrid-day-bg" }, i.bgContent),
                ),
              );
            },
          );
  ...
  ss.addPropsEquality({ onMoreClick: !0 });
  var us = kt({
    hour: "numeric",
    minute: "2-digit",
    omitZeroMinute: !0,
  ...
  function hs(e, t, n, o, i, a, s, l) {
    ...
    for (var m = 0, y = (t = Rn(t, l)); m < y.length; m++) {
      T(
        (D = y[m]),
        i[D.eventRange.instance.instanceId + ":" + D.firstCol] || 0,
      );
    }
    !0 === n || !0 === o
      ? (function (e, t, n, r) {
    ...
    for (var S = 0; S < s; S += 1) {
      for (var E = 0, C = 0, b = 0, R = u[S]; b < R.length; b++) {
        var D,
          w = R[b];
        d[(D = w.seg).eventRange.instance.instanceId] ||
          ((p[D.eventRange.instance.instanceId] = w.top),
          D.firstCol === D.lastCol && D.isStart && D.isEnd
            ? ((f[D.eventRange.instance.instanceId] = w.top - E),
              (C = 0),
              (E = w.bottom))
            : (C = w.bottom - E));
      }
  ...
  var ms = (function (e) {
    function t() {
      ...
      return (
        (t.cellElRefs = new Ji()),
        (t.frameElRefs = new Ji()),
        (t.fgElRefs = new Ji()),
        (t.segHarnessRefs = new Ji()),
        (t.rootElRef = Yr()),
        (t.state = {
          framePositions: null,
        ...
        if (p)
          for (var g = 0, v = e; g < v.length; g++) {
            var m = v[g],
              ...
              C = t[y] || E,
              b =
                t[y] || S || m.firstCol !== m.lastCol || !m.isStart || !m.isEnd,
              R = void 0,
              D = void 0,
              w = void 0,
              T = void 0;
            b
              ? ((D = n[y]),
                c.isRtl
                  ? ((T = 0), (w = p.lefts[m.lastCol] - p.lefts[m.firstCol]))
                  : ((w = 0), (T = p.rights[m.firstCol] - p.rights[m.lastCol])))
              : (R = o[y]),
              h.push(
                Gr(
                  "div",
          ...
          for (var l = 0, u = e; l < u.length; l++) {
            ...
            s.push(
              Gr(
                ...
                "bg-event" === t ? Gr(Ca, r({ seg: c }, kn(c, i))) : Ea(t),
              ),
            );
          }
        ...
        if (null !== t.clientWidth) {
          if (e) {
            ...
            if (r.length) {
              ...
              this.setState({ framePositions: new Ur(o, r, !0, !1) });
            }
          }
  ...
  ms.addPropsEquality({ onMoreClick: !0 }),
    ms.addStateEquality({ segHeights: ze });
  var ys = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.repositioner = new ri(t.updateSize.bind(t))),
          (t.handleRootEl = function (e) {
            (t.rootEl = e), t.props.elRef && io(t.props.elRef, e);
          }),
        ...
        (t.prototype.render = function () {
          ...
          return Gr(
            ...
            Gr(
              ...
              Gr("span", { className: "fc-popover-title" }, t.title),
              Gr("span", {
        ...
        (t.prototype.updateSize = function () {
          ...
          if (r) {
            ...
            (s = Math.min(s, window.innerHeight - i.height - 10)),
              ...
              Y(r, { top: s, left: (o = Math.max(o, 10)) });
          }
        }),
        t
      );
      ...
      return (
        ...
        (t.prototype.positionToHit = function (e, t, n) {
          ...
          return l >= 0 && l < i.width && u >= 0 && u < i.height
            ? {
                dateSpan: { allDay: !0, range: { start: c, end: ye(c, 1) } },
                dayEl: r,
                relativeRect: {
                  left: a,
                  top: s,
    ...
    Es = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.splitBusinessHourSegs = pt(ts)),
          (t.splitBgEventSegs = pt(ts)),
          (t.splitFgEventSegs = pt(ts)),
          (t.splitDateSelectionSegs = pt(ts)),
          (t.splitEventDrag = pt(rs)),
          (t.splitEventResize = pt(rs)),
          (t.buildBuildMoreLinkText = pt(Cs)),
          (t.morePopoverRef = Yr()),
          (t.rowRefs = new Ji()),
  ...
  function Ps(e) {
    ...
    return Gr(Qr.Consumer, null, function (n) {
      if (!e.isLabeled)
        return Gr("td", { className: t.join(" "), "data-time": e.isoTimeStr });
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a =
          null == o.slotLabelFormat
            ...
            : Array.isArray(o.slotLabelFormat)
              ? kt(o.slotLabelFormat[0])
              : kt(o.slotLabelFormat),
        s = {
          level: 0,
          time: e.time,
      ...
      return (
        ...
        (t.prototype.render = function () {
          return this.props.slatMetas.map(function (e) {
            return Gr("tr", { key: e.key }, Gr(Ps, r({}, e)));
          });
        }),
        t
      );
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              s =
                o.navLinks && 1 === a
                  ? { "data-navlink": xr(i.start, "week"), tabIndex: 0 }
                  : {};
            return o.weekNumbers && "day" === e
              ? Gr(
                  Ra,
                  { date: i.start, defaultFormat: Ns },
                  function (e, t, o, i) {
                    return Gr(
                      "th",
                      {
                  ...
                  content: function (e) {
                    return Gr(
                      ...
                      Gr(
                        ...
                        e.tableColGroupNode,
                        Gr("tbody", null, Gr(_s, { slatMetas: i })),
                      ),
                      Gr(
                        "div",
                        { className: "fc-timegrid-now-indicator-container" },
                        Gr(zi, { unit: h ? "minute" : "day" }, function (e) {
        ...
        (e.prototype.safeComputeTop = function (e) {
          ...
          if (vn(t.currentRange, e)) {
            ...
            if (r >= ot(t.slotMinTime) && r < ot(t.slotMaxTime))
              return this.computeTimeTop(Ke(r));
          }
          return null;
        }),
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = we(e)), this.computeTimeTop(Ke(e.valueOf() - t.valueOf()))
          );
        }),
  ...
  function js(e) {
    ...
    if (null == e.forwardPressure) {
      for (t = 0; t < r.length; t += 1)
        js((n = r[t])), (o = Math.max(o, 1 + n.forwardPressure));
      e.forwardPressure = o;
    }
  }
  function Gs(e, t, n, r) {
  ...
  var Ys = kt({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
    Zs = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Gr(
              fa,
              r({}, this.props, { defaultTimeFormat: Ys, extraClassNames: e }),
            )
          );
        }),
        t
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Gr(
            ...
            function (e, t) {
              return (
                t && Gr("div", { className: "fc-timegrid-col-misc", ref: e }, t)
              );
            },
          );
        }),
  ...
  var Ks = (function (e) {
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          ...
          var a = e.map(function (e) {
            return Gr(
              ...
              "bg-event" === t
                ? Gr(Ca, r({ seg: e }, kn(e, i.todayRange, i.nowDate)))
                : Ea(t),
            );
          });
          return Gr(Zr, null, a);
    ...
    Js = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.splitFgEventSegs = pt(Us)),
          (t.splitBgEventSegs = pt(Us)),
          (t.splitBusinessHourSegs = pt(Us)),
          (t.splitNowIndicatorSegs = pt(Us)),
          (t.splitDateSelectionSegs = pt(Us)),
          (t.splitEventDrag = pt(Bs)),
          (t.splitEventResize = pt(Bs)),
          (t.rootElRef = Yr()),
          (t.cellElRefs = new Ji()),
          t
        );
    ...
    return (
      ...
      (t.prototype.positionToHit = function (e, t) {
        ...
        if (null != d && null != p) {
          ...
          return {
            col: d,
            dateSpan: { range: { start: S, end: r.add(S, u) }, allDay: !1 },
            dayEl: i.els[d],
            relativeRect: {
              left: i.lefts[d],
              right: i.rights[d],
    ...
    tl = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Gr(zi, { unit: a ? "minute" : "day" }, function (l, u) {
            return Gr(
              $s,
              r(
  ...
  function ul(e) {
    ...
    return Gr(
      Zr,
      null,
      e.text && Gr("a", r({ className: "fc-list-day-text" }, t), e.text),
      e.sideText &&
        Gr("a", r({ className: "fc-list-day-side-text" }, t), e.sideText),
    );
  }
  var cl = kt({ hour: "numeric", minute: "2-digit", meridiem: "short" }),
    dl = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
              ...
              return Gr(
                ...
                (function (e, t, n) {
                  ...
                  if (!1 !== r.displayEventTime) {
                    ...
                    return Gr("td", { className: "fc-list-event-time" }, s);
                  }
                  return null;
                })(n, r, t),
                Gr(
                ...
                Gr("td", { className: "fc-list-event-title", ref: i }, a),
              );
            },
          );
        }),
  ...
  function pl(e) {
    var t = e.event,
      n = t.url;
    return Gr("a", r({}, n ? { href: n } : {}), t.title);
  }
  function fl(e) {
    return e.text;
  }
  var hl = (function (e) {
    ...
    return (
        ...
        return Gr(
          ...
          function (e, t, n, r) {
            return Gr(
              ...
              Gr("div", { className: "fc-list-empty-cushion", ref: n }, r),
            );
          },
        );
      }),
      (t.prototype.renderSegList = function (e, t) {
        ...
        return Gr(zi, { unit: "day" }, function (e, n) {
          for (var s = [], l = 0; l < a.length; l += 1) {
            var u = a[l];
            if (u) {
              var c = t[l].toISOString();
              s.push(Gr(ll, { key: c, dayDate: t[l], todayRange: n }));
              for (
                var d = 0, p = (u = Rn(u, i.eventOrder));
                d < p.length;
                d++
              ) {
                var f = p[d];
  ...
  function vl(e) {
    for (
      ...
      r.push(t), o.push({ start: t, end: ye(t, 1) }), (t = ye(t, 1));
  ...
  var El = yo({ themeClasses: { bootstrap: Sl } });
  var Cl = yo({
      eventSourceDefs: [
        {
          parseMeta: function (e) {
              ...
              var u = (function (e) {
                ...
                p = (function (e, t, n, o) {
                  ...
                  o.canComputeOffset
                    ...
                    : ((a = ye(e.start, -1).toISOString()),
                      (s = ye(e.end, 1).toISOString()));
                  (i = r(r({}, n || {}), {
                    key: t,
                    timeMin: a,
                    timeMax: s,
        ...
        function (e) {
          ...
          if (!/\w+:\/\/fullcalendar\.io\/|\/examples\/[\w-]+\.html$/.test(n)) {
            ...
            if ("valid" !== r)
              return Gr(
                "div",
                { className: "fc-license-message", style: Rl },
                "outdated" === r
                  ? Gr(
                      Zr,
                      null,
    ...
    xl = (function () {
      function e(e) {
        ...
        (this.el = e),
          ...
          (this.wheelWaiter = new ri(this._handleWheelWaited.bind(this))),
          (this.scrollWaiter = new ri(this._handleScrollWaited.bind(this))),
  ...
  var Nl = (function (e) {
            ...
            Gr(
              ...
              Gr(
                Ki,
                {
                  ...
                  overflowX:
                    "scroll-hidden" === e.overflowX ? "scroll" : e.overflowX,
                  overflowY:
                    "scroll-hidden" === e.overflowY ? "scroll" : e.overflowY,
                  overcomeLeft: r,
                  overcomeRight: o,
                  overcomeBottom: i,
                  maxHeight:
    ...
    Ol = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.compileColGroupStats = ht(Ul, Vl)),
          (t.renderMicroColGroups = ht(ra)),
          (t.clippedScrollerRefs = new Ji()),
          (t.scrollerElRefs = new Ji(t._handleScrollerEl.bind(t))),
          (t.chunkElRefs = new Ji(t._handleChunkEl.bind(t))),
          (t.getStickyScrolling = ht(Gl, null, ql)),
          (t.getScrollSyncersBySection = gt(Fl.bind(t, !0), null, jl)),
          (t.getScrollSyncersByColumn = gt(Fl.bind(t, !1), null, jl)),
          (t.stickyScrollings = []),
      ...
      return (
        ...
        (t.prototype.render = function () {
          for (
            var e,
              ...
              l = aa(t.liquid, r),
              u = this.getDims(),
              c = (u[0], u[1], t.sections),
              d = c.length,
              p = 0,
              f = [],
              h = [],
              g = [];
            p < d && "header" === (e = c[p]).type;

          )
            f.push(this.renderSection(e, p, a, s, n.sectionRowMaxHeights)),
              (p += 1);
          for (; p < d && "body" === (e = c[p]).type; )
            h.push(this.renderSection(e, p, a, s, n.sectionRowMaxHeights)),
              (p += 1);
          for (; p < d && "footer" === (e = c[p]).type; )
            g.push(this.renderSection(e, p, a, s, n.sectionRowMaxHeights)),
              (p += 1);
          var v = !Er();
          return Gr(
            "table",
            ...
            (function (e, t) {
              var n = e.map(function (e, n) {
                var r = e.width;
                return (
                  "shrink" === r && (r = e.totalColWidth + oa(t[n]) + 1),
                  Gr("col", { style: { width: r } })
                );
              });
              return Gr.apply(void 0, o(["colgroup", {}], n));
            })(a, i),
            Boolean(!v && f.length) && Gr.apply(void 0, o(["thead", {}], f)),
            Boolean(!v && h.length) && Gr.apply(void 0, o(["tbody", {}], h)),
            Boolean(!v && g.length) && Gr.apply(void 0, o(["tfoot", {}], g)),
            v && Gr.apply(void 0, o(["tbody", {}], f, h, g)),
          );
        }),
        ...
        (t.prototype.renderChunk = function (e, t, n, r, o, i, a) {
          if ("outerContent" in o)
            return Gr(Zr, { key: o.key }, o.outerContent);
          var s = this.state,
          ...
          return (
            ...
            Gr("td", { key: o.key, ref: this.chunkElRefs.createRef(f) }, b)
          );
        }),
        (t.prototype.componentDidMount = function () {
        ...
        (t.prototype.allowSizing = function () {
          ...
          return !this.lastSizingDate ||
            e.valueOf() > this.lastSizingDate.valueOf() + 1e3
          ...
          for (
            ...
            if (a && a.syncRowHeights) {
              for (var l = [], u = 0; u < r; u += 1) {
                ...
                (d = p
                  ? j(p, ".fc-scrollgrid-sync-table tr").map(function (t) {
                      var n = Al(t);
                      return e.set(t, n), n;
                    })
                  : []),
        ...
        (t.prototype.destroyScrollSyncers = function () {
          Le(this.scrollSyncersBySection, jl),
            Le(this.scrollSyncersByColumn, jl);
        }),
  ...
  var Yl = yo({ deps: [wl], scrollGridImpl: Ol }),
    Zl = [],
    Xl = [],
    Kl = yo({
      deps: [wl],
      contextInit: function (e) {
        Zl.length ||
          (window.addEventListener("beforeprint", Jl),
          window.addEventListener("afterprint", $l)),
          Zl.push(e),
          e.calendarApi.on("_unmount", function () {
            ct(Zl, e),
              Zl.length ||
                (window.removeEventListener("beforeprint", Jl),
                window.removeEventListener("afterprint", $l));
          });
      },
    });
  function Jl() {
    for (
      var e = j(document.body, ".fc-scroller-harness > .fc-scroller"),
        t = e.map(function (e) {
  ...
  function nu(e, t, n, r) {
    ...
    (o.largeUnit = s),
      (o.emphasizeWeeks =
        1 === $e(o.slotDuration) && au("weeks", e, t) >= 2 && !n.businessHours);
    var u,
      c,
      d = n.snapDuration;
    d && ((u = Ke(d)), (c = it(o.slotDuration, u))),
    ...
    o.isTimeScale &&
      ((f = t.add(f, e.slotMinTime)), (h = t.add(ye(h, -1), e.slotMaxTime))),
      (o.timeWindowMs = p),
      (o.normalizedRange = { start: f, end: h });
    for (var g = [], v = f; v < h; )
      ou(v, o, e, r) && g.push(v), (v = t.add(v, o.slotDuration));
    o.slotDates = g;
    var m = -1,
      y = 0,
      S = [],
      E = [];
    for (v = f; v < h; )
      ou(v, o, e, r) ? ((m += 1), S.push(m), E.push(y)) : S.push(m + 0.5),
        (v = t.add(v, o.snapDuration)),
        (y += 1);
    return (
      (o.snapDiffToIndex = S),
      (o.snapIndexToDiff = E),
      ...
      (o.slotsPerLabel = it(o.labelInterval, o.slotDuration)),
      o
    );
  }
  function ru(e, t, n) {
    ...
    return (
      t.isTimeScale ||
        ((r = we(r)), t.largeUnit && (r = n.startOf(r, t.largeUnit))),
      r
    );
  }
  function ou(e, t, n, r) {
    ...
    if (!o) {
      if (e.slotDuration) {
        ...
        for (var u = 0, c = tu; u < c.length; u++) {
          if (
            ((o = Ke(c[u])), n.countDurationsBetween(r.start, r.end, o) >= 18)
          )
            break;
        }
      e.labelInterval = o;
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            l = ["fc-timeline-slot", "fc-timeline-slot-label"].concat(
              "time" === o.rowUnit ? Tr(s, t.theme) : wr(s, t.theme),
            );
          ...
          var e = this,
            ...
            o =
              t.slatCoords && t.slatCoords.dateProfile === t.dateProfile
                ? t.slatCoords
                : null;
          return Gr(zi, { unit: r }, function (r, i) {
            return Gr(
              "div",
              ...
              n.options.nowIndicator &&
                Gr(
                  ...
                  o &&
                    o.isDateInRange(r) &&
                    Gr(ga, { isAxis: !0, date: r }, function (e, t, n, i) {
                      return Gr(
                        "div",
                        {
                          ref: e,
    ...
    hu = (function () {
      function e(e, t, n, r, o, i) {
        (this.slatRootEl = e),
          ...
          (this.dateEnv = o),
          (this.isRtl = i),
          (this.outerCoordCache = new Ur(e, t, !0, !1)),
          (this.innerCoordCache = new Ur(e, G(t, "div"), !0, !1));
      }
      return (
        ...
        (e.prototype.dateToCoord = function (e) {
          ...
          return this.isRtl
            ? a.rights[r] - i.getWidth(r) * o - a.originClientRect.width
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            c.push.apply(c, e.isDay ? wr(u, i) : Tr(u, i)),
            Gr(
              bo,
              {
                hookProps: p,
          ...
          var o = this.props,
            ...
            s = e.map(function (e) {
              ...
              return Gr(
                ...
                "bg-event" === n ? Gr(Ca, r({ seg: e }, kn(e, i, a))) : Ea(n),
              );
            });
          return Gr(Zr, null, s);
        }),
          ...
          for (var f = 0, h = 0, g = 0; g < s.length; g += 1) {
            ...
            (r = p),
              ...
              r.right > i.left &&
                ...
                o + r.height > a &&
                o < a + i.height &&
                ((f = v.top + v.dims.height), (h = g));
          }
          for (; h < s.length && f >= s[h].top; ) h += 1;
          s.splice(h, 0, { key: d, dims: p, top: f }),
  ...
  var wu = (function (e) {
      function t() {
        ...
        return (
          (t.slicer = new Eu()),
          (t.computeFgSegHorizontals = pt(Ru)),
          (t.computeSegVerticals = pt(Du)),
          (t.harnessElRefs = new Ji()),
          (t.innerElRef = Yr()),
          (t.state = { segDims: null }),
          t
        );
      }
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            i = this.slicer.sliceProps(
              e,
              r,
              o.isTimeScale ? null : e.nextDayThreshold,
              n,
              r,
            ...
            a =
              (i.eventDrag ? i.eventDrag.segs : null) ||
              (i.eventResize ? i.eventResize.segs : null) ||
              [],
            s = this.computeFgSegHorizontals(i.fgEventSegs, e.timelineCoords),
            l = this.computeSegVerticals(
              i.fgEventSegs,
          ...
          return Gr(
            ...
            Gr(
              ...
              this.renderFgSegs(i.fgEventSegs, s, u, d, !1, !1, !1),
              this.renderFgSegs(
                a,
                Ru(a, e.timelineCoords),
                u,
                {},
                Boolean(i.eventDrag),
          ...
          return Gr(
            ...
            Gr(zi, { unit: a }, function (a, s) {
              return Gr(
                ...
                r.nowIndicator &&
                  n.coords &&
                  n.coords.isDateInRange(a) &&
                  Gr(
                    "div",
                    { className: "fc-timeline-now-indicator-container" },
                    Gr(ga, { isAxis: !1, date: a }, function (e, t, r, o) {
                      return Gr(
                        "div",
                        {
                          ref: e,
                          className: ["fc-timeline-now-indicator-line"]
                            .concat(t)
                            .join(" "),
                          style: { left: n.coords.dateToCoord(a) },
                        },
                        o,
                      );
                    }),
    ...
    xu = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.buildTimelineDateProfile = pt(nu)),
          (t.scrollGridRef = Yr()),
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            u = [
              "fc-timeline",
              !1 === i.eventOverlap ? "fc-timeline-overlap-disabled" : "",
            ],
            c = i.slotMinWidth,
          ...
          return (
            s &&
              p.push({
                ...
                key: "footer",
                isSticky: !0,
                chunks: [{ key: "timeline", content: la }],
              }),
            Gr(Po, { viewSpec: o.viewSpec }, function (n, r) {
              return Gr(
                "div",
                { ref: n, className: u.concat(r).join(" ") },
                Gr(Ol, {
                  ref: e.scrollGridRef,
  ...
  function _u(e, t, n, o) {
    if (t) {
      var i = (function (e, t) {
        ...
        for (var r in e)
          for (
            var o = e[r], i = 0, a = t[o.defId].resourceIds;
            i < a.length;
            i++
          ) {
            var s = a[i];
  ...
  var Nu = (function () {
    function e() {
      (this.buildResourceEventUis = pt(Hu, ze)),
        (this.injectResourceEventUis = pt(Ou));
    }
    return (
      (e.prototype.transform = function (e, t) {
        return t.viewSpec.optionDefaults.needsResourceData
      ...
      case "CHANGE_VIEW_TYPE":
        return (function (e, t, n, r) {
          if (
            ...
            (!e.fetchRange || !fn(e.fetchRange, t))
          )
            return ju(e, t, r);
          return e;
  ...
  var Xu = { resourceId: String, resourceIds: Ut, resourceEditable: Boolean };
  var Ku = (function () {
    function e(e, t) {
    ...
    return (
      ...
      (e.prototype.getEvents = function () {
        ...
        for (var a in o) {
          var s = o[a],
            l = r[s.defId];
          -1 !== l.resourceIds.indexOf(e) && i.push(new Kn(t, l, s));
        }
        return i;
      }),
      Object.defineProperty(e.prototype, "id", {
  ...
  (Xn.prototype.addResource = function (e, t) {
    ...
    (Xn.prototype.getResources = function () {
      var e = this.getCurrentData(),
        t = e.resourceStore,
        n = [];
      if (t) for (var r in t) n.push(new Ku(e, t[r]));
      return n;
    }),
    (Xn.prototype.getTopLevelResources = function () {
      var e = this.getCurrentData(),
        t = e.resourceStore,
        n = [];
      if (t) for (var r in t) t[r].parentId || n.push(new Ku(e, t[r]));
      return n;
    }),
  ...
  function $u(e, t) {
    return r(r({}, t), { constraints: Qu(e, t.constraints) });
  }
  function Qu(e, t) {
    ...
    sc = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Gr(zi, { unit: "day" }, function (o, i) {
        ...
        (t.prototype.renderResourceRow = function (e, t) {
          var n = e.map(function (e) {
            return Gr(ac, { key: e.id, resource: e, colSpan: 1, date: t });
          });
        ...
        (t.prototype.renderDateCell = function (e, t, n, r, o, i) {
          var a = this.props,
            s = o ? ":" + o.id : "",
            l = o ? { resource: new Ku(this.context, o) } : {},
  ...
  var uc = function (e) {
          ...
          for (
            ...
            for (var i = [], a = 0; a < t.colCnt; a += 1)
              for (var s = 0; s < n.length; s += 1) {
                var l = n[s],
                  u = { resource: new Ku(this.context, l) },
    ...
    hc = (function () {
      function e() {
        (this.joinDateSelection = pt(this.joinSegs)),
          (this.joinBusinessHours = pt(this.joinSegs)),
          (this.joinFgEvents = pt(this.joinSegs)),
          (this.joinBgEvents = pt(this.joinSegs)),
          (this.joinEventDrags = pt(this.joinInteractions)),
          (this.joinEventResizes = pt(this.joinInteractions));
      }
      return (
        (e.prototype.joinProps = function (e, t) {
          for (
            ...
            n.push(f.dateSelectionSegs),
              r.push(p ? f.businessHourSegs : fc),
              i.push(p ? f.fgEventSegs : fc),
      ...
      (function e(t, n, r, o, i, a, s) {
          ...
          if (c)
            if (r) {
              ...
              var h = c.spec.field + ":" + c.value,
                g = null != a[h] ? a[h] : s;
              n.push({ id: h, group: c, isExpanded: g }),
        ...
        (function (e, t, n, r) {
          var o = (function (e, t) {
              ...
              for (var r in e) {
                var o = e[r];
                n[r] = { resource: o, resourceFields: Ec(o), children: [] };
              }
              for (var r in e) {
                if ((o = e[r]).parentId) {
                  var i = n[o.parentId];
  ...
  var bc = yo({
      ...
      dateSelectionTransformers: [
        function (e, t) {
          ...
          return n && r
            ? (!1 !== e.component.allowAcrossResources || n === r) && {
                resourceId: n,
              }
            : null;
        },
      ...
      isPropsValid: function (e, t) {
        ...
        for (var o in n) {
          ...
          if (
            ...
            !po(i, t, { resourceId: o }, $u.bind(null, o)))
          )
            return !1;
        }
        return !0;
    ...
    Dc = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            (this.allowAcrossResources = 1 === o.dayTableModel.colCnt),
            Gr(
              Es,
              r(
                {
          ...
          return n
            ? {
                ...
                dateSpan: {
                  ...
                  resourceId:
                    this.props.resourceDayTableModel.cells[n.row][n.col]
                      .resource.id,
                },
                dayEl: n.dayEl,
                rect: {
    ...
    wc = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.flattenResources = pt(vc)),
          (t.buildResourceDayTableModel = pt(Tc)),
          (t.headerRef = Yr()),
          (t.tableRef = Yr()),
          t
        );
  ...
  var xc = yo({
    ...
    kc = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            (this.allowAcrossResources = 1 === l.length),
            Gr(
              zi,
          ...
          return n
            ? {
                ...
                dateSpan: {
                  ...
                  allDay: n.dateSpan.allDay,
                  resourceId:
                    this.props.resourceDayTableModel.cells[0][n.col].resource
                      .id,
                },
                dayEl: n.dayEl,
                rect: {
    ...
    Pc = (function (e) {
      function t() {
        ...
        return (
          (t.flattenResources = pt(vc)),
          (t.buildResourceTimeColsModel = pt(Ic)),
          (t.buildSlatMetas = pt(ol)),
          t
        );
      }
      return (
  ...
  function Nc(e) {
    for (
      ...
      a.push(Gr("span", { className: "fc-icon" }));
    var l = ["fc-icon"];
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Gr(
          ...
          e.colSpecs.map(function (i, a) {
            ...
            return s > 1
              ? Gr(Lc, { key: a, colSpec: i, fieldValue: l, rowSpan: s })
              : Gr(Ac, {
                  key: a,
                  colSpec: i,
                  resource: t,
  ...
  Bc.addPropsEquality({ rowSpans: dt });
  var zc = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
  ...
  zc.addPropsEquality({ group: Cc });
  var Fc = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.resizerElRefs = new Ji(t._handleColResizerEl.bind(t))),
          (t.colDraggings = {}),
          t
        );
      }
    ...
    jc = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            t = this.context,
            n = { resource: new Ku(t, e.resource) };
          return Gr(
            Do,
            ...
            function (e, t) {
              return (
                t &&
                Gr("div", { className: "fc-timeline-lane-misc", ref: e }, t)
              );
            },
          );
        }),
  ...
  function qc(e) {
    return { resource: new Ku(e.context, e.resource) };
  }
  var Yc = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
            ...
            Gr(
              ...
              function (n, r, o, i) {
                return Gr(
                  ...
                  Gr("div", { style: { height: t.innerHeight }, ref: o }, i),
                );
              },
            ),
          );
  ...
  var Kc = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.computeHasResourceBusinessHours = pt(Jc)),
        (t.resourceSplitter = new Ju()),
        (t.bgSlicer = new Eu()),
        (t.slatsRef = Yr()),
        (t.state = { slatCoords: null }),
        (t.handleEl = function (e) {
      ...
      (t.prototype.render = function () {
        var e = this,
          ...
          c = this.bgSlicer.sliceProps(
            u,
            o,
            i.isTimeScale ? null : t.nextDayThreshold,
            r,
            o,
          ...
          d =
            n.slatCoords && n.slatCoords.dateProfile === t.dateProfile
              ? n.slatCoords
              : null;
        return Gr(
          "div",
          {
            ref: this.handleEl,
            className: "fc-timeline-body",
            style: { minWidth: t.tableMinWidth },
          },
          Gr(zi, { unit: a }, function (n, a) {
            return Gr(
              Zr,
              null,
              Gr(yu, {
              ...
              r.options.nowIndicator &&
                ...
                Gr(
                  "div",
                  { className: "fc-timeline-now-indicator-container" },
                  Gr(ga, { isAxis: !1, date: n }, function (e, t, r, o) {
                    return Gr(
                      "div",
                      {
                        ref: e,
  ...
  var $c = (function (e) {
      function t() {
        ...
        return (
          (t.scrollGridRef = Yr()),
          (t.timeBodyScrollerElRef = Yr()),
          (t.spreadsheetHeaderChunkElRef = Yr()),
          (t.rootElRef = Yr()),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Gr(Ol, {
            ...
            colGroups: [
              { cols: e.spreadsheetCols, width: s },
              { cols: [] },
              { cols: e.timeCols },
            ],
            sections: a,
          ...
          if (r) {
            ...
            l.emitter.on("dragstart", function () {
              ...
              l.emitter.on("dragmove", function (t) {
                ...
                (r = Math.max(r, 30)),
                  (r = Math.min(r, a - 30)),
                  e.setState({ resourceAreaWidthOverride: r });
              }),
    ...
    Qc = (function (e) {
      function t(t, n) {
        var r = e.call(this, t, n) || this;
        return (
          (r.processColOptions = pt(rd)),
          (r.buildTimelineDateProfile = pt(nu)),
          (r.hasNesting = pt(nd)),
          (r.buildRowNodes = pt(mc)),
          (r.layoutRef = Yr()),
          (r.rowNodes = []),
          (r.renderedRowNodes = []),
          (r.buildRowIndex = pt(ed)),
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            c = a.isVGrouping,
            d = a.colSpecs,
            p = this.buildTimelineDateProfile(
              t.dateProfile,
              r.dateEnv,
              o,
              r.dateProfileGenerator,
            ),
            f = (this.rowNodes = this.buildRowNodes(
              t.resourceStore,
              l,
              u,
              c,
              t.resourceEntityExpansions,
              o.resourcesInitiallyExpanded,
            )),
            h = [
              "fc-resource-timeline",
              this.hasNesting(f) ? "" : "fc-resource-timeline-flat",
              "fc-timeline",
              !1 === o.eventOverlap
          ...
          return Gr(Po, { viewSpec: i }, function (o, i) {
            return Gr(
              "div",
              { ref: o, className: h.concat(i).join(" ") },
              Gr($c, {
                ref: e.layoutRef,
                forPrint: t.forPrint,
                ...
                spreadsheetBodyRows: function (t) {
                  return Gr(
                    Zr,
                    null,
                    e.renderSpreadsheetRows(f, d, t.rowSyncHeights),
                  );
                },
                timeCols: v,
  ...
  Qc.addStateEquality({ spreadsheetColWidths: dt });
  var od = yo({
    deps: [wl, bc, ku],
  ...
  return (
    ei.push(Qa, xs, sl, yl, El, Cl, Yl, Kl, ku, bc, xc, _c, od),
    (e.AbstractResourceDayTableModel = cc),
    (e.BASE_OPTION_DEFAULTS = It),
    (e.BASE_OPTION_REFINERS = Pt),
    (e.BaseComponent = no),
    (e.BgEvent = Ca),
    (e.BootstrapTheme = Sl),
    (e.Calendar = wa),
    (e.CalendarApi = Xn),
    (e.CalendarContent = _i),
    (e.CalendarDataManager = ai),
    (e.CalendarDataProvider = mi),
    (e.CalendarRoot = Oi),
    (e.Component = jr),
    (e.ContentHook = Do),
    (e.CustomContentRenderContext = Ro),
    (e.DEFAULT_RESOURCE_ORDER = tc),
    (e.DateComponent = mo),
    (e.DateEnv = or),
    (e.DateProfileGenerator = Oo),
    (e.DayCellContent = ma),
    (e.DayCellRoot = Sa),
    (e.DayGridView = ws),
    (e.DayHeader = Fi),
    (e.DayResourceTableModel = pc),
    (e.DaySeriesModel = Gi),
    (e.DayTable = Ds),
    (e.DayTableModel = qi),
    (e.DayTableSlicer = Rs),
    (e.DayTimeCols = tl),
    (e.DayTimeColsSlicer = el),
    (e.DayTimeColsView = il),
    (e.DelayedRunner = ri),
    (e.Draggable = Ka),
    (e.ElementDragging = Ri),
    (e.ElementScrollController = zr),
    (e.Emitter = Lr),
    (e.EventApi = Kn),
    (e.EventRoot = pa),
    (e.EventSourceApi = B),
    (e.FeaturefulElementDragging = Aa),
    (e.Fragment = Zr),
    (e.Interaction = Si),
    (e.ListView = hl),
    (e.MountHook = To),
    (e.NamedTimeZoneImpl = yi),
    (e.NowIndicatorRoot = ga),
    (e.NowTimer = zi),
    (e.PointerDragging = ka),
    (e.PositionCache = Ur),
    (e.RefMap = Ji),
    (e.RenderHook = bo),
    (e.ResourceApi = Ku),
    (e.ResourceDayHeader = sc),
    (e.ResourceDayTable = Dc),
    (e.ResourceDayTableModel = dc),
    (e.ResourceDayTableView = wc),
    (e.ResourceDayTimeCols = kc),
    (e.ResourceDayTimeColsView = Pc),
    (e.ResourceLabelRoot = oc),
    (e.ResourceSplitter = Ju),
    (e.ResourceTimelineLane = Gc),
    (e.ResourceTimelineView = Qc),
    (e.ScrollController = Br),
    (e.ScrollGrid = Ol),
    (e.ScrollResponder = $r),
    (e.Scroller = Ki),
    (e.SimpleScrollGrid = da),
    (e.Slicer = Yi),
    (e.Splitter = br),
    (e.SpreadsheetRow = Bc),
    (e.StandardEvent = fa),
    ...
    (e.TableView = es),
    (e.Theme = Fr),
    (e.ThirdPartyDraggable = $a),
    (e.TimeCols = $s),
    (e.TimeColsSlatsCoords = Ws),
    (e.TimeColsView = Hs),
    (e.TimelineCoords = hu),
    (e.TimelineHeader = fu),
    (e.TimelineHeaderRows = pu),
    (e.TimelineLane = wu),
    (e.TimelineLaneBg = Su),
    (e.TimelineLaneSlicer = Eu),
    (e.TimelineSlats = yu),
    (e.TimelineView = xu),
    (e.VResourceJoiner = hc),
    (e.VResourceSplitter = gc),
    (e.ViewApi = jn),
    (e.ViewContextType = Qr),
    (e.ViewRoot = Po),
    (e.WeekNumberRoot = Ra),
    (e.WindowScrollController = Vr),
    (e.addDays = ye),
    (e.addDurations = Qe),
    (e.addMs = Se),
    (e.addWeeks = me),
    (e.allowContextMenu = se),
    (e.allowSelection = ie),
    (e.applyMutationToEventStore = zn),
    (e.applyStyle = Y),
    (e.applyStyleProp = Z),
    (e.asCleanDays = $e),
    (e.asRoughMinutes = nt),
    ...
    (e.buildDayRanges = nl),
    (e.buildDayTableModel = Ts),
    (e.buildEventApis = $n),
    (e.buildEventRangeKey = In),
    ...
    (e.buildNavLinkData = xr),
    (e.buildResourceFields = Ec),
    (e.buildRowNodes = mc),
    (e.buildSegCompareObj = Dn),
    (e.buildSegTimeText = Mn),
    (e.buildSlatCols = Mu),
    (e.buildSlatMetas = ol),
    (e.buildTimeColsModel = al),
    (e.buildTimelineDateProfile = nu),
    (e.collectFromHash = Ge),
    (e.combineEventUis = Kt),
    (e.compareByFieldSpec = ce),
    (e.compareByFieldSpecs = ue),
    (e.compareNumbers = fe),
    (e.compareObjs = Fe),
    (e.computeEdges = Nr),
    (e.computeFallbackHeaderFormat = Wi),
    ...
    (e.computeInnerRect = Hr),
    (e.computeRect = Or),
    (e.computeSegDraggable = wn),
    (e.computeSegEndResizable = xn),
    (e.computeSegStartResizable = Tn),
    (e.computeShrinkWidth = $i),
    (e.computeSmallestCellWidth = ge),
    (e.computeVisibleDayRange = sn),
    (e.config = Di),
    (e.constrainPoint = mr),
    (e.createContext = Xr),
    (e.createDuration = Ke),
    (e.createElement = Gr),
    (e.createEmptyEventStore = Ft),
    (e.createEventInstance = He),
    (e.createEventUi = Xt),
    ...
    (e.elementMatches = F),
    (e.enableCursor = re),
    (e.eventTupleToStore = zt),
    (e.filterEventStoreDefs = Gt),
    (e.filterHash = Ae),
    (e.findDirectChildren = G),
    (e.findElements = j),
    (e.flattenResources = vc),
    (e.flexibleCompare = de),
    (e.flushToDom = Kr),
    ...
    (e.getAllowYScrolling = ea),
    (e.getCanVGrowWithinCell = Er),
    (e.getClippingParents = Wr),
    (e.getDateMeta = Dr),
    (e.getDayClassNames = wr),
    (e.getDefaultEventEnd = Bn),
    (e.getElSeg = En),
    (e.getEventClassNames = Pn),
    (e.getIsRtlScrollbarOnLeft = Pr),
    (e.getPublicId = Yu),
    (e.getRectCenter = yr),
    (e.getRelevantEvents = Vt),
    (e.getScrollGridClassNames = aa),
    (e.getScrollbarWidths = Ir),
    (e.getSectionClassNames = sa),
    (e.getSectionHasLiquidHeight = Qi),
    (e.getSegMeta = kn),
    (e.getSlotClassNames = Tr),
    (e.getStickyFooterScrollbar = ca),
    (e.getStickyHeaderDates = ua),
    (e.getUnequalProps = Ve),
    (e.globalLocales = ir),
    (e.globalPlugins = ei),
    ...
    (e.hasShrinkWidth = ia),
    (e.identity = Ut),
    (e.interactionSettingsStore = bi),
    (e.interactionSettingsToStore = Ci),
    (e.intersectRanges = pn),
    (e.intersectRects = gr),
    (e.isArraysEqual = dt),
    (e.isColPropsEqual = na),
    (e.isDateSpansEqual = Hn),
    (e.isGroupsEqual = Cc),
    (e.isInt = he),
    (e.isInteractionValid = uo),
    (e.isMultiDayRange = ln),
    (e.isPropsEqual = ze),
    (e.isPropsValid = po),
    (e.isValidDate = _e),
    (e.listenBySelector = J),
    (e.mapHash = Le),
    (e.memoize = pt),
    (e.memoizeArraylike = ht),
    (e.memoizeHashlike = gt),
    (e.memoizeObjArg = ft),
    (e.mergeEventStores = jt),
    (e.multiplyDuration = et),
    (e.padStart = pe),
    (e.parseBusinessHours = fr),
    (e.parseClassNames = qt),
    (e.parseDragMeta = Ti),
    (e.parseEventDef = on),
    (e.parseFieldSpecs = le),
    (e.parseMarker = rr),
    (e.pointInsideRect = hr),
    (e.preventContextMenu = ae),
    (e.preventDefault = X),
    (e.preventSelection = oe),
    (e.rangeContainsMarker = vn),
    (e.rangeContainsRange = gn),
    (e.rangesEqual = fn),
    (e.rangesIntersect = hn),
    (e.refineEventDef = nn),
    (e.refineProps = Lt),
    (e.removeElement = z),
    (e.removeExact = ct),
    (e.render = qr),
    (e.renderChunkContent = ta),
    (e.renderFill = Ea),
    (e.renderMicroColGroup = ra),
    (e.renderScrollShim = la),
    (e.requestJson = Jo),
    (e.sanitizeShrinkWidth = oa),
    (e.setElSeg = Sn),
    (e.setRef = io),
    (e.setScrollFromStartingEdge = kl),
    (e.sliceEventStore = mn),
    ...
    (e.startOfDay = we),
    (e.translateRect = vr),
    (e.triggerDateSelect = Ln),
    (e.unmountComponentAtNode = Jr),
    (e.unpromisify = Ar),
    (e.version = "5.5.1"),
    (e.whenTransitionDone = Q),
