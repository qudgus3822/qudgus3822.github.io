...
var FullCalendar = (function (exports) {
  ...
  var INVALID_LICENSE_URL =
    "http://fullcalendar.io/docs/schedulerLicenseKey#invalid";
  var OUTDATED_LICENSE_URL =
    "http://fullcalendar.io/docs/schedulerLicenseKey#outdated";
  ...
  function buildLicenseWarning(context) {
    ...
    if (!isImmuneUrl(currentUrl)) {
      ...
      if (status_1 !== "valid") {
        return createElement(
          "div",
          { className: "fc-license-message", style: CSS },
          status_1 === "outdated"
            ? createElement(
                Fragment,
                null,
  ...
  function processLicenseKey(key) {
    ...
    if (parts && parts[1].length === 10) {
      ...
      var releaseDate = new Date(
        config.mockSchedulerReleaseDate || RELEASE_DATE,
      );
  ...
  var WHEEL_EVENT_NAMES =
    "wheel mousewheel DomMouseScroll MozMousePixelScroll".split(" ");
  /*
  ...
  var ScrollListener = /** @class */ (function () {
    function ScrollListener(el) {
      ...
      this.scrollWaiter = new DelayedRunner(
      ...
      for (
        var _i = 0, WHEEL_EVENT_NAMES_1 = WHEEL_EVENT_NAMES;
        _i < WHEEL_EVENT_NAMES_1.length;
        _i++
      ) {
    ...
    ScrollListener.prototype.destroy = function () {
      ...
      for (
        var _i = 0, WHEEL_EVENT_NAMES_2 = WHEEL_EVENT_NAMES;
        _i < WHEEL_EVENT_NAMES_2.length;
        _i++
      ) {
  ...
  function getScrollCanvasOrigin(scrollEl) {
    ...
    return {
      left:
        ...
        edges.borderLeft +
        edges.scrollbarLeft -
        getScrollFromLeftEdge(scrollEl),
  ...
  var IS_MS_EDGE =
    typeof navigator !== "undefined" && /Edge/.test(navigator.userAgent); // TODO: what about Chromeum-based Edge?
  ...
  var StickyScrolling = /** @class */ (function () {
    ...
    StickyScrolling.prototype.queryElGeoms = function (els) {
      ...
      for (var _i = 0, els_1 = els; _i < els_1.length; _i++) {
        ...
        var parentBound = translateRect(
          computeInnerRect(el.parentNode, true, true), // weird way to call this!!!
          -canvasOrigin.left,
          -canvasOrigin.top,
        );
    ...
    // only for IE
    StickyScrolling.prototype.computeElDestinations = function (
      elGeoms,
      viewportWidth,
    ) {
    ...
    ClippedScroller.prototype.render = function () {
      ...
      return createElement(
        "div",
        {
          ...
          className:
            "fc-scroller-harness" +
            (props.liquid ? " fc-scroller-harness-liquid" : ""),
        },
        createElement(
          Scroller,
          {
            ...
            overflowX:
              props.overflowX === "scroll-hidden" ? "scroll" : props.overflowX,
            overflowY:
              props.overflowY === "scroll-hidden" ? "scroll" : props.overflowY,
            ...
            maxHeight:
              typeof props.maxHeight === "number"
                ? props.maxHeight +
                  (props.overflowX === "scroll-hidden"
                    ? state.xScrollbarWidth
                    : 0)
                : "",
            liquid: props.liquid,
            liquidIsAbsolute: true,
    ...
    ScrollSyncer.prototype.bindScroller = function (el) {
      ...
      var onScroll = function (isWheel, isTouch) {
        if (!_this.isPaused) {
          if (
            !_this.masterEl ||
            (_this.masterEl !== el && (isWheel || isTouch))
          ) {
          ...
          if (_this.masterEl === el) {
            ...
            for (
              var _i = 0, scrollEls_1 = scrollEls;
              _i < scrollEls_1.length;
              _i++
            ) {
  ...
  var ScrollGrid = /** @class */ (function (_super) {
    ...
    function ScrollGrid() {
      var _this = (_super !== null && _super.apply(this, arguments)) || this;
      _this.compileColGroupStats = memoizeArraylike(
        compileColGroupStat,
        isColGroupStatsEqual,
      );
      ...
      _this.getStickyScrolling = memoizeArraylike(
        initStickyScrolling,
        null,
        destroyStickyScrolling,
      );
      _this.getScrollSyncersBySection = memoizeHashlike(
        initScrollSyncer.bind(_this, true),
        null,
        destroyScrollSyncer,
      );
      _this.getScrollSyncersByColumn = memoizeHashlike(
        initScrollSyncer.bind(_this, false),
        null,
        destroyScrollSyncer,
      );
      ...
      _this.handleRowHeightChange = function (rowEl, isStable) {
        ...
        if (!isStable) {
          ...
          if (
            !rowInnerMaxHeightMap.has(rowEl) ||
            rowInnerMaxHeightMap.get(rowEl) !== innerMaxHeight
          ) {
    ...
    ScrollGrid.prototype.render = function () {
      ...
      var colGroupStats = this.compileColGroupStats(
        props.colGroups.map(function (colGroup) {
          return [colGroup];
        }),
      );
      var microColGroupNodes = this.renderMicroColGroups(
        colGroupStats.map(function (stat, i) {
    ...
    ScrollGrid.prototype.renderSection = function (
      sectionConfig,
      sectionIndex,
      colGroupStats,
      microColGroupNodes,
    ...
    ScrollGrid.prototype.renderChunk = function (
      sectionConfig,
      sectionIndex,
      colGroupStat,
      microColGroupNode,
      ...
      var sideScrollIndex =
        !this.context.isRtl || getIsRtlScrollbarOnLeft()
          ? chunksPerSection - 1
          : 0;
      ...
      var content = renderChunkContent(sectionConfig, chunkConfig, {
        ...
        clientWidth:
          scrollerClientWidths[index] !== undefined
            ? scrollerClientWidths[index]
            : null,
        clientHeight:
          scrollerClientHeights[index] !== undefined
            ? scrollerClientHeights[index]
            : null,
      ...
      var overflowX = forceXScrollbars
        ? isLastSection
          ? "scroll"
          : "scroll-hidden"
        : !allowXScrolling
          ...
          : isLastSection
            ? "auto"
            : "scroll-hidden";
      var overflowY = forceYScrollbars
        ? isVScrollSide
          ? "scroll"
          : "scroll-hidden"
        : !allowYScrolling
      ...
      return createElement(
        "td",
        { key: chunkConfig.key, ref: this.chunkElRefs.createRef(index) },
        content,
      );
    };
    ...
    ScrollGrid.prototype.componentDidUpdate = function (prevProps, prevState) {
      ...
      this.handleSizing(
        false,
        prevState.sectionRowMaxHeights !== this.state.sectionRowMaxHeights,
      );
    };
    ...
    ScrollGrid.prototype.computeShrinkWidths = function () {
      var _this = this;
      var colGroupStats = this.compileColGroupStats(
        this.props.colGroups.map(function (colGroup) {
          return [colGroup];
        }),
      );
      var _a = this.getDims(),
      ...
      for (var sectionI = 0; sectionI < sectionCnt; sectionI += 1) {
        ...
        if (sectionConfig && sectionConfig.syncRowHeights) {
          ...
          for (var chunkI = 1; chunkI < chunksPerSection; chunkI += 1) {
            var isOuterContent =
              sectionConfig.chunks[chunkI] &&
              sectionConfig.chunks[chunkI].outerContent !== undefined; // can be null
            if (
              !isOuterContent &&
              rowHeightsByChunk[chunkI].length !== rowCnt
            ) {
              // skip outer content
              isEqualRowCnt = false;
              break;
          ...
          if (!isEqualRowCnt) {
            ...
            for (var chunkI = 0; chunkI < chunksPerSection; chunkI += 1) {
              chunkHeightSums.push(
                sumNumbers(rowHeightsByChunk[chunkI]) +
                  rowHeightsByChunk[chunkI].length,
              );
            }
            ...
            for (var chunkI = 0; chunkI < chunksPerSection; chunkI += 1) {
              ...
              var rowInChunkHeightOthers = Math.floor(
                rowInChunkTotalHeight / rowInChunkCnt,
              );
              // whatever is leftover goes to the first row
              var rowInChunkHeightFirst =
                rowInChunkTotalHeight -
                rowInChunkHeightOthers * (rowInChunkCnt - 1);
    ...
    ScrollGrid.prototype.updateScrollSyncers = function () {
      ...
      for (var sectionI = 0; sectionI < sectionCnt; sectionI += 1) {
        ...
        scrollElsBySection[sectionI] = collectFromHash(
          scrollElMap,
          startIndex,
          endIndex,
          1,
      ...
      for (var col = 0; col < chunksPerSection; col += 1) {
        scrollElsByColumn[col] = this.scrollerElRefs.collect(
          col,
          cnt,
          chunksPerSection,
      ...
      this.scrollSyncersBySection =
        this.getScrollSyncersBySection(scrollElsBySection);
      this.scrollSyncersByColumn =
        this.getScrollSyncersByColumn(scrollElsByColumn);
    };
    ...
    ScrollGrid.prototype.getDims = function () {
      ...
      var chunksPerSection = sectionCnt
        ? this.props.sections[0].chunks.length
        : 0;
  ...
  function getRowInnerMaxHeight(rowEl) {
    var innerHeights = findElements(rowEl, ".fc-scrollgrid-sync-inner").map(
      getElHeight,
    );
  ...
  function renderMacroColGroup(colGroupStats, shrinkWidths) {
    var children = colGroupStats.map(function (colGroupStat, i) {
      ...
      if (width === "shrink") {
        width =
          colGroupStat.totalColWidth + sanitizeShrinkWidth(shrinkWidths[i]) + 1; // +1 for border :(
      }
      return (
    ...
    return createElement.apply(
      void 0,
      __spreadArrays(["colgroup", {}], children),
    );
  }
  function compileColGroupStat(colGroupConfig) {
    ...
    var allowXScrolling =
      colGroupConfig.width !== "shrink" &&
      Boolean(totalColWidth || totalColMinWidth || hasShrinkCol);
    return {
  ...
  function handleBeforePrint() {
    ...
    undoFuncs.push(function () {
      return restoreScrollerCoords(scrollEls, scrollCoords);
    });
  ...
  function buildTimelineDateProfile(
    dateProfile,
    dateEnv,
    allOptions,
    dateProfileGenerator,
    ...
    if (!tDateProfile.isTimeScale) {
      var slotUnit = greatestDurationDenominator(
    ...
    // more...
    var timeWindowMs =
      asRoughMs(dateProfile.slotMaxTime) - asRoughMs(dateProfile.slotMinTime);
    ...
    while (date < normalizedEnd) {
      if (
        isValidDate$1(date, tDateProfile, dateProfile, dateProfileGenerator)
      ) {
        slotDates.push(date);
      }
    ...
    tDateProfile.slotsPerLabel = wholeDivideDurations(
  ...
  function ensureLabelInterval(tDateProfile, dateProfile, dateEnv) {
    ...
    if (!labelInterval) {
      ...
      if (tDateProfile.slotDuration) {
        for (
          var _i = 0, STOCK_SUB_DURATIONS_1 = STOCK_SUB_DURATIONS$1;
        ...
        for (
          var _a = 0, STOCK_SUB_DURATIONS_2 = STOCK_SUB_DURATIONS$1;
  ...
  function ensureSlotDuration(tDateProfile, dateProfile, dateEnv) {
    ...
    if (!slotDuration) {
      var labelInterval = ensureLabelInterval(
        tDateProfile,
        dateProfile,
        dateEnv,
      ...
      for (
        var _i = 0, STOCK_SUB_DURATIONS_3 = STOCK_SUB_DURATIONS$1;
  ...
  function buildCellRows(tDateProfile, dateEnv) {
    ...
    var guessedSlotUnit =
      slotAsDays === 7 ? "week" : slotAsDays === 1 ? "day" : null;
    ...
    for (var i = 0; i < slotDates.length; i += 1) {
      ...
      for (var row = 0; row < formats.length; row += 1) {
        ...
        var newCell = null;
        var rowUnit =
          rowUnitsFromFormats[row] || (isLastRow ? guessedSlotUnit : null);
        if (isSuperRow) {
          var text = dateEnv.format(date, format);
    ...
    TimelineHeaderThInner.prototype.render = function () {
      ...
      return createElement(
        ContentHook,
        {
          ...
          defaultContent: renderInnerContent$5,
        },
        function (innerElRef, innerContent) {
          return createElement(
            "a",
  ...
  var TimelineHeaderTh = /** @class */ (function (_super) {
    ...
    TimelineHeaderTh.prototype.render = function () {
      ...
      var classNames = ["fc-timeline-slot", "fc-timeline-slot-label"].concat(
      ...
      var navLinkData =
        options.navLinks && cell.rowUnit && cell.rowUnit !== "time"
          ...
          return createElement(
            ...
            createElement(
              "div",
              {
                ...
                style: { height: props.rowInnerHeight },
              },
  ...
  var TimelineHeaderRows = /** @class */ (function (_super) {
    ...
    TimelineHeaderRows.prototype.render = function () {
      ...
      return createElement(
        Fragment,
        null,
        cellRows.map(function (rowCells, rowLevel) {
          ...
          return (
            ...
            createElement(
              "tr",
              { key: rowLevel, className: classNames.join(" ") },
  ...
  var TimelineHeader = /** @class */ (function (_super) {
    ...
    TimelineHeader.prototype.render = function () {
      ...
      var timerUnit = greatestDurationDenominator(
      ...
      return createElement(
        ...
        function (nowDate, todayRange) {
          return createElement(
            "div",
            { className: "fc-timeline-header", ref: _this.rootElRef },
            createElement(
              "table",
              {
                className: "fc-scrollgrid-sync-table",
              ...
              createElement(
                "tbody",
                null,
                createElement(TimelineHeaderRows, {
                  dateProfile: props.dateProfile,
                  tDateProfile: props.tDateProfile,
                  nowDate: nowDate,
                  todayRange: todayRange,
            ...
            context.options.nowIndicator &&
              ...
              createElement(
                ...
                slatCoords &&
                  slatCoords.isDateInRange(nowDate) &&
                  createElement(
                    NowIndicatorRoot,
                    { isAxis: true, date: nowDate },
                    function (rootElRef, classNames, innerElRef, innerContent) {
  ...
  var TimelineCoords = /** @class */ (function () {
    function TimelineCoords(
      slatRootEl, // okay to expose?
      slatEls,
      dateProfile,
      tDateProfile,
      dateEnv,
  ...
  var TimelineSlatCell = /** @class */ (function (_super) {
    ...
    TimelineSlatCell.prototype.render = function () {
      ...
      var hookProps = __assign(
        __assign({ date: dateEnv.toDate(props.date) }, dateMeta),
        { view: context.viewApi },
      );
      if (isEm) {
        classNames.push("fc-timeline-slot-em");
    ...
    TimelineSlatsBody.prototype.render = function () {
      ...
      return createElement(
        ...
        createElement(
          "tr",
          null,
          slotDates.map(function (slotDate, i) {
    ...
    TimelineSlats.prototype.render = function () {
      ...
      return createElement(
        ...
        createElement(
          ...
          props.tableColGroupNode,
          createElement(TimelineSlatsBody, {
  ...
  var TimelineLaneBg = /** @class */ (function (_super) {
    ...
    TimelineLaneBg.prototype.render = function () {
      var props = this.props;
      var highlightSeg = [].concat(
        props.eventResizeSegs,
        props.dateSelectionSegs,
      );
      return (
    ...
    TimelineLaneBg.prototype.renderSegs = function (
      segs,
      timelineCoords,
      fillType,
    ) {
      ...
      var children = segs.map(function (seg) {
        ...
        return createElement(
          ...
          fillType === "bg-event"
            ? createElement(
                BgEvent,
                __assign({ seg: seg }, getSegMeta(seg, todayRange, nowDate)),
              )
            : renderFill(fillType),
        );
      });
  ...
  var TimelineLaneSlicer = /** @class */ (function (_super) {
    ...
    TimelineLaneSlicer.prototype.sliceRange = function (
      origRange,
      dateProfile,
      dateProfileGenerator,
      tDateProfile,
  ...
  function computeSegVerticals$1(segs, eventOrderSpecs, dimHash) {
    ...
    var maxBottom = 0;
    if (dimHash) {
      // protection for if dims not computed yet
      segs = sortEventSegs(segs, eventOrderSpecs);
      for (var _i = 0, segs_2 = segs; _i < segs_2.length; _i++) {
        var seg = segs_2[_i];
        ...
        if (dims) {
          ...
          while (
            insertI < placements.length &&
            top_1 >= placements[insertI].top
          ) {
            insertI += 1;
          }
  ...
  var TimelineLane = /** @class */ (function (_super) {
    ...
    TimelineLane.prototype.render = function () {
      ...
      var mirrorSegs =
        ...
        [];
      var segHorizontals = this.computeFgSegHorizontals(
        slicedProps.fgEventSegs,
        props.timelineCoords,
      ); // ONLY for non-mirror. needed?
      var _b = this.computeSegVerticals(
          slicedProps.fgEventSegs,
          context.options.eventOrder,
          state.segDims,
        ),
      ...
      var hiddenSegs = // TODO: more convenient
        (slicedProps.eventDrag
          ? slicedProps.eventDrag.affectedInstances
          : null) ||
        (slicedProps.eventResize
          ? slicedProps.eventResize.affectedInstances
          : null) ||
        {};
      return createElement(
        Fragment,
        ...
        createElement(TimelineLaneBg, {
          ...
          eventResizeSegs: slicedProps.eventResize
            ? slicedProps.eventResize.segs
            : [] /* bad new empty array? */,
        ...
        createElement(
          "div",
          {
            ...
            ref: this.innerElRef,
            style: { height: height /* computed by computeSegVerticals */ },
          },
          this.renderFgSegs(
            slicedProps.fgEventSegs,
            segHorizontals,
          ...
          this.renderFgSegs(
            mirrorSegs,
            computeSegHorizontals$1(mirrorSegs, props.timelineCoords), // not memoized
    ...
    TimelineLane.prototype.componentDidUpdate = function (
      prevProps,
      prevState,
    ) {
      if (
    ...
    TimelineLane.prototype.renderFgSegs = function (
      segs,
      segHorizontals,
      segTops,
      hiddenSegs,
          ...
          return createElement(
            "div",
            {
              ...
              style: {
                ...
                top: top != null ? top : "",
                visibility: hiddenSegs[instanceId]
                  ? "hidden"
                  : "" /* wtf, file @types/react bug */,
              },
            },
            createElement(
              TimelineEvent,
              __assign(
                {
                  isTimeScale: _this.props.tDateProfile.isTimeScale,
                  seg: seg,
                  isDragging: isDragging,
                  isResizing: isResizing,
                  isDateSelecting: isDateSelecting,
                  isSelected:
                    instanceId ===
                    _this.props.eventSelection /* TODO: bad for mirror? */,
                },
                getSegMeta(seg, props.todayRange, props.nowDate),
              ),
            ),
  ...
  var TimelineGrid = /** @class */ (function (_super) {
          ...
          function (nowDate, todayRange) {
            return createElement(
              ...
              options.nowIndicator &&
                state.coords &&
                state.coords.isDateInRange(nowDate) &&
                createElement(
                  "div",
                  { className: "fc-timeline-now-indicator-container" },
                  createElement(
                    NowIndicatorRoot,
                    { isAxis: false, date: nowDate },
                    function (rootElRef, classNames, innerElRef, innerContent) {
                      return createElement(
                        "div",
                        {
    ...
    // Hit System
    // ------------------------------------------------------------------------------------------
    TimelineGrid.prototype.queryHit = function (
      positionLeft,
      positionTop,
      elWidth,
      elHeight,
  ...
  var TimelineView = /** @class */ (function (_super) {
    ...
    TimelineView.prototype.render = function () {
      ...
      var stickyFooterScrollbar =
        !props.forPrint && getStickyFooterScrollbar(options);
      var tDateProfile = this.buildTimelineDateProfile(
        props.dateProfile,
        context.dateEnv,
        options,
        context.dateProfileGenerator,
          ...
          chunks: [
            {
              ...
              content: function (contentArg) {
                return createElement(TimelineHeader, {
                  ...
                  tDateProfile: tDateProfile,
                  slatCoords: state.slatCoords,
                  onMaxCushionWidth: slotMinWidth
                    ? null
                    : _this.handleMaxCushionWidth,
                });
              },
            },
          ],
    ...
    TimelineView.prototype.computeFallbackSlotMinWidth = function (
      tDateProfile,
    ) {
      return Math.max(
        30,
        (this.state.slotCushionMaxWidth || 0) / tDateProfile.slotsPerLabel,
      );
    };
    return TimelineView;
  })(DateComponent);
  ...
  function applyEventDefMutation(eventDef, mutation, context) {
    ...
    if (resourceMutation && computeResourceEditable(eventDef, context)) {
      var index = eventDef.resourceIds.indexOf(
        resourceMutation.matchResourceId,
      );
      if (index !== -1) {
  ...
  function computeResourceEditable(eventDef, context) {
    ...
    if (resourceEditable == null) {
      var source =
        eventDef.sourceId &&
        context.getCurrentData().eventSources[eventDef.sourceId];
      if (source) {
  ...
  function transformEventDrop(mutation, context) {
    ...
    if (resourceMutation) {
      ...
      return {
        oldResource: calendarApi.getResourceById(
          resourceMutation.matchResourceId,
        ),
        newResource: calendarApi.getResourceById(
          resourceMutation.setResourceId,
        ),
      };
    }
    return {
  ...
  function filterResources(
    ...
    if (doFilterResourcesWithEvents) {
      ...
      __assign(
        hasEvents_1,
        computeAncestorHasEvents(hasEvents_1, resourceStore),
      );
  ...
  function createSource(
    ...
    if (input) {
      ...
      source = fetchSource$1(
        source,
        refetchResourcesOnNavigate ? activeRange : null,
        context,
      );
      return source;
    }
  ...
  function parseResource(raw, parentId, store, context) {
    ...
    var resource = {
      ...
      title: refined.title || "",
      businessHours: refined.businessHours
        ? parseBusinessHours(refined.businessHours, context)
        : null,
      ui: createEventUi(
        {
  ...
  function reduceResourceStore(store, action, source, context) {
    ...
    switch (action.type) {
      ...
      case "SET_RESOURCE_EXTENDED_PROP":
        return setResourceExtendedProp(
          store,
          action.resourceId,
          action.propName,
          action.propValue,
  ...
  function removeResource(existingStore, resourceId) {
    ...
    for (var childResourceId in newStore) {
      ...
      if (newStore[childResourceId].parentId === resourceId) {
        newStore[childResourceId] = __assign(
          __assign({}, newStore[childResourceId]),
          { parentId: "" },
        );
      }
    }
  ...
  function setResourceProp(existingStore, resourceId, name, value) {
    ...
    if (existingResource) {
      return __assign(
        __assign({}, existingStore),
        ((_a = {}),
        (_a[resourceId] = __assign(
          __assign({}, existingResource),
          ((_b = {}), (_b[name] = value), _b),
        )),
        _a),
      );
  ...
  function setResourceExtendedProp(existingStore, resourceId, name, value) {
    ...
    if (existingResource) {
      return __assign(
        __assign({}, existingStore),
        ((_a = {}),
        (_a[resourceId] = __assign(__assign({}, existingResource), {
          extendedProps: __assign(
            __assign({}, existingResource.extendedProps),
            ((_b = {}), (_b[name] = value), _b),
          ),
        })),
        _a),
  ...
  function reduceResources(state, action, context) {
    ...
    var resourceEntityExpansions = reduceResourceEntityExpansions(
      state && state.resourceEntityExpansions,
      action,
    );
    return {
  ...
  function generateEventDefResourceMembers(refined) {
    return {
      resourceIds: ensureStringArray(refined.resourceIds).concat(
        refined.resourceId ? [refined.resourceId] : [],
      ),
  ...
  function isPropsValidWithResources(combinedProps, context) {
    ...
    var sets = splitter.splitProps(
      __assign(__assign({}, combinedProps), {
    ...
    for (var resourceId in sets) {
      ...
      if (resourceId && sets[""]) {
        ...
        props = __assign(__assign({}, props), {
          ...
          eventUiBases: __assign(
            __assign({}, sets[""].eventUiBases),
            props.eventUiBases,
          ),
        });
      }
  ...
  function handleResourceStore(resourceStore, calendarData) {
    ...
    if (emitter.hasHandlers("resourcesSet")) {
      emitter.trigger(
        "resourcesSet",
        buildResourceApis(resourceStore, calendarData),
      );
    }
  }
    ...
    return createElement(ViewContextType.Consumer, null, function (context) {
      ...
      return createElement(
        RenderHook,
        {
          ...
          defaultContent: renderInnerContent$6,
  ...
  var ResourceDayHeader = /** @class */ (function (_super) {
    ...
    ResourceDayHeader.prototype.render = function () {
      ...
      var _a = this,
        props = _a.props,
        context = _a.context;
      var dateFormat = this.buildDateFormat(
        context.options.dayHeaderFormat,
      ...
      return createElement(
        ...
        function (nowDate, todayRange) {
          ...
          return _this.renderResourceAndDayRows(
            props.resources,
            props.dates,
            dateFormat,
            todayRange,
    ...
    ResourceDayHeader.prototype.renderDayAndResourceRows = function (
      ...
      for (var _i = 0, dates_1 = dates; _i < dates_1.length; _i++) {
        ...
        for (
          var _a = 0, resources_1 = resources;
          _a < resources_1.length;
          _a++
        ) {
          var resource = resources_1[_a];
          resourceCells.push(
            createElement(ResourceCell, {
  ...
  var ResourceDayTableModel = /** @class */ (function (_super) {
    ...
    /*
        ...
        */
    ResourceDayTableModel.prototype.computeColRanges = function (
      dateStartI,
      dateEndI,
      resourceI,
    ) {
  ...
  var DayResourceTableModel = /** @class */ (function (_super) {
    ...
    /*
        ...
        */
    DayResourceTableModel.prototype.computeColRanges = function (
      dateStartI,
      dateEndI,
      resourceI,
    ) {
  ...
  var VResourceJoiner = /** @class */ (function () {
    ...
    /*
        ...
        */
    VResourceJoiner.prototype.joinProps = function (
      propSets,
      resourceDayTable,
    ) {
      ...
      return {
        dateSelectionSegs: this.joinDateSelection.apply(
          this,
          __spreadArrays([resourceDayTable], dateSelectionSets),
        ),
        businessHourSegs: this.joinBusinessHours.apply(
          this,
          __spreadArrays([resourceDayTable], businessHoursSets),
        ),
        fgEventSegs: this.joinFgEvents.apply(
          this,
          __spreadArrays([resourceDayTable], fgEventSets),
        ),
        bgEventSegs: this.joinBgEvents.apply(
          this,
          __spreadArrays([resourceDayTable], bgEventSets),
        ),
        eventDrag: this.joinEventDrags.apply(
          this,
          __spreadArrays([resourceDayTable], eventDrags),
        ),
        eventResize: this.joinEventResizes.apply(
          this,
          __spreadArrays([resourceDayTable], eventResizes),
        ),
  ...
  function buildResourceFields(resource) {
    var obj = __assign(
      __assign(__assign({}, resource.extendedProps), resource.ui),
      resource,
    );
    delete obj.ui;
  ...
  var ResourceDayTableJoiner = /** @class */ (function (_super) {
    ...
    ResourceDayTableJoiner.prototype.transformSeg = function (
      seg,
      resourceDayTableModel,
      resourceI,
    ) {
      var colRanges = resourceDayTableModel.computeColRanges(
        seg.firstCol,
        seg.lastCol,
        resourceI,
      );
  ...
  var ResourceDayTable = /** @class */ (function (_super) {
    ...
    ResourceDayTable.prototype.render = function () {
      ...
      this.allowAcrossResources =
        resourceDayTableModel.dayTableModel.colCnt === 1; // hack for EventResizing
      return createElement(
        Table,
        __assign(
          {
      ...
      if (rawHit) {
        return {
          ...
          dateSpan: {
            ...
            resourceId:
              this.props.resourceDayTableModel.cells[rawHit.row][rawHit.col]
                .resource.id,
          },
          dayEl: rawHit.dayEl,
          rect: {
  ...
  var ResourceDayTableView = /** @class */ (function (_super) {
    ...
    ResourceDayTableView.prototype.render = function () {
      ...
      var resources = this.flattenResources(
        props.resourceStore,
        resourceOrderSpecs,
      );
      var resourceDayTableModel = this.buildResourceDayTableModel(
        props.dateProfile,
        context.dateProfileGenerator,
        resources,
      ...
      var headerContent =
        options.dayHeaders &&
        createElement(ResourceDayHeader, {
          ref: this.headerRef,
          resources: resources,
          dateProfile: props.dateProfile,
  ...
  var ResourceDayTimeColsJoiner = /** @class */ (function (_super) {
    ...
    ResourceDayTimeColsJoiner.prototype.transformSeg = function (
      seg,
      resourceDayTable,
      resourceI,
    ) {
  ...
  var ResourceDayTimeCols = /** @class */ (function (_super) {
            ...
            return createElement(
              ...
              __assign(
                ...
                _this.joiner.joinProps(slicedProps, resourceDayTableModel),
                {
                  ...
                  nowIndicatorSegs:
                    options.nowIndicator &&
                    _this.buildNowIndicatorSegs(nowDate),
                  todayRange: todayRange,
                  onScrollTopRequest: props.onScrollTopRequest,
                  forPrint: props.forPrint,
                  onSlatCoords: props.onSlatCoords,
    ...
    ResourceDayTimeCols.prototype.buildNowIndicatorSegs = function (date) {
      var nonResourceSegs = this.slicers[""].sliceNowDate(
        date,
        this.context,
        this.dayRanges,
      );
    ...
    ResourceDayTimeCols.prototype.queryHit = function (
      positionLeft,
      positionTop,
    ) {
      var rawHit = this.timeColsRef.current.positionToHit(
      ...
      if (rawHit) {
        return {
          ...
          dateSpan: {
            ...
            allDay: rawHit.dateSpan.allDay,
            resourceId:
              this.props.resourceDayTableModel.cells[0][rawHit.col].resource.id,
          },
          dayEl: rawHit.dayEl,
          rect: {
            left: rawHit.relativeRect.left,
  ...
  var ResourceDayTimeColsView = /** @class */ (function (_super) {
    ...
    ResourceDayTimeColsView.prototype.render = function () {
      ...
      var resourceDayTableModel = this.buildResourceTimeColsModel(
        dateProfile,
        context.dateProfileGenerator,
        resources,
        options.datesAboveResources,
      ...
      createElement(
        "span",
        {
          className:
            ...
            (hasChildren ? "" : " fc-datagrid-expander-placeholder"),
    ...
    SpreadsheetIndividualCellInner.prototype.render = function () {
      ...
      return createElement(
        ...
        function (innerElRef, innerContent) {
          return createElement(
            "span",
            { className: "fc-datagrid-cell-main", ref: innerElRef },
            innerContent,
          );
        },
      );
    ...
    SpreadsheetRow.prototype.render = function () {
      ...
      return createElement(
        ...
        props.colSpecs.map(function (colSpec, i) {
          ...
          var fieldValue = colSpec.field
            ? resourceFields[colSpec.field]
  ...
  var SpreadsheetHeader = /** @class */ (function (_super) {
              ...
              function (rootElRef, classNames, innerElRef, innerContent) {
                return createElement(
                  "th",
                  {
                    ...
                    ref: rootElRef,
                    className: ["fc-datagrid-cell", "fc-datagrid-cell-super"]
                      .concat(classNames)
                      .join(" "),
                  },
                  createElement(
    ...
    SpreadsheetHeader.prototype._handleColResizerEl = function (
      resizerEl,
      index,
    ) {
    ...
    SpreadsheetHeader.prototype.initColResizing = function (resizerEl, index) {
      ...
      if (ElementDraggingImpl) {
        ...
        dragging.emitter.on("dragmove", function (pev) {
          currentWidths_1[index] = Math.max(
            startWidth_1 + pev.deltaX * (isRtl ? -1 : 1),
  ...
  var ResourceTimelineLaneMisc = /** @class */ (function (_super) {
    ...
    ResourceTimelineLaneMisc.prototype.render = function () {
      ...
      return createElement(
        ContentHook,
        { hookProps: hookProps, content: context.options.resourceLaneContent },
        function (innerElRef, innerContent) {
          return (
            innerContent && // TODO: test how this would interfere with height
            createElement(
              "div",
              { className: "fc-timeline-lane-misc", ref: innerElRef },
              innerContent,
            )
          );
        },
  ...
  var ResourceTimelineLane = /** @class */ (function (_super) {
    ...
    ResourceTimelineLane.prototype.render = function () {
      ...
      var customClassNames = this.normalizeClassNames(
        options.resourceLaneClassNames,
        hookProps,
      );
      return createElement(
        "tr",
        ...
        createElement(
          ...
          function (rootElRef, classNames, innerElRef, innerContent) {
            return createElement(
              ...
              createElement(
                "div",
                { style: { height: props.innerHeight }, ref: innerElRef },
                innerContent,
              ),
            );
          },
  ...
  var ResourceTimelineLanesBody = /** @class */ (function (_super) {
    ...
    ResourceTimelineLanesBody.prototype.render = function () {
      ...
      return createElement(
        "tbody",
        null,
        props.rowNodes.map(function (node, index) {
          if (node.group) {
          ...
          if (node.resource) {
            ...
            return createElement(
              ...
              __assign(
                { key: node.id, elRef: rowElRefs.createRef(node.id) },
                props.splitProps[resource.id],
                {
                  ...
                  nextDayThreshold: context.options.nextDayThreshold,
                  businessHours:
                    resource.businessHours || props.fallbackBusinessHours,
                  innerHeight: innerHeights[index] || "",
    ...
    ResourceTimelineLanes.prototype.render = function () {
      ...
      return createElement(
        "table",
        {
          ref: this.rootElRef,
          className:
            "fc-scrollgrid-sync-table " + context.theme.getClass("table"),
          style: {
            minWidth: props.tableMinWidth,
            width: props.clientWidth,
            height: props.minHeight,
  ...
  var ResourceTimelineGrid = /** @class */ (function (_super) {
    ...
    function ResourceTimelineGrid() {
      var _this = (_super !== null && _super.apply(this, arguments)) || this;
      _this.computeHasResourceBusinessHours = memoize(
    ...
    ResourceTimelineGrid.prototype.render = function () {
      ...
      var hasResourceBusinessHours = this.computeHasResourceBusinessHours(
        props.rowNodes,
      );
      var splitProps = this.resourceSplitter.splitProps(props);
      var bgLaneProps = splitProps[""];
      var bgSlicedProps = this.bgSlicer.sliceProps(
        bgLaneProps,
        dateProfile,
        tDateProfile.isTimeScale ? null : props.nextDayThreshold,
      ...
      // WORKAROUND: make ignore slatCoords when out of sync with dateProfile
      var slatCoords =
        state.slatCoords && state.slatCoords.dateProfile === props.dateProfile
          ? state.slatCoords
          : null;
      return createElement(
        "div",
        ...
        createElement(
          ...
          function (nowDate, todayRange) {
            return createElement(
              ...
              createElement(TimelineLaneBg, {
                businessHourSegs: hasResourceBusinessHours
                  ? null
                  : bgSlicedProps.businessHourSegs,
                bgEventSegs: bgSlicedProps.bgEventSegs,
                timelineCoords: slatCoords,
                // empty array will result in unnecessary rerenders?
                eventResizeSegs: bgSlicedProps.eventResize
                  ? bgSlicedProps.eventResize.segs
                  : [],
              ...
              createElement(ResourceTimelineLanes, {
                ...
                fallbackBusinessHours: hasResourceBusinessHours
                  ? props.businessHours
                  : null,
                clientWidth: props.clientWidth,
                minHeight: props.expandRows ? props.clientHeight : "",
    ...
    // Hit System
    // ------------------------------------------------------------------------------------------
    ResourceTimelineGrid.prototype.queryHit = function (
      positionLeft,
      positionTop,
    ) {
  ...
  var ResourceTimelineViewLayout = /** @class */ (function (_super) {
    ...
    ResourceTimelineViewLayout.prototype.render = function () {
      ...
      var resourceAreaWidth =
        state.resourceAreaWidthOverride != null
    ...
    ResourceTimelineViewLayout.prototype.initSpreadsheetResizing = function () {
      ...
      if (ElementDraggingImpl) {
        ...
        var dragging = (this.spreadsheetResizerDragging =
          new ElementDraggingImpl(rootEl_1, ".fc-resource-timeline-divider"));
    ...
    ResourceTimelineViewLayout.prototype.destroySpreadsheetResizing =
      function () {
  ...
  var ResourceTimelineView = /** @class */ (function (_super) {
    ...
    ResourceTimelineView.prototype.render = function () {
      ...
      var rowNodes = (this.rowNodes = this.buildRowNodes(
        props.resourceStore,
        groupSpecs,
        orderSpecs,
        isVGrouping,
        ...
        function (rootElRef, classNames) {
          return createElement(
            ...
            createElement(ResourceTimelineViewLayout, {
              ...
              forPrint: props.forPrint,
              isHeightAuto: props.isHeightAuto,
              spreadsheetCols: buildSpreadsheetCols(
                colSpecs,
              ...
              spreadsheetBodyRows: function (contentArg) {
                return createElement(
                  Fragment,
                  null,
                  _this.renderSpreadsheetRows(
                    rowNodes,
                    colSpecs,
                    contentArg.rowSyncHeights,
                  ),
                );
              },
              timeCols: slatCols,
    ...
    ResourceTimelineView.prototype.renderSpreadsheetRows = function (
      nodes,
      colSpecs,
      rowSyncHeights,
    ) {
    ...
    ResourceTimelineView.prototype.componentDidUpdate = function (
      prevProps,
      prevState,
      snapshot,
    ) {
    ...
    ResourceTimelineView.prototype.computeFallbackSlotMinWidth = function (
      tDateProfile,
    ) {
      return Math.max(
        30,
  ...
  function processColOptions(options) {
    ...
    for (
      ...
      if (colSpec.group) {
        groupColSpecs.push(
          __assign(__assign({}, colSpec), {
            cellClassNames:
              colSpec.cellClassNames || options.resourceGroupLabelClassNames,
            cellContent:
              colSpec.cellContent || options.resourceGroupLabelContent,
            cellDidMount:
              colSpec.cellDidMount || options.resourceGroupLabelDidMount,
            cellWillUnmount:
              colSpec.cellWillUnmount || options.resourceGroupLaneWillUnmount,
          }),
        );
      } else {
    ...
    mainColSpec.cellClassNames =
      mainColSpec.cellClassNames || options.resourceLabelClassNames;
    mainColSpec.cellContent =
      mainColSpec.cellContent || options.resourceLabelContent;
    mainColSpec.cellDidMount =
      mainColSpec.cellDidMount || options.resourceLabelDidMount;
    mainColSpec.cellWillUnmount =
      mainColSpec.cellWillUnmount || options.resourceLabelWillUnmount;
