!(function () {
  ...
  const { language: j, format: H, weekStart: $ } = B;
  function _(e, t) {
  ...
  function q(t, s) {
    ...
    if (a.language) {
      ...
      if (
        ...
        o = n.language = e;
        const t = c || r[j];
        (c = Object.assign({ format: H, weekStart: $ }, r[j])),
          o !== j && Object.assign(c, r[o]),
          (n.locale = c),
  ...
  class G extends X {
    ...
    setOptions(t) {
      ...
      void 0 !== t.showDaysOfWeek &&
        (t.showDaysOfWeek
          ? (K(this.dow), this.calendarWeeks && K(this.calendarWeeks.dow))
  ...
  function re(t, i) {
    if (
      (void 0 !== i.title &&
        (i.title
          ? ((t.controls.title.textContent = i.title), K(t.controls.title))
    ...
    if (
      ...
      void 0 !== i.todayBtn &&
        (i.todayBtn ? K(t.controls.todayBtn) : W(t.controls.todayBtn)),
    ...
    void 0 !== i.clearBtn &&
      (i.clearBtn ? K(t.controls.clearBtn) : W(t.controls.clearBtn));
  }
  function de(e) {
  ...
  class me {
    constructor(e, t = {}, i) {
      ...
      const o = (this.picker = new le(this));
      if (n) this.show();
      else {
