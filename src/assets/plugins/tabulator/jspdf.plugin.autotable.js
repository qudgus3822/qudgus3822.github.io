      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function styles(styles) {
          ...
          return polyfills_1.assign.apply(
            void 0,
            [config_1.defaultStyles()].concat(styles),
          );
        }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function printFullRow(row) {
          ...
          if (!canFitOnPage(row.maxCellHeight)) {
            if (
              row.maxCellLineCount <= 1 ||
              (table.settings.rowPageBreak === "avoid" &&
                !rowHeightGreaterThanMaxTableHeight(row))
            ) {
              addPage();
            } else {
        ...
        function rowHeightGreaterThanMaxTableHeight(row) {
          ...
          var pageHeight = state_1.default().pageHeight();
          var maxTableHeight =
            pageHeight - table.margin("top") - table.margin("bottom");
            ...
            for (var _i = 0, _a = table.columns; _i < _a.length; _i++) {
              ...
              if (colRowSpansLeft > 1) {
                ...
                if (data.cell.height > row.maxCellHeight) {
                  ...
                  data.row.maxCellLineCount = Array.isArray(data.cell.text)
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function parseInput(args) {
          ...
          table.settings = polyfills_1.assign.apply(
            void 0,
            [{}, config_1.defaultConfig()].concat(allOptions),
          );
          ...
          var _loop_2 = function (sectionName) {
            ...
            sectionRows.forEach(function (rawRow, rowIndex) {
              ...
              for (var _i = 0, _a = table.columns; _i < _a.length; _i++) {
                var column = _a[_i];
                if (
                  rowSpansLeftForColumn[column.dataKey] == null ||
                  rowSpansLeftForColumn[column.dataKey].left === 0
                ) {
        ...
        function cellStyles(sectionName, dataKey, rowIndex) {
          ...
          var colStyles =
            sectionName === "body"
              ? table.styles.columnStyles[dataKey] || {}
              : {};
          var rowStyles =
          ...
          return polyfills_1.assign.apply(
            void 0,
            [config_1.defaultStyles()].concat(
              otherStyles.concat([rowStyles, colStyles]),
            ),
          );
        }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Cell = /** @class */ (function () {
          function Cell(raw, themeStyles, section) {
            ...
            var text = "";
            var content =
              raw && typeof raw.content !== "undefined" ? raw.content : raw;
            content =
              content != undefined && content.dataKey != undefined
                ? content.title
                : content;
            var fromHtml =
            ...
            this.contentWidth =
              ...
              common_1.getStringWidth(this.text, this.styles);
...
*/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function parseCss(element, scaleFactor, ignored) {
          ...
          assign(
            "lineWidth",
            parseInt(style.borderWidth || "") / pxScaleFactor / scaleFactor,
          );
