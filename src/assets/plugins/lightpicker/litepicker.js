              ...
              if (g.test(e)) {
                ...
                r.month
                  ...
                  : r.shortMonth
                    ...
                    : r.longMonth &&
                      (D = t.longMonths(i).indexOf(y[r.longMonth]));
          ...
          if (o.length) {
            ...
            for (var r = 0, a = Object.entries(o); r < a.length; r++) {
              ...
              (i += this.formatTokens(p[0], n)),
                o[c + 1] &&
                  (i += e.substring(p.index + p[0].length, o[c + 1].index)),
      ...
      p = (function (t) {
        ...
        return (
            ...
            if (this.options.element instanceof HTMLInputElement) {
              ...
              if (this.options.singleMode && t)
                ...
                this.options.elementEnd instanceof HTMLInputElement
                  ? ((this.options.element.value = n),
                    (this.options.elementEnd.value = i))
                  : (this.options.element.value =
                      "" + n + this.options.delimiter + i);
              }
              t ||
                e ||
                ((this.options.element.value = ""),
                ...
                if (this.isSamePicker(e))
                  if ((this.emit("before:click", e), this.preventClick))
                    ...
                    if (e.classList.contains(h.dayItem)) {
                      if (
                        (t.preventDefault(), e.classList.contains(h.isLocked))
                      )
                        return;
                      if (
                    ...
                    if (e.classList.contains(h.buttonPreviousMonth)) {
                      ...
                      return (
                        this.calendars[i].setMonth(
                          this.calendars[i].getMonth() - o,
                        ),
          ...
          (e.prototype.hideTooltip = function () {
            this.ui.querySelector("." + h.containerTooltip).style.visibility =
              "hidden";
          }),
          (e.prototype.shouldAllowMouseEnter = function (t) {
            return (
              !this.options.singleMode && !t.classList.contains(h.isLocked)
            );
          }),
          ...
          (e.prototype.onMouseEnter = function (t) {
            ...
            if (this.isDayItem(n) && this.shouldAllowMouseEnter(n)) {
              ...
              if (
                ...
                r
                  ? (i && i.classList.add(h.isFlipped),
                    n.classList.add(h.isFlipped))
                  : (i && i.classList.remove(h.isFlipped),
                    n.classList.remove(h.isFlipped)),
        ...
        return (
          ...
          (e.prototype.render = function () {
            ...
            (n.className = a.containerMonths),
              ...
              this.options.showWeekNumbers &&
                n.classList.add(a.showWeekNumbers);
            for (
          ...
          (e.prototype.renderDay = function (t) {
            ...
            this.options.selectBackward &&
              ...
              e.classList.add(a.isLocked),
            h.dateIsLocked(t, this.options, this.datePicked) &&
              e.classList.add(a.isLocked),
      ...
      l = (function (t) {
        function e(e) {
          ...
          n.options.startDate &&
            ...
            l instanceof a.DateTime &&
              !isNaN(l.getTime()) &&
              (n.options.startDate = l),
            n.options.startDate &&
          ...
          for (var c = 0; c < n.options.numberOfMonths; c += 1) {
            ...
            if (!n.options.startDate && (0 === c || n.options.splitView)) {
              var u = n.options.maxDate
                  ? new a.DateTime(n.options.maxDate)
                  : null,
                m = n.options.minDate
                  ? new a.DateTime(n.options.minDate)
                  : null,
    ...
    (s.Litepicker.prototype.show = function (t) {
      ...
      (s.Litepicker.prototype.setDateRange = function (t, e, n) {
        ...
        (this.options.disallowLockDaysInRange
          ...
          : r.dateIsLocked(i, this.options, [i, s]) ||
            r.dateIsLocked(s, this.options, [i, s])) && !n
